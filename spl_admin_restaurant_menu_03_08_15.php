...
if($_REQUEST['submit_item'] == 'Save & Continue')
{
	...
	foreach($data['item_id'] as $item_id)
	{
			...
			$update = "UPDATE restaurant_menu_item SET menu_name = '".$data['menu_item_name'][$i]."' , price = '".$data['menu_item_price'][$i]."' , description = '".$data['menu_item_description'][$i]."' ,whats_good = '".$data['whats_good'][$i]."' , spicy = '".$data['spicy'][$i]."' , veggie = '".$data['veggie'][$i]."' , healthy = '".$data['healthy'][$i]."'";
        ...
        if($subcat_num_rows_new > 0)
		{
			...
			?>
                ...
                <td>
                    ...
                    <input type="checkbox" name="whats_good[]" id="whats_good" value="1" <?php if($row_item['whats_good'] == '1'){?> checked="checked" <?php } ?>> What's Good
                </td>
                <td>
					<input type="text" name="menu_item_price[]" id="menu_item_price" class="restaurant menu_item_rest" value="<?php echo $row_item['price']; ?>" ><br>
                    <input type="checkbox" name="spicy[]" id="spicy" value="1" <?php if($row_item['spicy'] == '1'){?> checked="checked" <?php } ?>> Spicy
                </td>
                <td>
                    ...
                    <input type="checkbox" name="veggie[]" id="veggie" value="1" <?php if($row_item['veggie'] == '1'){?> checked="checked" <?php } ?>> Veggie
                </td>
                <td>
                    ...
                    <input type="checkbox" name="healthy[]" id="healthy" value="1" <?php if($row_item['healthy'] == '1'){?> checked="checked" <?php } ?>> Healthy
                </td>
