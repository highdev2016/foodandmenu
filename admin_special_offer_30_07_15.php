...
<?php
$res_basic_info=mysql_query("SELECT * FROM restaurant_basic_info where id='".$_SESSION['admin_res_id']."'");
$row_res_id  = mysql_fetch_array($res_basic_info);
$restaurant_id = $row_res_id['id'];

//echo $row_res_id['restaurant_name'];
...
<?php $basic_info_for_disclaimer=mysql_fetch_array(mysql_query("select * from restaurant_disclaimer where restaurant_id='".$_SESSION['admin_res_id']."'"));?>
...
<input name="coupon_picture1" type="file" class="restaurant_browse" /><br>
...
<?php 
if($_SESSION['admin_res_id']!="")
{
$sql_deals = mysql_query("SELECT * FROM restaurant_coupon WHERE restaurant_id='".$_SESSION['admin_res_id']."'");
...
<table width="100%" border="1" bordercolor="c5c8d5" cellspacing="0" cellpadding="0" style="border-collapse:collapse; margin-top:10px;" align="center">
  <tr>
    ...
    <td width="22%" class="all_restaurant">Coupon Code</td>
  ...
  <tr>
    ...
    <td class="all_restaurant2"><a href="edit_daily_coupon1_admin.php?coupon_id=<?php echo $array_deals['id']?>" class="all_edit">Edit</a>&nbsp;<a href="admin_special_offer.php?action=del&del_coupon_id=<?php echo $array_deals['id']?>" class="all_edit" onClick="return confirm('Are you sure you want to delete this coupon deals?');">Delete</a></td>
  </tr>
<?php } ?>
</table></div>
<?php
...
<?php 
$sql_deals = mysql_query("SELECT * FROM restaurant_deals WHERE restaurant_id='".$_SESSION['admin_res_id']."'");
if(mysql_num_rows($sql_deals)>0){?>
...
<table width="100%" border="1" bordercolor="c5c8d5" cellspacing="0" cellpadding="0" style="border-collapse:collapse; margin-top:10px;" align="center">
  <tr>
    ...
    <td width="18%" class="all_restaurant">Price ($)</td>
    <td width="20%" class="all_restaurant">Your Price ($)</td>
    <td width="21%" class="all_restaurant">Action</td>
  </tr>
  <?php
	while($array_deals = mysql_fetch_array($sql_deals)){
  ...
  <tr>
    ...
    <td class="all_restaurant2"><a href="edit_daily_deals1_admin.php?deals_id=<?php echo $array_deals['id']?>" class="all_edit">Edit</a>&nbsp;<a href="admin_special_offer.php?action=del&del_deal_id=<?php echo $array_deals['id']?>" class="all_edit" onClick="return confirm('Are you sure you want to delete this daily deals?');">Delete</a></td>
  </tr>
<?php } ?>
</table></div>
<?php
