...
if($_REQUEST['delete_holiday_hrs']!=''){
	...
	header("location:additional.php?restaurant_edit_id=".$_REQUEST['restaurant_edit_id']."&hol_del_success=1");
}
/*------------------------------- Delete Monday Business Hours ---------------------------------------------*/
...
if($_REQUEST['delete_mon_buss_hrs']!=''){
	...
	header("location:additional.php?restaurant_edit_id=".$_REQUEST['restaurant_edit_id']."&bus_del_success=1");
}
/*------------------------------- Delete Monday Business Hours ---------------------------------------------*/
...
if($_REQUEST['delete_mon_del_hrs']!=''){
	...
	header("location:additional.php?restaurant_edit_id=".$_REQUEST['restaurant_edit_id']."&del_del_success=1");
}
/*------------------------------- Delete Monday Delivery Hours ---------------------------------------------*/
...
if($_REQUEST['delete_mon_pickup_hrs']!=''){
	...
	header("location:additional.php?restaurant_edit_id=".$_REQUEST['restaurant_edit_id']."&pickup_del_success=1");
}
/*------------------------------- Delete Monday Pickup Hours ---------------------------------------------*/
...
if($_REQUEST['delete']!=''){
	...
	header("location:additional.php?success=1");
}
...
if($_REQUEST['delete_pickup_hrs']!=''){
	...
	header("location:additional.php?restaurant_edit_id=".$_REQUEST['restaurant_edit_id']."&del_pickup_success=1");
}

if($_REQUEST['delete_del_charge']!=''){
	mysql_query("DELETE FROM restaurant_delivery_charge WHERE id = '".$_REQUEST['delete_del_charge']."'");
	header("location:additional.php?del_success=1");
}

$sql_sel_pickup_hrs = mysql_fetch_array(mysql_query("SELECT * FROM restaurant_take_out_master WHERE restaurant_id = '".$_SESSION['restaurant_id']."'"));

$sql_sel_del_hrs = mysql_fetch_array(mysql_query("SELECT * FROM restaurant_delivery_details_master WHERE restaurant_id = '".$_SESSION['restaurant_id']."'"));
...
if(count($_POST)>0 && $_REQUEST['submit']=="Save & Continue")
{
	...
	$sql_select_del_charges = mysql_query("SELECT * FROM restaurant_delivery_charge WHERE restaurant_id = '".$restaurant_id."'");
	$j = 1;
	...
	header("location:restaurant_menu.php");
		...
		header("lcation:additional.php?status=error");
	}
}
?>
...
<ul>
    ...
    <li><a href="additional.php" class="active7">Additional Info</a></li>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_mon_buss_hrs=<?php echo $array_monday_buss_hrs['id'];?>">
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_tue_buss_hrs=<?php echo $array_tuesday_buss_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_wed_buss_hrs=<?php echo $array_wednesday_buss_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_thu_buss_hrs=<?php echo $array_thursday_buss_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_fri_buss_hrs=<?php echo $array_friday_buss_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_sat_buss_hrs=<?php echo $array_saturday_buss_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_sun_buss_hrs=<?php echo $array_sunday_buss_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_holiday_hrs=<?php echo $array_holidays_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<a href="additional.php?delete=<?php echo $array_business_extra_hours['id'];?>" >
<img  src="images/Close_Box_Red.png">
</a>
</div>
...
<input name="delivery_hours" id="delivery_hours" type="text" class="restaurant" value="<?php echo $result_business_delivery_details['delivery_hours']?>" /><?php */?>
...
<div class="cross_bt" style="margin-left:394px;">
<a href="additional.php?restaurant_edit_id=<?php echo $_REQUEST['restaurant_edit_id'];?>&delete_del_hrs=<?php echo $array_delivery_hours['id'];?>" >
<img  src="images/Close_Box_Red.png">
</a>
</div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_mon_del_hrs=<?php echo $array_monday_del_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_tue_del_hrs=<?php echo $array_tuesday_del_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_wed_del_hrs=<?php echo $array_wednesday_del_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_thu_del_hrs=<?php echo $array_thursday_del_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_sat_del_hrs=<?php echo $array_saturday_del_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_sun_del_hrs=<?php echo $array_sunday_del_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;">
<a href="additional.php?delete_del_charge=<?php echo $array_del_charges['id'];?>" >
<img  src="images/Close_Box_Red.png">
</a>
</div>
...
<span style="color:#888888;">to</span>
<input name="pickup_hours_to" id="pickup_hours_to" type="text" class="restaurant" value="<?php echo $result_business_delivery_details['pickup_hours_to']; ?>" style="width:93px;" /><?php */?>
...
<div class="cross_bt" style="margin-left:394px;">
<a href="additional.php?restaurant_edit_id=<?php echo $_REQUEST['restaurant_edit_id'];?>&delete_pickup_hrs=<?php echo $array_pickup_hours['id'];?>" >
<img  src="images/Close_Box_Red.png">
</a>
</div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_mon_pickup_hrs=<?php echo $array_monday_pickup_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_tue_pickup_hrs=<?php echo $array_tuesday_pickup_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_wed_pickup_hrs=<?php echo $array_wednesday_pickup_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_thu_pickup_hrs=<?php echo $array_thursday_pickup_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_fri_pickup_hrs=<?php echo $array_friday_pickup_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_sat_pickup_hrs=<?php echo $array_saturday_pickup_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_sun_pickup_hrs=<?php echo $array_sunday_pickup_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
