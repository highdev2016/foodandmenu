...
if(count($_POST)>0 && $_REQUEST['submit']=="Save & Continue")
{
	if($_FILES['daily_picture']['name']!="")
		...
		header("location:special_offer.php?success=4");
...
<?php /*?><input name="disclaimer" id="disclaimer" type="text" class="restaurant_browse" value="<?php echo $select_deals['disclaimer'];?>" /><?php */?>
