...
google.maps.event.addDomListener(window, 'load', initialize);
                    ...
                    <div class="clear"></div>
                        ...
                        <?php } ?>
                        <div id="group_cart" <?php /*?>class="follow-scroll"<?php */?>>
                                ...
                                <div class="fcart myitems ordering">
                                    <div title="<?php echo $array_sel_groups['name']; ?>" class="friend-name">
                                        <div class="friend-name-cont text_dots">
                                            ...
                                            <span class="role">
											<?php  if($array_sel_groups['is_admin'] == '1'){ ?><img src="images/icon_admin.png"><?php } ?>
                                            <img src="images/user_img.png" width="20" height="20">
							...
							echo $sql_item_name1['menu_name']; ?>
                                    ...
                                    <div id="reward_div_group_<?php echo $array_sel_groups['id']; ?>" style="display:none;">
                                        <input type="text" name="group_reward_point" id="group_reward_point_<?php echo $array_sel_groups['id']; ?>" class="profilefield_right" style="float:left; width:154px;  padding:5px; margin:0; margin-top:9px;" onKeyPress="return goodchars(event,'1234567890');" >
                                        
                                        <input type="button" class="check_order_button" name="reward_point_submit" value="Apply" style="text-decoration: none; margin-top: 10px; margin-left: -1px; padding: 5px 22px;" onClick="get_reward_point_group('<?php echo $total_amt; ?>','<?php echo $_REQUEST['id']; ?>','<?php echo $array_sel_groups['id']; ?>');">
                                    </div>
                                    <script>
                                    ...
                                    <?php if($sql_restaurant_delivery_details1['service_fee']!=''){ ?>
                                        <div class="small friend-subtotal">Service Fee: 
                                        <span class="friend-subtotal-total">$<?php echo $sql_restaurant_delivery_details1['service_fee']; ?>
                                        </span>
                                        </div>
									<?php }?>
                                    
                                    <?php $sub_total_amt = $total_aft_coupon_dis + $tax_amt1 + $sql_restaurant_delivery_details1['service_fee'];
...
<div class="slide_head"><h1>Group Order by Food and Menu</h1></div>
...
<p><span>Name</span> <input type="text" name="name" id="name" placeholder="Your Name" class="restaurant" /></p>
<p><span>Email</span> <input type="text" name="email_adm" id="email_adm" placeholder="Your Email" class="restaurant"></p>
<p><span>Share Link</span> <input type="text" name="share_link" id="share_link" class="restaurant" value="https://foodandmenu.com/restaurant.php?id=<?php echo $_REQUEST['id'];?>&share=<?php echo $share_no; ?>" readonly /></p>
<p><input type="hidden" id="link" value="<?php echo $share_no; ?>"></p>
