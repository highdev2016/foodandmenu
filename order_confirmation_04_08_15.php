...
<div class="new_email_content">
  ...
  <?php //if($sql_menu['spare_napkins'] == 1){ ?>
    ...
    <p style="color:#000000; font-size:14px;">Order Type : <span class="pick_up"> <?php if($sql_menu['type'] == 'del'){ echo "Delivery"; }else{ echo "Pick Up"; }?></span></p>
  ...
  <div class="table_content">
    ...
    <table width="100%" border="1" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <?php }else{ ?>
        		<span class="cash_order" style="border: 1px solid rgb(0, 0, 0); padding: 20px;">Credit Card - Do Not Charge
                </span>
		<?php }?>
