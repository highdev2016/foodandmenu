...
<?php echo change_dateformat_reverse($row_updated_review['post_date']); ?>  By <span><?php echo $row_updated_review['customer_name']?></span>  </h5>
									  ...
									  ?>
                                        <p class="review-con"><?php if(mysql_num_rows($sql_mul_image) != 0) { 
										while($mul_image = mysql_fetch_array($sql_mul_image))
										{
											$uploaded_image = 'uploaded_images/'.$mul_image['image'];
										?><a class="example_cat" href="<?php echo $uploaded_image; ?>"><img src="thumb_images/<?php echo $mul_image['image']; ?>" height="30"></a><?php } } echo $row_updated_review['customer_review']?></p>
								...
								?>
                                 <li><div style="width:165px;">&nbsp;</div></li>
									...
									?>
									  ...
									  ?>
                                        <p class="review-con"><?php if(mysql_num_rows($sql_mul_image1) != 0) { 
										while($mul_image1 = mysql_fetch_array($sql_mul_image1))
										{
											$uploaded_image1 = 'uploaded_images/'.$mul_image1['image'];
										?>
                                        <a class="example_cat" href="<?php echo $uploaded_image1; ?>"><img src="thumb_images/<?php echo $mul_image1['image']; ?>" height="30"></a><?php } } echo $res_review['customer_review']?></p>
                                        <div class="viewers_comment">
                                    <ul>
