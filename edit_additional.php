...
if($_REQUEST['delete_holiday_hrs']!=''){
	...
	header("location:edit_additional.php?restaurant_edit_id=".$_REQUEST['restaurant_edit_id']."&hol_del_success=1");
}
/*------------------------------- Delete Monday Business Hours ---------------------------------------------*/
...
<input name="holidaydate<?php echo $id_holiday; ?>" id="holidaydate<?php echo $id_holiday; ?>" type="text" class="restaurant date_class" value="<?php echo date("m-d-Y", strtotime($array_holidays_hrs['holiday_date'])); ?>" />
...
<?php /*?><div style="margin-left:173px;"><a href="javascript:void(0);" onClick="add_cell(document.getElementById('item_id').value)" id="item_focus"><img src="images/add_bus_hrs.png"  style="margin-left:0;" width="213"/></a></div><?php */?>


<?php /*?><?php if(mysql_num_rows($business_extra_hours)>0){
$id=1;
...
<input type="hidden" id="item_id" name="item_id" value="1"><?php */?>
...
<div class="add_focus"><a href="javascript:void(0);" onClick="add_del_charge_cell(document.getElementById('del_charge_item_id').value)" id="item_focus_del_charge"><img src="images/add_new_del_crg.png"></a></div>
