...
<tr>
   ...
   <!-- EAT24 Deposited Into Your Account: $ -->
    ...
    <div>
    <div class="head_class">Serial No.</div>
    <div class="head_class">Order Time</div>
    <div class="head_class">Order #</div>
    <div class="head_class">Restaurant</div>
    <div class="head_class">Type</div>
    <div class="head_class">Tax</div>
    <div class="head_class">Delivery Fee</div>
    <div class="head_class">Tip</div>
    <div class="head_class">Total</div>
    </tr>
    <?php 
	$sl_no=1;
	...
	?>
    <div><?php echo $sl_no; ?></div>
    <div><?php echo date('m-d-Y h:i:s a', strtotime($fetch_array['order_date'])); ?></div>
    <div><?php echo "OR-00".$fetch_array['order_id']; ?></div>
    <div><?php echo getNameTable("restaurant_basic_info","restaurant_name","id",$fetch_array['restaurant_id']); ?></div>
    <div><?php echo $payment_mode; ?></div>
    <div><?php echo "$".$fetch_array['tax']; ?></div>
    <div><?php echo "$".number_format($fetch_array['delivery_charge'],2); ?></div>
    <div><?php echo "$".$fetch_array['tip']; ?></div>
    <div><?php echo "$".$fetch_array['price_with_del_charge']; ?></div>
    <?php
	$sl_no++;
	}
	?>
