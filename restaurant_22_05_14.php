...
#fade
	...
	.pop_item2{position: absolute;margin:100px -286px 0px 0px;background:#f5f5f5;box-shadow:0px 1px 5px 0px #aeaeae;width: 500px;-moz-border-radius:5px;-webkit-border-radius:5px;border-radius:5px; z-index:999999999999; width:900px;}
            ...
            <div class="food_body_cont">
                <div class="food_content">
                    ...
                    <div id="vertical_container" class="rstrnt_panel">
                       ...
                       <div class="rstrnt_right_panel rstrnt_right_panel_new" style="min-height:405px; display:<?php echo $display; ?>;">
