...
<div class="checkout_right_panel">
    ...
    <?php } ?>
		...
		$tax = round($tax1, 2);
		 ?>
        <fieldset class="special_instructions">
        <legend>Total $<input type="text" name="amount" id="amount" value="<?php echo ($total_amount + $tax + $service_fee); ?>" style="border:none; float:right; color:#FA8730; font:normal 20px calibri; margin:0 380px 0 0;" readonly></legend>
