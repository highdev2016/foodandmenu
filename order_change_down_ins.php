<?php
  ob_start();
	...
	$sql_team_order=sprintf("SELECT show_order,id FROM restaurant_menu_item_special_instruction WHERE show_order>'%s' AND menu_id = '".$menu_id."' AND restaurant_id = '".$res_id."' AND special_ins_id = '".$special_ins_id."' order by show_order asc limit 0,1",$order);
