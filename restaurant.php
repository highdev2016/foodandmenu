...
function distance_new($start,$destination)
	{
...
if($_SESSION['del_charge' . $ses_rest_id . '_' . $_SESSION['group_order_details_id' . $ses_rest_id]] == ''){
	...
	$distance = distance_new($address,$rest_address);
...
if($_SESSION['del_charge' . $ses_rest_id] == ''){
...
{
	//alert(no,coupon_id,restaurant_id);
	window.print();

   /*var printContents = document.getElementById("inline189").innerHTML;
...
<body onLoad="init();">
    ...
    <div style="width:400px; height:1px; margin:0 auto; display:<?php echo $display; ?>" id="light">
        <div  style="width:352px; position:absolute; z-index:9999999; background:#fff; padding:40px 20px; color:#d87340; font-family:'LithosPro-Bold',sans-serif; font-size:18px; height:auto; -moz-box-shadow: 0 0 5px #888;-webkit-box-shadow: 0 0 5px#888;box-shadow: 0 0 5px #888; text-align:center; margin-top:290px; border-radius:8px; -moz-border-radius:8px; -webkit-border-radius:8px; border:#2C4598 2px solid;">
            <?php
            if (($_REQUEST['error_msg'] == 1) || ($_REQUEST['error_msg'] == 3) || ($_REQUEST['error_msg'] == 4)) {
                $style = 'margin-left: 304px; position: absolute; margin-top: -52px; cursor:pointer;';
            } else if ($_REQUEST['error_msg'] == 2) {
                $style = 'margin-left: 296px; position: absolute; margin-top: -52px; cursor:pointer;';
            } else if ($_REQUEST['error_msg'] == 5) {
                $style = 'margin-left: 247px; position: absolute; margin-top: -52px; cursor:pointer;';
            } else if ($_REQUEST['error_msg'] == 6) {
                $style = 'margin-left: 305px; position: absolute; margin-top: -52px; cursor:pointer;';
            } else if ($_REQUEST['error_msg'] == 7) {
                $style = 'margin-left: 265px; position: absolute; margin-top: -52px; cursor:pointer;';
            } else if ($_REQUEST['error_msg'] == 8) {
                $style = 'margin-left: 299px; position: absolute; margin-top: -52px; cursor:pointer;';
            } else if ($_REQUEST['error_msg'] == 9) {
                $style = 'margin-left: 268px; position: absolute; margin-top: -52px; cursor:pointer;';
            }
            ?>
            <a href = "javascript:void(0)" onclick = "document.getElementById('light').style.display = 'none';
                    document.getElementById('fade11').style.display = 'none';
                    document.getElementById('fade').style.display = 'none'"><img src="images/cross-blue.png" style="<?php echo $style; ?>" class="cross_new"/></a>
            <?php
            if ($_REQUEST['error_msg'] == 1) {
                ...
                echo "This has requested to be removed a while back";
            } else if ($_REQUEST['error_msg'] == 6) {
    ...
    <style type="text/css">
        ...
        /*.pop_item{position: fixed;margin:200px -53px 0 0;background:#f5f5f5;box-shadow:0px 1px 5px 0px #aeaeae;width: 500px;-moz-border-radius:5px;-webkit-border-radius:5px;border-radius:5px; z-index:999999999999;
                  width:900px;}*/
		.pop_item{position: absolute;margin:-602px -175px 0 0; background:#f5f5f5;box-shadow:0px 1px 5px 0px #aeaeae;width: 500px;-moz-border-radius:5px;-webkit-border-radius:5px;border-radius:5px; z-index:999999999999;
                  width:900px;}
		...
		.pop_item2 {background: #f5f5f5; border-radius: 5px; box-shadow: 0 1px 5px 0 #aeaeae; margin: 0; position: absolute; top: 0; width: 600px;
    z-index: 2147483647;}
        .reviews_pop{position: fixed;background:#f5f5f5; box-shadow:0px 1px 5px 0px #aeaeae;width: 500px;-moz-border-radius:5px;-webkit-border-radius:5px;border-radius:5px; margin-top:220px !important; z-index:99999999; right:430px;}
                        ...
                        <div class="accr_details" >
                            ...
                            <div id="sidebox">
                                ...
                                while ($array_menu_catyegory1 = mysql_fetch_array($sql_menu_category1)) {
                                    ...
                                    ?>
                                    <?php if($_REQUEST['c_id'] == $array_menu_catyegory1['id']){
										$style_display_ul = 'block';
										$icon = 'fa-minus';
									}else{
										$style_display_ul = 'none';
										$icon = 'fa-plus';
									} ?>
                                    <ul class="side_menus">
										<?php if ($inc == 1) { ?>
                                        ...
                                        <?php } ?>
                                        <li><a href="javascript:void(0);" id="cat_a_sidebox<?php echo $array_menu_catyegory1['id']; ?>" class="cat_a_sidebox" onClick="open_accor('<?php echo $array_menu_catyegory1['id']; ?>');"><i class="fa <?php echo $icon; ?>"></i></a><a title="<?php echo $array_menu_catyegory1['category_name']; ?>" href="restaurant.php?id=<?php echo $_REQUEST['id']; ?>&c_id=<?php echo $array_menu_catyegory1['id']; ?>#tab"><?php echo $array_menu_catyegory1['category_name']; ?></a>
                                        
                                        <ul class="sub_cat_sidebox" id="sub_cat_sidebox<?php echo $array_menu_catyegory1['id'];?>" style="display:<?php echo $style_display_ul; ?>;">
                                       <?php
...
<?php } ?>
                                ...
                                <div id="start_div_single_cart"></div>
                                    ...
                                    if (mysql_num_rows($sql_items) > 0) {
                                        ?>
                                        <div id="navigation_single_cart" class="rstrnt_right_panel rstrnt_right_panel_new ur-order navigation_single_cart_class" style="display:<?php echo $display1; ?>; margin-top:10px;">
        ...
        ?>
                                                <table width="100%" border="0" cellspacing="1" class="restro2_table" >
                                                    <tr>
                                                        <td width="20%" height="20" colspan="3" align="center" class="restro2_table_bg"><h2>Qty</h2></td>
                                                    ...
                                                    while ($array_items = mysql_fetch_array($sql_items)) {
                                                        ?>
                                                        <tr>
                                                            <td height="30" colspan="3" align="center" class="text-center"><a class="qunTty" href="#"><?php echo $array_items['quantity']; ?></a>
                                                                <div class="item_hover"> <a class="left_minus" href="restaurant.php?id=<?php echo $_REQUEST['id']; ?>&sub=sub&cart_id=<?php echo $array_items['id']; ?>">-</a> <a class="right_plus" href="restaurant.php?id=<?php echo $_REQUEST['id']; ?>&add=add&cart_id=<?php echo $array_items['id']; ?>">+</a> </div></td>
                                                    ...
                                                    echo $sql_item_name['menu_name'];
                                                        ?></td>
                                                            <td height="30" align="left" style="padding-left:2px;">$ <?php echo number_format(($array_items['quantity'] * $array_items['price']),2); ?> <a href="delete_menu_cart_item.php?id=<?php echo $_REQUEST['id']; ?>&del_id=<?php echo $array_items['id']; ?>" onClick="return confirm('Are you sure?');"><img class="btnDtl" src="images/1400777057_delete.png" height="12" width="12"></a></td>
                                                        </tr>
        ...
        <?php } ?>
                                                    ...
                                                    <tr class="total-tr">
                                                        ...
                                                        <td height="20" id="subtotal" align="left">$<?php echo number_format($amount,2); ?></td>
                                                    </tr>
                                                    <tr class="total-tr">
                                                        <td height="20" colspan="3" align="center">&nbsp;</td>
        ...
        <?php if (isset($_SESSION['del_charge' . $ses_rest_id])) { ?>
                                                            <tr class="total-tr mn-ttl">
                                                                ...
                                                                <td height="20" align="left"><?php echo "$ " . $_SESSION['del_charge' . $ses_rest_id]; ?></td>
                                                            </tr>
                                                            <tr class="total-tr mn-ttl">
                                                                <td height="20" colspan="3" align="center" style="border-right: 1px solid #f8f8f8;">&nbsp;</td>
                                                                <td height="20" align="right">Total </td>
                                                                <td height="20" align="left"><?php echo "$ " . ($_SESSION['del_charge' . $ses_rest_id] + $tax1 + $amount + $sql_restaurant_delivery_details['service_fee']); ?></td>
                                                            </tr>
        <?php } else { ?>
                                                            <tr class="total-tr mn-ttl">
                                                                <td height="20" colspan="3" align="center" style="border-right: 1px solid #f8f8f8;">&nbsp;</td>
                                                                <td height="20" align="right" style="width:79%;">Total </td>
                                                ...
                                                <form name="order_del_frm" method="post" action="">
                                                    ...
                                                    <?php } ?>
                                                    <?php if (isset($_SESSION['del_charge' . $ses_rest_id])) { ?>
                                                        <div id="change_del_add"><a href="javascript:void(0)" onClick="del_block();" class="chg_del_add">Change Delivery Address</a></div>
                                                    <?php } ?>
                                                    <?php 
													$del_more = ($sql_restaurant_delivery_details['minimum_ammount'] - ($tax1 + $amount + $sql_restaurant_delivery_details['service_fee']));
													if ($sql_restaurant_delivery_details['minimum_ammount'] != '' && ($del_more > 0)) { ?>
                                                        <?php /*?><p>Delivery Minimum : $ <?php echo $sql_restaurant_delivery_details['minimum_ammount']; ?> (Before tax)</p><?php */?>
                                                        <p style="color:#360; font-size:16px !important; font-weight:bold;">Add $ <?php //echo $del_more; ?><?php echo $del_more; ?> for delivery. </p>
        <?php } ?>
                                                    <p style="color:#f00000; font-size:14px;">No minimum on pickup orders</p>
                                                    <br>
                                                    <script type="text/javascript">
                                                        var $j = jQuery.noConflict();
                                                    ...
                                                    if (!isset($_SESSION['customer_id'])) {
                                                        $link = 'login.php?check_out=1&type=pickup';
                                                    } else {
                                                    ...
                                                    <?php
                                                    if (!isset($_SESSION['customer_id'])) {
                                                        $link1 = 'login.php?check_out=1&type=del';
                                                    } else {
                                                ...
                                                <form name="frm" method="post" action="">
                                                    <div class="pop_item2" style="display:none;" id="del_add">
                                                        ...
                                                        <input name="address" id="address1" type="text" class="pop_quantity" style="width:350px; margin:10px !important; font-family: Calibri !important; font-size:14px;" placeholder="Enter Address" />
                                                ...
                                                <div class="clear"></div>
                                                <!--<span id="follow_unfollow"><a href="javascript:void(0);" onClick="addClassfunc();">Follow Me</a></span>-->
                                    ...
                                    <?php if ($_REQUEST['del_item_succ'] == '1') { ?>
                                        ...
                                        <p>This has requested to be removed a while back</p>
                                    <?php } ?>
                                    <?php if ($_REQUEST['qty_upd_succ'] == '1') { ?>
                                        <p>Item Updated Successfully.</p>
                                        
    <?php } ?>
                                    <div id="group_cart" class="navigation_group_cart_class">
                                                                ...
                                                                <div>
                                                                    <div class="cart_tr edit_item cart_edit">
                                                                        <div class="cart_item f_clear">
                                                                            ...
                                                                            <div class="cart_td cart_td3"> <span class="itm_price">$<?php echo number_format(($array_sel_items['quantity'] * $array_sel_items['price']),2); ?></span>
                                                                                <?php if ($array_sel_groups['id'] == $_SESSION['group_order_details_id' . $ses_rest_id]) { ?>
                                                                                    <span class="itm_close"><a href="restaurant.php?id=<?php echo $_REQUEST['id']; ?>&menu_del_id=<?php echo $array_sel_items['id']; ?>&delete_item=delete" onClick="return confirm('Are you sure , you want to delete this item?');"><img src="images/1400777057_delete.png" height="12" width="12"></a></span>
                                                                        <?php } ?>
                                                                            </div>
                                                                        </div>
            ...
            <?php if ($array_sel_groups['id'] == $_SESSION['group_order_details_id' . $ses_rest_id]) { ?>
                ...
                <?php } ?>
                                                        ...
                                                        ?>
                                                        <div class="small friend-subtotal">Subtotal: <span class="friend-subtotal-total">$<?php echo  number_format($total_aft_coupon_dis,2); ?></span></div>
    ...
    <?php } ?>
                                        ...
                                        ?>
                                        <!--<span id="follow_unfollowGroup"><a href="javascript:void(0);" onClick="addClassfuncGroup();">Cart, Follow Me</a></span>-->
                                        <span id="follow_unfollowGroup"><a href="javascript:void(0);" onClick="addClassfuncGroup();">Cart, Follow Me</a></span>
                                    </div>
...
<?php } ?>
        ...
        <script type="text/javascript">
			...
			function addClassfunc()
			{
				...
				$j("#follow_unfollow").html('<a href="javascript:void(0);" onClick="removeClassfunc();">Unfollow Me</a>');
				scroll_cart();
			}
			function removeClassfunc()
			{
				...
				$j("#follow_unfollow").html('<a href="javascript:void(0);" onClick="addClassfunc();">Cart, Follow Me</a>');
			...
			function scroll_cartGroup()
			{
				var $j = jQuery.noConflict();
				var element = $j('.navigation_group_cart_class'),
						originalY = element.offset().top;
				// Space between element and top of screen (when scrolling)
				var topMargin = 180;
				// Should probably be set in CSS; but here just for emphasis
			...
			function addClassfuncGroup()
			{
				var $j = jQuery.noConflict();
				//$j(window).on('scroll');
				$j("#group_cart").addClass('navigation_group_cart_class');
				$j("#follow_unfollowGroup").html('<a href="javascript:void(0);" onClick="removeClassfuncGroup();">Cart, Unfollow Me</a>');
				scroll_cartGroup();
			}
			function removeClassfuncGroup()
			{
				var $j = jQuery.noConflict();
				var offset1 = $j('.navigation_group_cart_class').offset();

				//var x_pos = offset1.left;
				var y_pos = offset1.top;
				
				$j("#group_cart").removeClass('navigation_group_cart_class');
				$j("#follow_unfollowGroup").html('<a href="javascript:void(0);" onClick="addClassfuncGroup();">Cart, Follow Me</a>');
				$j("#group_cart").css({'position':'initial'});
				//$j("#navigation_single_cart").css({'top':'900px', 'position':'initial'});
				//$j("#navigation_single_cart").css({'left': x_pos, 'top': y_pos});
				//$j(document).unbind('scroll',scroll_cart);
				//$j(window).off('scroll');
