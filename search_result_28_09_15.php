...
<style type="text/css">
	...
	function distance($start,$destination)
	{
	 ...
	 $data = file_get_contents("https://maps.googleapis.com/maps/api/distancematrix/json?origins=".$from."&destinations=".$to."&language=en-EN&key=AIzaSyBtQWXgLQVwOjC1DlaBmym_G_sg_yW-nCc");
		//echo "<br>";
        ...
        <div id="wrapper">
            ...
            <header class="stick_header banner-serve">
                ...
                <section class="search_address_section">
                    ...
                    <h2><a href="restaurant.php?id=<?php echo $ses_rest_id;?>" class="back_restu_link">BACK TO RESTAURANT</a></h2>
                                                ...
                                                <div id="cuisine_div" style="display:none;" class="white_content">
                                                    ...
                                                    <div class="l-contnt up-contnt"> 
                                                        ...
                                                        <div class="sort_sec cuisines_nw cuisine_new_2">
                                                            ...
                                                            <h1>Cuisines 
                                                            <!--<span id="select_all" class="clear_all"><a >Check All</a></span> -->
                                                            <span id="deselect_all" class="clear_all"><a onclick="javascript:checkAll('form3', false);" href="javascript:void();">Uncheck All</a></span></h1>     
					...
					<div style="width: 24%; float: right;">
                            ...
                            <div class="search_main_map" id="navigation" style="margin-top:52px;">
                                <div class="search_main_map_inner">
                                    ...
                                    <div id="mapcanvas123456789" style="width: 100%; height: 400px;"></div>
 <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB07MAPrJw5QMASepJKym-rXy9DJ9wdMKU&libraries=places&callback=initAutocomplete"
         async defer></script>
									...
									<script>
									 var $j = jQuery.noConflict();
                                        ...
                                        function initialize() {
                                            ...
                                            var map = new google.maps.Map(document.getElementById('mapcanvas123456789'),
                                                    mapOptions);
...
<script src="https://maps.googleapis.com/maps/api/js?v=3.exp&libraries=places"></script>
            ...
            function initialize_new() {
              ...
              var markers = [];
              var map = new google.maps.Map(document.getElementById('map_canvas_new'), {
             ...
             /* var defaultBounds = new google.maps.LatLngBounds(
              ...
              var input = /** @type {HTMLInputElement} */(
                  document.getElementById('address123'));
