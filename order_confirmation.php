...
<div class="about_body_cont order_confirm_body_cont">
...
<div class="new_email_content">
    ...
    <div class="clear"></div>
    <p style="padding-top:5px; color:#000000; font-size:15px;"><strong>Phone No. <span>:</span></strong><span>
     <?php echo substr($sql_contact_details['phone'],0,3); ?>-<?php echo substr($sql_contact_details['phone'],3,3); ?>-<?php echo substr($sql_contact_details['phone'],6,4); ?></span></p>
    <div class="clear"></div>
  ...
  <div class="instruction_sec">
    ...
    <p class="item_order_type">Order Type : <span class="pick_up"> <?php if($sql_menu['type'] == 'del'){ echo "Delivery"; }else{ echo "Pick Up"; }?></span></p>
    </div>
  ...
  <div class="table_content">
    ...
    <table width="100%" border="1" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <div class="clear"></div>
        <?php $card_year = explode("-",$sql_menu_order_details['expiry_date']);
		$sql_select_cradit=mysql_fetch_array(mysql_query("SELECT * FROM restaurant_menu_credit_details WHERE order_id = '".$order_id."'"));
		
		
		
		?>
        <p class="visa_end"><?php echo ucfirst($sql_menu_order_details['card_type'])." Ending ".substr($sql_select_cradit['card_no'],12,4); ?></p>
        </td>
