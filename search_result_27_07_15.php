...
//}
    ...
    <div style="width:400px; height:1px; margin:0 auto; display:none;" id="submit_div">
        <div class="pop_result_bg">
        	<div class="pop-box"  style="width:300px; position:fixed; z-index:9999999; background:#EFEFEF; padding:34px 24px; color:#000; font-family:Calibri; font-size:18px; -moz-box-shadow: 0 0 5px #888; -webkit-box-shadow: 0 0 5px#888; box-shadow: 0 0 5px #888; text-align:center; margin-top:200px; margin-left:200px; border-radius:8px; -moz-border-radius:8px; -webkit-border-radius:8px; border:#2C4598 2px solid;">
...
<?php /* ?><a href="#">More Distances</a> <?php */ ?>
        ...
        <?php } ?></p>
                                                        ...
                                                        ?></li>
                                                            ...
                                                            <li><span>Delivery Fee:</span> <?php if ($del_fee != 0.00)
                                                            echo "$" . $del_fee;
                                                        else
                                                            echo "Free";
                                                        ?></li>
