					...
					<div class="user-profile-section">
						...
						<div class="user-cont">
							...
							<div class="user-cont-left">
                                ...
                                <div>
									<a href="customer_order_history.php" style="color:rgb(235, 111, 0); text-decoration:none;"><img src="images/order_history.png" width="161" height="51"></a>
								</div>
								<div class="clear"> </div>
                                
                                <div>
									<a href="gift_certificate_order_history.php" style="color:rgb(235, 111, 0); text-decoration:none;"><img src="images/gift.png" width="161" height="51"></a>
								</div>
								<div class="clear"> </div>
							...
							<div class="user-cont-right">
                                ...
                                <div class="clear"></div>
                                <p>Apartment Number&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Gate Code</p>
                                ...
                                <h2>Billing Address <input type="checkbox" name="check1" id="check1" value="" onClick="copy_address();">  (Click here if same as physical address)
                                </h2>
...
function copy_address()
{
	if($("#check1").attr('checked') == "checked")
	{
		...
		$("#billing_home").val($("#physical_home").val());
		if($("#physical_home").val() == "apartment")
		{
			$("#info_div1").slideUp(1000);
			$("#apt_div1").slideDown(1000);
			$("#billing_information").val('');
			$("#billing_apartment_name").val($("#physical_apartment_name").val());
			$("#billing_apartment_no").val($("#physical_apartment_no").val());
			$("#billing_apartment_gate_code").val($("#physical_apartment_gate_code").val());
		}
		else if($("#physical_home").val() == "others")
		{
			$("#apt_div1").slideUp(1000);
			$("#info_div1").slideDown(1000);
			$("#billing_apartment_name").val('');
			$("#billing_apartment_no").val('');
			$("#billing_apartment_gate_code").val('');
			$("#billing_information").val($("#information").val());
		}
		$("#billing_phone_no").val($("#physical_phone_no").val());
		$("#billing_state").val($("#physical_state").val());
		//$("#billing_city").val($("#city").val());
		$("#billing_zip").val($("#physical_zip").val());
		get_city1($("#physical_state").val(),$("#city").val());
	}
	else
	{
		$("#apt_div1").slideUp(1000);
