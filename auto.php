...
$sql_basic_info_city=mysql_query("SELECT DISTINCT(restaurant_city) FROM restaurant_basic_info where status=1");
$sep="";
$all_county="";
...
//echo $all_zipcode;
echo $all_total=$all_city.$all_state.$all_zipcode;
?>
