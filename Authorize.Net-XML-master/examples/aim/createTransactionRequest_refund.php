...
*************************************************************************************************/
	...
	$tid=rand(2253655848, 3000000000);
...
if($xml->isSuccessful())
{
	mysql_query("UPDATE `restaurant_menu_order` SET `status` = 'Refund' WHERE `order_id` ='".$_GET['order_id']."'");
	
	header("Location: https://foodandmenu.com/manage_restaurant_live_orders.php?restaurant_id=".$_GET['restaurant_id']."&msgg=Refund Successful");
    exit();
}
