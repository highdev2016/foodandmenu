...
<style type="text/css">
.follow-section ul li .cancel-img-2 a{
	text-align: left;
	border-bottom:none;
}

div.cancel-img-2:last-child{
	border-bottom:none;
}
...
if($_GET['favorite_id']!="")
{
	mysql_query("DELETE FROM `restaurant_favourite` WHERE `id`='".$_GET['favorite_id']."'");
	$msggg="Deleted";
}


if($_GET['following_id']!="")
{
	mysql_query("DELETE FROM `user_follow` WHERE `id`='".$_GET['following_id']."'");
	$msggg="Deleted";
}

if($_GET['notification_id']!="")
{
	mysql_query("DELETE FROM `restaurant_notification` WHERE `id`='".$_GET['notification_id']."'");
	$msggg="Deleted";
}
...
<div class="body_cont_right user_full_profile_section">
...
<?php if($msggg!="")
       {
?>
<div class="user_deleted"><?php echo $msggg;?></div>
...
<div class="profile-name">
    <h1><?php echo $sql['firstname']; ?>'s Profile</h1>
</div>
	...
	<li>
		 ...
		 <div id="notification_div" class="notification" style="display:none;">
			...
			<?php while($row_all_notification = mysql_fetch_array($sql_get_notification)) { 
				...
				echo "<div class='cancel-img-2' style='position:relative;'><p>".getNameTable("restaurant_customer","firstname","id",$row_all_notification['user_id'])." ".$row_all_notification['notification']."</p>";
				
				echo '<a class="cross-img" href="user_profile.php?notification_id='.$row_all_notification['id'].'"><img style="margin-top: 18px;" src="images/1417787649_button_cancel.png"></a></div>';
...
<li>
	 ...
	 <div id="following_div" style="display:none;">
		...
		<?php while($row_all_follower = mysql_fetch_array($all_follower)) { 
			...
			echo "<div class='cancel-img-2' style='position:relative;'><a href='user.php?id=".$row_all_follower['following_id']."' style='color:#4E7AD5'>".getNameTable("restaurant_customer","firstname","id",$row_all_follower['following_id'])." ".getNameTable("restaurant_customer","lastname","id",$row_all_follower['following_id'])."</a>";
			echo '<a class="cross-img" href="user_profile.php?following_id='.$row_all_follower['id'].'"><img style="margin-top: 18px;" src="images/1417787649_button_cancel.png"></a></div>';
...
<li>
	 ...
	 <div id="favourite_div" class="favo" style="display:none;">
		...
		<?php while($row_all_favourite = mysql_fetch_array($all_favourite)) { 
			...
			echo "<div class='cancel-img-2' style='position:relative;'><a href='restaurant.php?id=".$row_all_favourite['restaurant_id']."' style='color:#4E7AD5'>".getNameTable("restaurant_basic_info","restaurant_name","id",$row_all_favourite['restaurant_id'])."</a>  ";
		
		echo '<a class="cross-img" style="padding-right:0;" href="user_profile.php?favorite_id='.$row_all_favourite['id'].'"><img style="margin-top: 18px;" src="images/1417787649_button_cancel.png"></a><div class="clearfix"></div></div>';
		 } ?>
	</div>    
</li>
...
{
?>
	<?php /*?><span class="full-block">You need <span style="color:#F00;"><?php echo ($row_mul_reward['redeemable_point'] - $current_reward_single['point_added']);?></span> more points to reach your reward, <a href="javascript:void(0);" onClick="open_desc_div('<?php echo $inc; ?>');">Click here</a> for Reward Details</span><?php */?>
    
    <span class="full-block"><a href="javascript:void(0);" onClick="open_desc_div('<?php echo $inc; ?>');">Click here to redeem <span style="color:#F00;"><?php echo ($row_mul_reward['redeemable_point'] - $current_reward_single['point_added']);?></span> points</a></span>
...
?>
    ...
    <div class="form-group">
                ...
                <div class="">
                    ...
                    <div class="col-md-9 item-pic-2 poplight-con">
                    <div><strong>Description :</strong> <!--<span class="des">--><?php echo $row_mul_reward['description'];?> <!--</span>--></div> 
                    <div><strong>Start Date :</strong> <?php echo date('d', strtotime($row_mul_reward['start_date']))."".$start_date." ".$start_month." ".$start_year; ?></div>
                    <div><strong>Expiry Date :</strong> <?php echo date('d', strtotime($row_mul_reward['end_date']))."".$exp_date." ".$exp_month." ".$exp_year; ?></div>
                    <div><strong>Receiveable Point :</strong> <?php echo $row_mul_reward['redeemable_point']; ?></div>
                    <?php
						$reward_types = explode(",",$row_mul_reward['reward_type']);
					?>
                    <div><strong>Points against Actions : </strong>
                    	<span>
...
<div class="right_user_div user_pro_div">
...
<div class="right_user_div user_pro_div">
<h1><a href="order_history.php" style="color:rgb(235, 111, 0); text-decoration:none;"><img src="images/order_history.png" width="161" height="51"></a></h1>
<!--<div><img src="images/shdw_btm.png" width="204" height="14">
<div class="clear"></div>
</div>-->
<div class="clear"></div>
...
<div class="right_user_div user_pro_div">
<h1><a href="gift_certificate_history.php" style="color:rgb(235, 111, 0); text-decoration:none;"><img src="images/gift.png" width="161" height="51"></a></h1>
<!--<div><img src="images/shdw_btm.png" width="204" height="14">
<div class="clear"></div>
</div>-->
<div class="clear"></div>
...
<div class="right_user_div user_pro_div">
<h1><a href="edit_shipping_billing.php" style="color:rgb(235, 111, 0); text-decoration:none;"><img src="images/edit_shipping.png" width="161" height="51"></a></h1>
<!--<div><img src="images/shdw_btm.png" width="204" height="14">
<div class="clear"></div>
</div>-->
<div class="clear"></div>
...
<div class="right_user_div user_pro_div">
<h1><a href="onlinereservation.php" style="color:rgb(235, 111, 0); text-decoration:none;"><img src="images/online_reservation.png" width="161" height="51"></a></h1>
<!--<div><img src="images/shdw_btm.png" width="204" height="14">
<div class="clear"></div>
</div>-->
<div class="clear"></div>
