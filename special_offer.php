...
//			mail($email,$subject,$message,$headers);
	...
	if($disclaimer_row>0)
	{
		mysql_query("update restaurant_disclaimer set disclaimer='".$_REQUEST['disclaimer']."',description='".$_REQUEST['dis_description1']."' WHERE restaurant_id='".$restaurant_id."'");
	}
	else{
	mysql_query("insert into restaurant_disclaimer set restaurant_id='".$restaurant_id."', disclaimer='".$_REQUEST['disclaimer']."',description='".$_REQUEST['dis_description1']."'");
	}
...
<div class="restaurant_nav">
                    ...
                    <li><a href="special_offer.php" class="active7">Special Offer</a></li>
...
<textarea name="dis_description1" rows="5" cols="25"><?php echo $basic_info_for_disclaimer['description']?></textarea>
...
<p>Disclaimer Description :</p>
<textarea name="dis_description" rows="5" cols="25"></textarea>
...
<table width="98%" border="1" bordercolor="c5c8d5" cellspacing="0" cellpadding="0" style="border-collapse:collapse; margin-top:10px;" align="center">
  <tr>
    ...
    <th width="22%" class="all_restaurant">Coupon Code</th>
  ...
  <tr>
    ...
    <td class="all_restaurant2"><a href="edit_daily_coupon1.php?coupon_id=<?php echo $array_deals['id']?>" class="all_edit">Edit</a>&nbsp;<a href="special_offer.php?action=del&del_coupon_id=<?php echo $array_deals['id']?>" class="all_edit" onClick="return confirm('Are you sure you want to delete this coupon deals?');">Delete</a></td>
  </tr>
<?php } ?>
</table></div>
<?php
...
<table width="98%" border="1" bordercolor="c5c8d5" cellspacing="0" cellpadding="0" style="border-collapse:collapse; margin-top:10px;" align="center">
  ...
  <tr>
    ...
    <td class="all_restaurant2"><a href="edit_daily_deals1.php?deals_id=<?php echo $array_deals['id']?>" class="all_edit">Edit</a>&nbsp;<a href="special_offer.php?action=del&del_deal_id=<?php echo $array_deals['id']?>" class="all_edit" onClick="return confirm('Are you sure you want to delete this daily deals?');">Delete</a></td>
  </tr>
<?php } ?>
</table></div>
<?php
