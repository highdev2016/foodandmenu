...
<tr>
<td width="114">Old Password : </td><td width="219"><input type="password" name="old_password" id="old_password" value="" style="height:23px;" class="restaurant"></td></tr>
<tr>
<td width="152">New Password : </td><td width="277"><input type="password" name="new_password" id="new_password" value="" style="height:23px;" class="restaurant"></td></tr>
<tr>
<td width="115">Confirm New Password : </td><td width="298"><input type="password" name="confirm_new_password" id="confirm_new_password" value="" style="height:23px;" class="restaurant"></td>
</tr>
<tr>
