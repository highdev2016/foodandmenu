...
$sql_basic_info = mysql_fetch_array(mysql_query("SELECT * FROM restaurant_basic_info WHERE id = '".$_SESSION['restid']."'"));

$sql_basic = mysql_fetch_array(mysql_query("SELECT * FROM restaurant_basic_info WHERE id = '".$_SESSION['restid']."'"));
...
Sent to you from Food & menu</h4>
	...
	$sql_res_owner = mysql_fetch_array(mysql_query("SELECT * FROM restaurant_basic_info WHERE id = '".$_SESSION['restid']."'"));
...
Sent to you from Food & menu</h4>
	...
	header("location:admin_confirmation.php?success=1");
}
?>
...
<div class="restaurant_nav">
                    ...
                    <li><a href="admin_confirmation.php" class="active7">Confirmation</a></li>
                    </ul>
...
?>
        ...
        <div class="multimedia_form_field">
                        ...
                        <h2 style="float:no !important;"><?php $sql_select_res_category = mysql_query("SELECT * FROM restaurant_category WHERE id IN (".$sql_basic_info['restaurant_category'].")");			
...
<div class="clear"></div>
                            ...
                            <div class="accordion_content2"> 
                                ...
                                <?php $sql_business = mysql_fetch_array(mysql_query("SELECT * FROM restaurant_business_delivery_takeout_info WHERE restaurant_id = '".$_SESSION['restid']."'"));?>
                                <div class="clear"></div> 
                        ...
                        <div class="clear"></div>
                        <?php 
						$sql_business_extra_hours = mysql_query("SELECT * FROM restaurant_extra_business_hours WHERE restaurant_id = '".$_SESSION['restid']."'");
...
<?php $sql_cat_service = mysql_fetch_array(mysql_query("SELECT * FROM  restaurant_services_dress_payment WHERE restaurant_id = '".$_SESSION['restid']."'"));?>
<div class="multimedia_form_field">
        ...
        <div class="multimedia_form_field">
                ...
                <div class="clear"></div>
                           ...
                           <div class="clear"></div> 
                            ...
                            <?php } ?><?php */?>
                            <div class="accordion_content2"> 
                            <?php $sql_select_menu = mysql_query("SELECT * FROM restaurant_menu_item WHERE restaurant_id = '".$_SESSION['restid']."'");
							if(mysql_num_rows($sql_select_menu)>0){
							while($array_menu = mysql_fetch_array($sql_select_menu)){?>
