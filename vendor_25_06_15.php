...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                 ...
                 <td width="13%" class="all_restaurant">Company Name:</td>
                  <td width="29%">
                  ...
                  <td width="12%" class="all_restaurant">Service Type:</td>
                  <td width="23%"><select name="service_type" id="company_name" class="restaurant_list">
                  <option value="">----Select----</option>
                  <?php
				  ...
				  ?>
                    ...
                    <td width="12%"><input type="submit" name="search" value="Search" class="button4" style="margin-left:10px; margin-top:10px;"></td>
                 </tr>
