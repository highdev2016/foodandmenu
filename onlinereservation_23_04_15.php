					...
					<div class="user-profile-section">
						...
						<div class="user-cont">
							...
							<div class="user-cont-right">
                                ...
                                <form name="reservation_frm" id="reservation_frm" method="post" action="">
	  ...
	  ?>
        ...
        while($array_order = mysql_fetch_array($query_products)){
            ...
            <tr>
              ...
              <td class="all_restaurant2"><a class="various1" href="#inline_<?php echo $array_order['id'];?>" title="More Info" style="color:#686868;">More Info</a></td>
                ...
                <div id="inline_<?php echo $array_order['id'];?>" style="width:500px;height:300px;overflow:auto;">
                    <div class="profle_wrapper">
                        <div style="width:450px;">
                            ...
                            <div id="map_canvas<?php echo $array_order['id']; ?>" style="width:444px; height:250px;"></div>
