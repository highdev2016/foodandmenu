...
<img src="captcha_code_file.php?rand=<?php echo $_SESSION['6_letters_code'];?>" id='captchaimg' class="captcha_cont">
<div class="clear"></div>
<p class="click_refresh">Can't read the image? click <a href='javascript: refreshCaptcha();'>here</a> to refresh</p>
<div class="clear"></div>

<p style="width:auto;"><input name="captcha_code" id="captcha_code" type="text" class="contactfield captcha_field" value="<?php echo $_REQUEST['captcha_code']; ?>" /></p>
...
<div class="mailing_address"><?php echo htmlspecialchars_decode($sql_contact['address']);?></div>
    ...
    <h3 class="mail_text">Email:</h3>
    
    <h5>
    <a href="mailto:<?php echo $sql_contact['email'];?>" target="_top">
    <?php echo $sql_contact['email'];?></a></h5>
