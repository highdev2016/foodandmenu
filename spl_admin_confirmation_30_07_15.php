...
Sent to you from Food & menu</h4>
	...
	if($_SESSION['admin_id']!="")
	{
	 ...
	 $email=$sql_res_owner['email'];
	
	}else{

	$email=$_SESSION['restaurant_user_email'];
}	
	/*$cms_rep = '<div style="width:100%;clear:both; border-bottom:3px solid #04303d;">
...
Sent to you from Food & menu</h4>
	...
	$_SESSION['restid'] = '';
	header("location:spl_admin_confirmation.php?success=1");
}
?>
...
<div class="restaurant_nav">
                    ...
                    <li><a href="spl_admin_confirmation.php" class="active7">Confirmation</a></li>
                    </ul>
