					...
					<div class="user-profile-section">
						...
						<div class="user-cont">
							...
							<div class="user-cont-right">
                                ...
                                ?>
                                <p style="float:right;">You Save $ <?php echo $amount_saved; ?> at this restaurant by using Food and menu</p>
                                
                                <form name="gift_cer_frm" id="gift_cer_frm" method="post" action="">
                                
                                <select name="restaurant_name" id="restaurant_name">
                                	<option value="">Select</option>
                                    <?php $sql_sel_restaurant = mysql_query("SELECT * FROM restaurant_basic_info WHERE status = '1' ORDER BY restaurant_name ASC");
								...
								<table width="99%" border="1" bordercolor="#c5c8d5" cellspacing="0" cellpadding="0" align="center">
                                <tr>
	  ...
	  ?>
		...
		?>
            <tr>
              ...
              <td class="all_restaurant2"><a href="view_certificate.php?giftcard_id=<?php echo $array_order['id']; ?>"  class="example_cat">View Certificate</a></td>
              <td class="all_restaurant2"><?php if($sql_used_check['used'] == 1) {  echo "Already Used"; } else { echo "Not Used"; ?><?php /*?><a href="javascript:void(0);" onClick="return confirm_gift_cer('<?php echo $array_order['id']; ?>');">Confirm</a> <?php */?><?php }?></td>
            </tr>
...
function confirm_gift_cer(id){
	$("#confirm_gift_cer"+id).show();
	$("#fade1").show();
}

function close_confirm_gift_cer(id){
	$("#confirm_gift_cer"+id).hide();
	$("#fade1").hide();
}
</script>