...
<script type="text/javascript">stLight.options({publisher: "a0f3f2c1-4b2c-4bb6-863c-98c2a1a09a67", doNotHash: false, doNotCopy: false, hashAddressBar: false});</script>
                        ...
                        <div class="food_middle_side">
                         ...
                         <div class="clear"></div>   
                           ...
                           <div style="border: 1px solid #B5ABC6; border-radius: 3px; margin: 10px 0 0 10px; padding: 4px 10px;"> 
                           <h1 style="font-size: 19px; line-height: 20px; padding: 0 0 5px;">Categories - </h1><?php //echo $sql_restaurant_category['category_name'] 
											$i=1;
											 ...
											 {?>
											<span style="color: #686868; font-size: 14px; font-weight: bold; padding-right: 5px;"><?php echo $result_restaurant_category['category_name']; ?> <?php if($i!=mysql_num_rows($sql_restaurant_category)){ echo ",";
											}?></span>
