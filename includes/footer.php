...
<?php /*?><h1>Newsletter</h1>
<?php if($error == 1){ ?>
<a name="#letter"><p style="color:#ffffff; font-family:Arial, Helvetica, sans-serif; font-size:14px;">The email id already exists</p></a><?php } ?><?php */?>
<?php /*?><form name="frm_newsletter" method="post" action="" onsubmit="return check_valid()">
<input name="email_subscribe" id="email_subscribe" type="text" class="textfield" value="Enter your email here" onfocus="if (this.value=='Enter your email here') this.value = ''" onBlur="(this.value=='')? this.value='Enter your email here':this.value;"/>
...
<input name="submit_newsletter" type="submit" value="Subscribe" class="button" />
</form><?php */?>
...
<?php if(basename($_SERVER['PHP_SELF'])!='index.php' && basename($_SERVER['PHP_SELF'])!='vendor.php' && basename($_SERVER['PHP_SELF'])!='index.php' && basename($_SERVER['PHP_SELF'])!='paymentdetails.php'){?>	
