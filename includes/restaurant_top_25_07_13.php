	...
	{  
		...
		$sql_res_name = mysql_fetch_array(mysql_query("SELECT * FROM restaurant_basic_info WHERE id = '".$_REQUEST['id']."'"));
			...
			$cms_rep = '<div style="width:100%;clear:both; border-bottom:3px solid #04303d;">
        				...
        				<img src="http://www.foodandmenu.com/images/logo.png" alt="" style="margin:10px 0 10px 10px;; float:left;" />
            			...
            			<div style="clear:both;"></div>
							...
							<p style="font:bold 12px Arial, Helvetica, sans-serif; color:#000000; margin:0 0 4px 15px;">Name : '.$sql_username['firstname'].'&nbsp;'.$sql_username['lastname'].'</p>
...
Sent to you from Food & menu</h4>
			...
			mail($sql_res_name['email'],$subject2,$message2,$headers2);
	
	header("location:profile.php?id=".$_REQUEST['profile_id'].'&status=success');
...
<?php $sql_restaurant = mysql_fetch_array(mysql_query("SELECT * FROM restaurant_basic_info WHERE id = '".$_REQUEST['id']."'"));?>
  ...
  <ul id="mycarouse2" class="jcarousel-skin-tango">
    <div class="highslide-gallery" style="width:285px !important; overflow:hidden !important; height:40px;">
<?php 
...
<!--   <a class="video"  title="Video1" href="http://www.youtube.com/v/ZeStnz5c2GI?fs=1&amp;autoplay=1"> 
 ...
 ?>
  ...
  <ul>
		<li><?php if(isset($_SESSION['customer_id'])){?><a id="various3" href="#inline3" title="Lorem ipsum dolor sit amet"><?php } else { $_SESSION['page_type']='reservation';
 ...
 ?>
                        ...
                        <div class="food_middle_side">
                         ...
                         <div class="clear"></div>   
                            ...
                            <h1>Categories : <?php //echo $sql_restaurant_category['category_name']
							                 while($result_restaurant_category=mysql_fetch_array($sql_restaurant_category))
											 {
												 echo $result_restaurant_category['category_name']."<br>";
											 }
							?></h1>
                            ...
                            <div class="middle_bottom">
                              ...
                              <p><a href="<?php echo $sql_restaurant['website']?>" target="_blank" style="color:#686868; text-decoration:none;"><?php echo $sql_restaurant['website']?></a></p> 
                            </div>
                           <?php
							}
							?>
  ...
  <ul>
		<li><?php if(isset($_SESSION['customer_id'])){?><a class="various6" href="#inline<?php echo $array_coupons['id'];?>" title="<?php echo $array_coupons['coupon_name'];?>">
        <img src="uploaded_images/<?php echo $array_coupons['coupon_image'];?>" width="95" height="70" /></a><?php }else{?><a href="login.php">
        <img src="uploaded_images/<?php echo $array_coupons['coupon_image'];?>" width="95" height="70" /></a> <?php } ?>
...
<div class="clear"></div>
                        ...
                        <div style="display: none;">
		<div id="inline5" style="width:500px;height:250px;overflow:auto;">
			<div class="profle_wrapper">
...
<b><?php echo $result_disclaimer['disclaimer']?></b><br />

<?php echo $result_disclaimer['description']?>
