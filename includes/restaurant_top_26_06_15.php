...
<div class="food_cont_top title-top">
    ...
    <?php $rating = number_format(getRestaurantRating($sql_restaurant['id']),1); ?>
        ...
        <div class="restu_top_review" style="float:left; padding-left:0; width:100px;"><div class="stars"></div></div>
        <?php  
        ...
        <?php echo $total_review; ?> reviews</p></div>
    ...
    <div style="display: none;">
		<div id="inline<?php echo $array_coupons['id'];?>" style="width:450px;height:450px;overflow:auto;">
			<div class="profle_wrapper">
                ...
                <a href="#"><img src="images/share.png" width="118" height="41" onclick="fbpublish('<?=addslashes($array_coupons['coupon_name'])?>','<?=addslashes($array_coupons['coupon_description'])?>','<?=addslashes($array_coupons['coupon_image'])?>')" style="margin-left: 12px;
 margin-top: 15px;"/></a></div>
