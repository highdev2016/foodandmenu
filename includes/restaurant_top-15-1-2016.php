...
@media only screen and (max-width: 767px) {
	.flex-viewport{max-height: 213px !important;}
	.black_pop_bg{top: 20% !important;}
}
...
@media only screen and (min-width: 768px) and (max-width: 959px) {
	...
	.black_pop_bg{top: 15% !important; left:5% !important; width: 90% !important;}
...
@media only screen and (min-width: 480px) and (max-width: 767px) {
	...
	.flex-viewport{max-height: 113px !important;}
}
...
@media only screen and (min-width: 480px) and (max-width: 750px) {
	...
	.flex-viewport{max-height: 313px !important;}
}
