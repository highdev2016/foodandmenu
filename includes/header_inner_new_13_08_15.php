...
?>
            ...
            <header class="stick_header banner-serve">
                ...
                <section class="search_address_section">
                    ...
                    <div>
                        <span style="cart_text"><?php echo get_qty_total() ; ?></span><a href="cart.php" style="float:left;"><img src="images/cart.png" width="20" height="20" style="margin-top:5px; padding-right:5px;"/></a>
					</div>
