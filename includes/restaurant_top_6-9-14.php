...
<p>Date * :</p>
<input name="post_date_test" id="post_date_test" type="text"  class="profilefield"/ readonly="readonly">&nbsp;(mm/dd/yyyy)
<div class="clear"></div>
...
<?php $sql_occasions = mysql_query("SELECT id , occassions FROM restaurant_occassions WHERE status = 'Active'");
...
<?php
	...
	$sql_cust_email = mysql_query("SELECT email FROM restaurant_customer WHERE id = '".$_SESSION['customer_id']."'");
	$row_cust_email = mysql_fetch_array($sql_cust_email);
	
?>

<p>Contact Email * :</p>
<input name="contact_email" id="contact_email" type="text"  class="profilefield" value="<?php echo $row_cust_email['email']; ?>"/>
<div class="clear"></div>
...
<div class="clear"></div>
  ...
  <ul>
		...
		{
		?>
        Coupon Code : <p style="font-weight:bold"><?php echo $array_coupons['coupon_code'];?></p>
        <?php
		}
		?>
        </li>
...
Coupon Code : <div style="font-weight:bold;"><?php echo $array_coupons['coupon_code']; ?></div>
<?php } ?>
</div>
