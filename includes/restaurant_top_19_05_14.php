...
<script type="text/javascript">stLight.options({publisher: "a0f3f2c1-4b2c-4bb6-863c-98c2a1a09a67", doNotHash: false, doNotCopy: false, hashAddressBar: false});</script>
</div><?php */?>
                        ...
                        <div class="food_middle_side">
                         ...
                         <div class="clear"></div>   
                           ...
                           <div style="padding-left:10px;"> <h1 style="padding-left:0;">Categories - </h1><?php //echo $sql_restaurant_category['category_name'] 
											$i=1;
                        ...
                        <div style="float:left; width:30px;"><input name="deals" type="radio" value="<?php echo $array_deals['id']; ?>" class="right_radio" <?php if($array_deals['id'] == $_REQUEST['deal_id']){?> checked="checked" <?php } ?>/></div>
                        <div style="float:left; width:325px;"> 
						<p style="padding:0px !important;">$<?php echo $array_deals['daily_description'];?> / Your Price $<?php echo $array_deals['daily_price'];?>  /  Expiry Date : <?php echo date("m-d-Y", strtotime($array_deals['expiry_date'])); ?></p></div>
                        <div class="clear"></div>
