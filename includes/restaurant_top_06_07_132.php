		...
		$sql_res_name = mysql_fetch_array(mysql_query("SELECT * FROM restaurant_basic_info WHERE id = '".$_REQUEST['id']."'"));
			...
			$cms_rep = '<div style="width:100%;clear:both; border-bottom:3px solid #04303d;">
            			...
            			<div style="clear:both;"></div>
                			...
                			<p style="font:bold 12px Arial, Helvetica, sans-serif; color:#000000; margin:0 0 4px 15px;">Date : '.change_dateformat_reverse($post_date).'</p>
...
<input class="profilebutton" type="submit" value="Submit" name="submit">
                         ...
                         <div class="clear"></div>   
                            ...
                            <div class="middle_center">
                                ...
                                <p>
                                 ...
                                 <p style="padding-top:0px; padding-left:38px;"><?php echo $sql_restaurant['restaurant_city'];?><br /><?php echo $sql_restaurant['restaurant_state'];?><br /><?php echo $sql_restaurant['restaurant_zipcode'];?>
                                </p>
                            </div>
                        	<div class="clear"></div>
                            ...
                            <div class="clear"></div>
                            <div class="middle_bottom">
                              <img src="images/website.png" alt="" width="18" height="20" />
                              <p><a href="<?php echo $sql_restaurant['website']?>" target="_blank"><?php echo $sql_restaurant['website']?></a></p> 
                            </div>
                           <?php
							}
							?>
  ...
  <ul>
        ...
        <img src="uploaded_images/<?php echo $array_coupons['coupon_image'];?>" width="95" height="70" /></a> <?php } ?></li>
	</ul>
