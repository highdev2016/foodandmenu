...
setcookie("reszip", $_REQUEST['zipcode'], $expire);
header("location:home.php?city=".$city[0]."&zipcode=".$_REQUEST['zipcode']);
}
?>
...
<p>Get up to 20% off great deals on restaurant, spas and experiences<br />
in your city</p>
</div>
