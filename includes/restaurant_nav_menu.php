...
<div class="restu_nav_right">
<h2><?php echo stripslashes($sql_restaurant['restaurant_name']); ?></h2>
<div class="restu_address_section">
<p style="padding:0px; margin-right:5px;">Address : </p>
<p style="padding:0px; color:#000000;"><?php echo $sql_restaurant['restaurant_address']; ?></p>
<p style="padding:0px; color:#000000;"><?php echo $sql_restaurant['restaurant_city'];?>&nbsp;&nbsp;<?php echo $sql_restaurant['restaurant_state'];?>&nbsp;&nbsp;<?php echo $sql_restaurant['restaurant_zipcode'];?></p>
<div class="clear"></div>
</div>
</div>
...
<li><a href="edit_special_offer1.php?restaurant_edit_id=<?=$_SESSION['restaurant_admin_panel_id']?>" <?php if($page == 'my_reports.php'){?> class="active7" <?php } ?>>Special Offer</a></li>
