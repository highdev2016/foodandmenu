...
<div><a href="http://twitter.com/home?status=http://foodandmenu.com/restaurant.php?id=<?php echo $_REQUEST['id']?>" target="_blank"><img src="images/twitter_logo.png" /></a></div>

<div><a href="mailto:<?php echo $sql_restaurant['email']; ?>" target="_top"><img src="images/mail_icon.png" /></a></div>
