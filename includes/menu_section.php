...
?>
<ul>
<li><a href="index.php" <?php if($page=="index.php"){?> class="active" <?php }?>>Home</a></li>
...
<div><a href="http://115.115.196.29:8100/priya/restaurant/login.php"><img class="chat_header" src="images/chat.png" alt="#" height="97"  width="104" /></a></div><?php }else { ?>
<div><a href="http://115.115.196.29:8100/priya/restaurant/customer_onlinechat.php"><img class="chat_header" src="images/chat.png" alt="#" height="97"  width="104"/></a></div>
<?php } ?><?php */?>
