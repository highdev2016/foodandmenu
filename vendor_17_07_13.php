...
Sent to you from Food & menu</h4>
			...
			$email_admin='support@foodandmenu.com';
			//$email_admin='dipanjan@infosolz.com';
...
<h1>Vendor <span><form name="frmproduct" action="" method="post">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                 <tr>
                 <td class="all_restaurant">Company Name:</td>
                  <td><input type="text" name="company_name" id="company_name"  class="login_ipboxin" value=""></td>
                  
                  <td class="all_restaurant">Service Type:</td>
                  <td><input type="text" name="service_type" id="service_type"  class="login_ipboxin" value=""></td>
