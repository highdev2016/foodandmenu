...
function sort_function(sort_by,submit1,start_date,end_date){
	var $j = jQuery.noConflict();
	var limit = $j('#hid_limit').val();
	location.href = 'balancebkp.php?sort_order='+sort_by+'&submit='+submit1+'&start_date='+start_date+'&end_date='+end_date+'&limit='+limit;
}
</script>
...
<ul class="tab-look">
	...
	<li class="active"><a href="balancebkp.php">Balance</a></li>
</ul>
...
<div class="tab-look-restu" style="padding:2%;">
          <form name="frm" method="post" action="balancebkp.php" onSubmit="return check_validtion();">
            <table class="sec-pnl-top" width="100%">
              ...
              <tr> -->
                ...
                <td width="50">
					...
					{
					?>
					<a href="javascript:void(0);" class="check_order_button noprint" style="text-decoration: none; padding: 7px 10px; float: none; margin: 0px; font-size: 13.3px;" id="print_but" >Print</a>
					<?php
					}
					?>
                </td>
    ...
    <span class="blnce-head">Summary for <?php echo $start_date_summary; ?> - <?php echo str_replace("-","/",$sr_end_dt); ?></span>
    ...
    <td class="all_restaurant"><a href="javascript:void(0)" onClick="sort_function('order_id','<?php echo $_REQUEST['submit']; ?>','<?php echo $_REQUEST['start_date']; ?>','<?php echo $_REQUEST['end_date']; ?>')" class="heading_link">Order #</a></td>
    <td class="all_restaurant">Restaurant</td>
    <td class="all_restaurant"><a href="javascript:void(0)" onClick="sort_function('order_date','<?php echo $_REQUEST['submit']; ?>','<?php echo $_REQUEST['start_date']; ?>','<?php echo $_REQUEST['end_date']; ?>')" class="heading_link">Date</a></td>
    <td class="all_restaurant"><a href="javascript:void(0)" onClick="sort_function('payment_mode','<?php echo $_REQUEST['submit']; ?>','<?php echo $_REQUEST['start_date']; ?>','<?php echo $_REQUEST['end_date']; ?>')" class="heading_link">Type</a></td>
    <td class="all_restaurant"><a href="javascript:void(0)" onClick="sort_function('price_with_del_charge','<?php echo $_REQUEST['submit']; ?>','<?php echo $_REQUEST['start_date']; ?>','<?php echo $_REQUEST['end_date']; ?>')" class="heading_link">Total</a></td>
    <td class="all_restaurant"><a href="javascript:void(0)" onClick="sort_function('commission','<?php echo $_REQUEST['submit']; ?>','<?php echo $_REQUEST['start_date']; ?>','<?php echo $_REQUEST['end_date']; ?>')" class="heading_link">Commission</a></td>
    <td class="all_restaurant"><a href="javascript:void(0)" onClick="sort_function('coupon_discount','<?php echo $_REQUEST['submit']; ?>','<?php echo $_REQUEST['start_date']; ?>','<?php echo $_REQUEST['end_date']; ?>')" class="heading_link">Coupons</a></td>
    <td class="all_restaurant">Status</td>
    <td class="all_restaurant">Action</td>
    </tr>
    ...
    <td class="all_restaurant2"><a href="javascript:void(0);" title="View" onClick="open_view_div('<?php echo $fetch_array['order_id'] ?>');" style="color:#686868;">View</a></td>
