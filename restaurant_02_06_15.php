...
else if($_REQUEST['error_msg'] == 9){ echo "Order Confirmed Successfully."; } ?>                              
            ...
            <div class="food_body_cont">
                <div class="food_content">
                    ...
                    <div id="vertical_container" class="rstrnt_panel" style="min-height:1000px; border:none !important;">
						...
						{	
						?>
                            <h1 class="accordion_toggle" style="border:1px solid #ffc198;"><?php echo $array_sub_category['subcategory_name'];?></h1>
                            <div class="accordion_content" style="border:1px solid #ffc198;">
                           ...
                           <?php $sql_mn = "SELECT * FROM restaurant_menu_item WHERE restaurant_id = '".$_REQUEST['id']."' AND sub_category_id = '".$array_sub_category['id']."' ";
                            ...
                            <input type="hidden" name="menu_price<?php echo $array_menu['id'];?>" id="menu_price<?php echo $array_menu['id'];?>" value="<?php echo $array_menu['price'];?>">
                                ...
                                <span style="margin-left:10px;">$ <span id="menu_prc<?php echo $array_menu['id']; ?>"><?php echo $array_menu['price']; ?></span>  </span><?php } ?>
                                ...
                                <a class="plus" href="javascript:void(0);" onClick="count_down('<?php echo $array_menu['id'];?>');"></a>
                                ...
                                <a class="minus" href="javascript:void(0);" onClick="count_up('<?php echo $array_menu['id'];?>');"></a>
                                </div>
                                </div>
                                <div class="clear"></div>
								...
								{
								?>
								<a href="javascript:void(0);" class="highslide" onClick="open_single_slider_div(<?php echo $cnt; ?>);">
                                ...
                                <div class="slide_head"><h1><?php echo stripslashes($array_menu['menu_name']); ?></h1></div>
                       ...
                       <div id="restro_2left_panel" class="restro_2left_panel_new"> 
                        ...
                        <div id="share_bar">
                            <h4>Group Order</h4>
                            <a class="start_share" href="javascript:void(0)" onClick="open_shared_cart();" title="Start shared cart">
                                Start group order
                            </a>
                        </div>
                        <?php }else{ ?>
                        ...
                        <?php $is_admin = getNameTable("restaurant_group_order_details","is_admin","id",$_SESSION['group_order_details_id'.$ses_rest_id]); ?>
                            <h4><?php echo $adm_name = getNameTable("restaurant_group_order_details","name","id",$_SESSION['group_order_details_id'.$ses_rest_id]); ?>'s Cart</h4><br>
                            Link <?php echo getNameTable("restaurant_group_order","share_link","id",$_SESSION['group_order_id'.$ses_rest_id]); ?><br>
                            
                            Share By <a href="javascript:void(0);" id="email_top_a" onClick="email_top_div_show()">Email</a> <br>

                            <div id="email_top_div" style="display:none;">
                            ...
                            <input type="button" name="send" id="send" value="Send" onClick="send_top_email();">
                            </div>
                            <?php if($is_admin == 0) { ?>
                            <a href="restaurant.php?id=<?php echo $_REQUEST['id']; ?>&session_group=<?php echo $_SESSION['group_order_details_id'.$ses_rest_id];?>&res_id=<?php echo $_REQUEST['id']; ?>" onClick="return confirm('Are you sure to Leave the Group?');">Leave Goup Order</a>
                            <?php } ?>
                        </div>
                        <?php } ?>
                        <div class="rstrnt_right_panel2 rstrnt_right_panel_new2">
                    		<div class="rstrnt_right_panel rstrnt_right_panel_new" style="min-height:310px; display:block;">
                        		<div class="rstrnt2_reviews_rtngs rstrnt2_reviews_rtngs_new">
			                       ...
			                       <?php $sql_restaurant = mysql_fetch_array(mysql_query("SELECT * FROM restaurant_basic_info WHERE id = '".$_REQUEST['id']."'")); ?>
			                           <div class="reviews_pop rev_pop_nw ppp " style="display:none; width:580px;" id="local_review">
			                                ...
			                                <a class="fr-light" href="write_review.php?id=<?php echo $_REQUEST['id']; ?>" style="color:rgb(228, 96, 2); font:normal 20px 'Calibri'; float:right; margin-right: 27px; margin-bottom: 10px;"> Write A Review </a>
											<?php 
...
<?php echo change_dateformat_reverse($row_updated_review['post_date']); ?>  By <span><?php echo $row_updated_review['customer_name']?></span>  </h5><?php */?>
                                      ...
                                      <div class="rating_content light-rating">
                                        ...
                                        <div class="rating_content_two review-likes">
                                            <span class="status-review light-stats"><!-- <a href=""> --> <?php if($upd_status != '') { ?><img src="../images/refesh-org.png" align="absmiddle"  width="14px" /> <?php } ?><!-- </a> --><?php echo $prev_rev_stat; ?> <?php echo $upd_status; ?> </span>
                                            </div>
                                ...
                                <span class="status-review"> <?php echo $prev_status; ?> <!-- <a href=""> <img width="14px" align="absmiddle" src="../images/refesh-org.png"></a>--> </span>
                                       ...
                                       <div class="clear"></div> 
			                                <p style="margin-top:0px; margin-bottom:10px;"><?php echo $array_reviews['customer_name']; ?></p><?php echo $array_reviews['customer_review']; ?>
									  ...
									  $sql_mul_image1 = mysql_query("SELECT image FROM restaurant_review_images WHERE review_id = '".$array_reviews['id']."'");
										...
										?><li><a class="example_cat" href="<?php echo $uploaded_image; ?>"><img src="uploaded_images/<?php echo $mul_image1['image']; ?>" height="30"></a></li><?php } } ?>
                                    ...
                                    <?php if($array_reviews['abuse_status']==0){?>
                                     ...
                                     <div class="clear"></div>
                                       ...
                                       <?php $sql_owners_comment1 = mysql_fetch_array(mysql_query("SELECT * FROM restaurant_rev_owners_comment WHERE review_id = '".$array_reviews['id']."'"));
								 ...
								 ?>
			                    	...
			                    	<!-------------------- popular pop item --------------------------------------------->
			                    	<div class="reviews_pop fd-pop" style="display:none;" id="popular_item">
                     ...
                     <!------------------------------------ Sunday Business Hours --------------------------> 
								...
								<?php $sql_reviews = mysql_query("SELECT * FROM restaurant_reviews WHERE restaurant_id = '".$_REQUEST['id']."' AND status = 1");
                    ...
                    <h2 class="popular_item"><a href="#top_div" onClick="popularitem()">More Business Info... </a></h2>
                        ...
                        <div class="rstrnt_right_panel rstrnt_right_panel_new" style="display:<?php echo $display1; ?>; margin-top:10px;">
                       ...
                       <?php /*?> <?php if($del_hours_from!='' && $del_hours_to!=''){
                        ...
                        <table width="100%" border="0" cellspacing="1" class="restro2_table">
                          ...
                          <tr>
                            ...
                            <td height="20" id="subtotal" align="left" style="padding-left:10px !important; padding-top:20px !important;">$<?php echo $amount; ?></td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <td height="20" align="left" style="padding-right:15px !important;"><?php echo "$ ". ($_SESSION['del_charge'.$ses_rest_id] + $tax1 + $amount + $sql_restaurant_delivery_details['service_fee']); ?></td>
                          </tr>
                          <?php } ?>
                          </table></div>
                         ...
                         <div id="total_div" style="display:<?php echo $total_div; ?>;"> 
                          ...
                          <tr>
                            ...
                            <td height="20" align="right">Total</td>
                            <td height="20" id="total" align="left" style="padding-left:10px;">$ <?php echo ($tax1 + $amount + $sql_restaurant_delivery_details['service_fee']); ?></td>
                          </tr>
                         </table></div>
                   ...
                   <input type="hidden" name="ser_fee" id="ser_fee" value="<?php echo $sql_restaurant_delivery_details['service_fee']; ?>">
                    ...
                    <label class="coupon-check-label"><div id="hide_show_span">
...
<label for="have_coupon"></label>
                    <!--<input type="checkbox" id="have_coupon" name="have_coupon" onClick="open_apply_div();" >--> I have a Coupon Code</div></label>
                    <div id="apply_coupon" class="cpn" style="display:none;">
                        <div class="left lower-code-row"> <!--style="width: 100%; margin: -3px 0px 13px; font-size: 19px; text-align:left;"-->
                            ...
                            <span id="coup_code" class="cupon-action">
					...
					?>
                    		...
                    		<label class="coupon-check-label"><div id="reward_show_span">
...
<label for="have_reward"></label> 
                            <!--<input type="checkbox" id="have_reward" name="have_reward" onClick="open_reward_div();" >--> I want to use my Reward Points</div></label>
                    
                    <div id="apply_reward" class="cpn" style="display:none;">
                          <div class="left lower-code-row mrgn-btn-sm">
                            <span id="reward_text" style="display:none;">Reward Redeemed : </span>
                            <span id="reward" class="cupon-code sm" style="display:none;"></span>
                            <span id="reward_point_span" class="cupon-action">
...
google.maps.event.addDomListener(window, 'load', initialize);
                    ...
                    <div class="clear"></div>
                        ...
                        <!-----------------------------------  GROUP CART  ------------------------------------------>
                        <?php $restaurant_basic_info = mysql_fetch_array(mysql_query("SELECT * FROM restaurant_basic_info WHERE id = '".$_REQUEST['id']."'"));
                        ...
                        <div id="group_cart">
                            ...
                            <div id="cart_container">
                                <?php $sql_sel_groups = mysql_query("SELECT t1.* FROM restaurant_group_order_details as t1  INNER JOIN restaurant_group_order as t2 ON t2.id = t1.group_order_id  WHERE t1.group_order_id = '".$_SESSION['group_order_id'.$ses_rest_id]."' AND t2.restaurant_id = '".$_REQUEST['id']."'  "); 
								$total_tax = 0;
								$total_sub_total = 0;
								$grand_total = 0;
								$total_del_charge = 0;
                                ...
                                <div class="fcart myitems ordering">
                                    <div title="<?php echo $array_sel_groups['name']; ?>" class="friend-name">
                                        <div class="friend-name-cont text_dots">
                                            <span style="color: #790000;">
                                            <?php  if($array_sel_groups['is_admin'] == '1'){ ?>
                                            <span class="role">(Admin)</span>
                                            <?php } ?>
                                            </span>
                                            <?php echo $array_sel_groups['name']; ?>
                                        </div>
                                    </div>
                                    <?php $sql_sel_items = mysql_query("SELECT * FROM restaurant_menuitem_cart WHERE group_id = '".$_SESSION['group_order_id'.$ses_rest_id]."' AND group_order_details_id = '".$array_sel_groups['id']."' AND restaurant_id = '".$_REQUEST['id']."' ");
									if(mysql_num_rows($sql_sel_items) > 0){
										$total_amt = 0;
										while($array_sel_items = mysql_fetch_array($sql_sel_items)){ ?>
                                    	<div class="items">
                                    <div>
                                        <div class="cart_tr edit_item">
                                            <div class="cart_item f_clear">
                                                <div class="cart_td cart_td1 text_dots">
                                                    <?php $sql_item_name1 = mysql_fetch_array(mysql_query("SELECT * FROM restaurant_menu_item WHERE id = '".$array_sel_items['menu_item_id']."'"));
							echo $sql_item_name1['menu_name']; ?>
                                                ...
                                                <div class="cart_td cart_td3">
                                                    <span class="itm_price">$<?php echo ($array_sel_items['quantity']*$array_sel_items['price']); ?></span>
                                                    <?php if($array_sel_groups['id'] == $_SESSION['group_order_details_id'.$ses_rest_id]){ ?>
									...
									?>
                                    <div class="left lower-code-row">
                                        <span id="coupon_text" style="display: inline;">Coupon Code : </span>
                                        <span id="code" class="cupon-code" style="display: inline-block;"><?php echo $_SESSION['coupon_code'.$ses_rest_id."_".$array_sel_groups['id']]; ?></span>
                                        <span id="coup_code_group" class="cupon-action"><a href="javascript:void(0);" onClick="change_group_coupon()"><img src="images/change-coupon.png" height="12" title="Change Coupon Code" width="12"></a><a href="remove_coupon_group.php?id=<?php echo $_REQUEST['id']; ?>" onClick="return confirm('Are you sure you want to Delete This Coupon!!');"><img src="images/1400777057_delete.png" height="12" title="Remove Coupon" width="12"> </a></span>
                                    </div>
                                    <?php } ?>
                                    ...
                                    <?php if($_SESSION['coupon_code'.$ses_rest_id."_".$array_sel_groups['id']]==''){ ?>
                                        ...
                                        I have a Coupon Code</div></label>
                                        
                                    <?php } ?>
            
                                    <div id="apply_coupon_grp" class="cpn" style="display:none;">
                                        <div class="left lower-code-row" style="padding-top:10px;">

                                            <span id="coupon_text" style="display:none;">Coupon Code : </span>
                                        </div>
                                        <div class="left" style="width:100%;">
                                        <input type="text" name="coupon_code_grp" id="coupon_code_grp" class="profilefield_right" style="float:left; width:154px;  padding:5px; margin:0;">
                                        
                                        <input type="button" name="apply" class="check_order_button" id="apply" value="Apply" onClick="check_group_coupon_code('<?php echo $total_amt; ?>','<?php echo $_REQUEST['id']; ?>');" style="text-decoration:none; margin:0;  padding:5px 22px;">
                                        </div>
                                    ...
                                    <?php if($_SESSION['user_reward_point'.$ses_rest_id.'_'.$_SESSION['group_order_details_id'.$ses_rest_id]]!=''){ ?>
                                    <div class="left lower-code-row mrgn-btn-sm">
                                        <span id="reward_text">Reward Redeemed : </span>
                                        <span id="reward" class="cupon-code sm"><?php echo $_SESSION['user_reward_point'.$ses_rest_id.'_'.$_SESSION['group_order_details_id'.$ses_rest_id]]; ?></span>
                                        <span id="reward_point_span_group" class="cupon-action"><a href="javascript:void(0);" onClick="change_group_reward()"><img src="images/change-coupon.png" height="12" title="Change Reward Point" width="12"></a><a href="remove_reward_group.php?id=<?php echo $_REQUEST['id']; ?>" onClick="return confirm('Are you sure you want to Delete This Reward Point From Subtotal!!');"><img src="images/1400777057_delete.png" height="12" title="Remove Reward" width="12"> </a></span>
                                    </div>
                                    <?php } ?>
                                    ...
                                    <?php if($_SESSION['user_reward_point'.$ses_rest_id.'_'.$array_sel_groups['id']] == ''){ ?>
                                        <label class="coupon-check-label"><div id="reward_show_span">
                                        <input type="checkbox" id="have_group_reward" name="have_group_reward" onClick="open_group_reward_div();" class="regular-checkbox big-checkbox">
                                        <label for="have_group_reward"></label> 
                                        I want to use my Reward Points</div></label>
                                    <?php } ?>
                                    
                                    
                                    <div id="reward_div_group" style="display:none;">
                                        <input type="text" name="group_reward_point" id="group_reward_point" class="profilefield_right" style="float:left; width:154px;  padding:5px; margin:0; margin-top:9px;" onKeyPress="return goodchars(event,'1234567890');" >
                                        
                                        <input type="button" class="check_order_button" name="reward_point_submit" value="Apply" style="text-decoration: none; margin-top: 10px; margin-left: -1px; padding: 5px 22px;" onClick="get_reward_point_group('<?php echo $total_amt; ?>','<?php echo $_REQUEST['id']; ?>');">
                                    </div>
                                    <script>
									function open_group_reward_div(){
										var $j = jQuery.noConflict();
										if($j('input[name="have_group_reward"]').prop("checked") == true){
											 $j("#reward_div_group").slideDown(1000);
										 }else{
											 $j("#reward_div_group").slideUp(1000);
										 }
									}
									
									function change_group_reward(){
										var $j = jQuery.noConflict();
										$j("#reward_div_group").slideDown(1000);
										$j("#reward_point_span_group").hide(1000);
									}
									
									function get_reward_point_group(amount,res_id){
										if($j("#group_reward_point").val() == '')
										{
											alert("This Field cannot be left Blank!!");
											$j("#group_reward_point").focus();
											return false;
										}else{
											var reward_point = $j("#group_reward_point").val();
                                    ...
                                    <div class="small friend-subtotal">Tax: 
                                    <span class="friend-subtotal-total"><?php $tax_amt = ($sql_restaurant_delivery_details1['tax']/100 * $total_amt);
                                    ...
                                    <?php if($_SESSION['coupon_discount'.$ses_rest_id."_".$array_sel_groups['id']]!=''){ ?>
                                        <div class="small friend-subtotal">Coupon Discount: 
                                            <span class="friend-subtotal-total">
                                                <?php echo "$".$_SESSION['coupon_discount'.$ses_rest_id."_".$_SESSION['group_order_details_id'.$ses_rest_id]]; ?>
                                            </span>
                                        </div>
                                    <?php } ?>
                                    
                                    <?php if($_SESSION['reward_point'.$ses_rest_id."_".$array_sel_groups['id']]!=''){ ?>
                                        <div class="small friend-subtotal">Reward Point Discount: 
                                            <span class="friend-subtotal-total">
                                                <?php echo "$".$_SESSION['reward_point'.$ses_rest_id."_".$_SESSION['group_order_details_id'.$ses_rest_id]]; ?>
                                            </span>
                                        </div>
                                    <?php } ?>
                                    ...
                                    <div id="del_crge<?php echo $_SESSION['group_order_details_id'.$ses_rest_id]; ?>" style="display:<?php echo $del_blk_dis; ?>">
                                        <div class="small friend-subtotal del_crge">Delivery Charge: 
                                            <span class="friend-subtotal-total">$<?php $delivery_crge_grp = $_SESSION['del_charge'.$ses_rest_id.'_'.$array_sel_groups['id']];
                                    ...
                                    <?php } ?>
                                    <?php $sub_total_amt = $total_aft_coupon_dis + $tax_amt1;
									$sub_total_del = $total_aft_coupon_dis + $tax_amt1 + $_SESSION['del_charge'.$ses_rest_id.'_'.$array_sel_groups['id']];
									 ?>
                                    ...
                                    <?php
										...
										<div class="user_status"></div><p>Cart is Empty</p>
									<?php }
									 ?>
                            ...
                            <div class="cost_summary" id="totalblock">
                            	...
                            	<div class="f_clear">
                                    Tax:
                                    <span>$<?php echo $total_tax; ?></span>
                                </div>
                                <?php if($coupon_diss!='0'){ ?>
                                    <div class="f_clear">
                                        Coupon Discount:
                                        <span>$<?php echo $coupon_diss; ?></span>
                                    </div>
                                <?php } ?>
                                <?php if($reward_point_dis!='0'){ ?>
                                	<div class="f_clear">
                                        Reward Point Discount:
                                        <span>$<?php echo $reward_point_dis; ?></span>
                                    </div>
                                <?php } ?>
                                <div class="f_clear" style="display:<?php echo $del_blk_dis; ?>" id="final_del_div">
                                    Delivery Charge:
                                    <span>$<?php echo $total_del_charge; ?></span>
                                </div>
                                <div class="f_clear">
                                    Global Subtotal:
                                    <span>$<?php echo $total_sub_total; ?></span>
                                </div>
                                <?php 
								...
								?>
                                <div class="f_clear" id="total" style="display:<?php echo $del_blk_div; ?>">
                                	Global Total:
                                    <span>$<?php echo $grand_total; ?></span>
                                </div>
                                <div class="f_clear" id="total_del" style="display:<?php echo $del_blk_div1; ?>">
                                    Global Total:
                                    <span>$<?php echo $grand_total_del; ?></span>
                                </div>
                            </div>
                            ...
                            <div class="cost_summary" id="totalblock">
                                ...
                                <div style="float:left;">
                                    <input type="radio" name="del_method_grp" id="pickup_grp" value="pickup" onClick="enable_checkout(this.value);">PICKUP
                                    <img src="images/pickup.png">
                                </div>
                                <div style="float:right;">
                                    <input type="radio" name="del_method_grp" id="del_grp" value="delivery" <?php if($_REQUEST['type'] == 'del'){ ?> checked = "checked" <?php } ?> <?php if($_SESSION['total_amt'.$_SESSION['group_order_details_id'.$ses_rest_id]] <  $sql_restaurant_delivery_details1['minimum_ammount']){ ?> disabled <?php } ?> onClick="enable_checkout(this.value);">DELIVERY
							...
							?>
                            <div id="checkout_disabled_btn" style="display:<?php echo $del_sty_blk1; ?>">
                                <a href="javascript:void(0);" class="checkout_grey" id="summary_btn">
                                    CHECKOUT
                                </a>
                            </div>
                            <?php
							...
							?>
                            <div id="checkout_enabled_btn_pickup" style="display:none;">
                                <a href="<?php echo $pickup_lnk; ?>" class="checkout_blue" id="summary_btn">
                                    CHECKOUT
                                </a>
                            </div>
                            <?php 
                            ...
                            <div id="checkout_enabled_btn_delivery" style="display:<?php echo $del_sty_blk; ?>;">
                                <a href="<?php echo $delivery_lnk; ?>" class="checkout_blue" id="summary_btn" <?php if($_SESSION['del_charge'.$ses_rest_id.'_'.$_SESSION['group_order_details_id'.$ses_rest_id]] == ''){ ?> onClick="open_del_crg_div();" <?php } ?> >
                                    CHECKOUT
                                </a>
                            </div>
                        ...
                        <input type="hidden" name="hid_rest_id" id="hid_rest_id" value="<?php echo $_REQUEST['id']; ?>">
                            <div class="pop_item2" style="display:none; margin:250px 0 0 0;" id="del_add_grp1">
                                ...
                                <h3>We want to make sure this restaurant is convenient for delivery or pickup.</h3>
                                  ...
                                  <div><input name="submit_del_grp" id="submit" type="submit" value="VERIFY ADDRESS" class="pop_button" style="width:150px;" /></div>
                            </div>
                        </form>
...
?>
<div id="shared_div" style="display:none;" class="white_content"  >
...
Name <input type="text" name="name" id="name" placeholder="Your Name" class="restaurant" /> <br>
Email <input type="text" name="email_adm" id="email_adm" placeholder="Your Email" class="restaurant"> <br>
Share Link <input type="text" name="share_link" id="share_link" class="restaurant" value="https://foodandmenu.com/restaurant.php?id=<?php echo $_REQUEST['id'];?>&share=<?php echo $share_no; ?>" /> <br>
<input type="hidden" id="link" value="<?php echo $share_no; ?>">

Or share link by: <br>

<a href="javascript:void(0);" id="email_a" onClick="email_div_show()">Email</a> <br>

<div id="email_div" style="display:none;">
<input type="text" name="email" id="email" placeholder="Enter the Email" class="restaurant">
<input type="button" name="send" id="send" value="Send" onClick="send_email();">
</div>

<input type="submit" name="submit" id="submit" value="Start Your Order">
...
?> 
<div id="group_add_div" style="display:<?php echo $display2; ?>;" class="white_content"  >
<div class="l-contnt up-contnt"> 
Joining <?php echo $adm_name; ?>'s Shared Cart<br>
for <?php echo $res_name; ?>
...
Name <input type="text" name="chld_name" id="chld_name" placeholder="Your Name" class="restaurant" />
