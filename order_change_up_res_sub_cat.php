<?php
  ob_start();
	...
	$sql_team_order=sprintf("SELECT show_order,id FROM restaurant_menu_subcategory WHERE show_order<'%s' AND category_id = '".$cat_id."' AND restaurant_id = '".$res_id."' order by show_order desc limit 0,1",$order);
