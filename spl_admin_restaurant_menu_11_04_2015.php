...
//print_r($_POST['sub_category1']);
	...
	header("location:spl_admin_multimedia.php");
}
?>
...
function sort_function(sort_by){
	location.href = 'spl_admin_restaurant_menu.php?sort_order='+sort_by;
}
</script>
...
<p style="text-align:center;">Menu item updated successfully</p>
<?php } ?>
...
$res_basic_info_detail=mysql_fetch_array(mysql_query("SELECT * FROM restaurant_basic_info where user_id='".$_SESSION['restaurant_id']."'"));
$sql_select = mysql_query("SELECT * FROM restaurant_menu_item WHERE restaurant_id='".$res_basic_info_detail['id']."'");
...
<table width="100%" border="1" bordercolor="c5c8d5" cellspacing="0" cellpadding="0" style="border-collapse:collapse; margin-top:20px;" align="center">
  <tr>
    <td width="22%" class="all_restaurant">Menu Item Name</td>
    <td width="18%" class="all_restaurant">Category</td>
    <td width="20%" class="all_restaurant">Sub Category</td>
    <td width="19%" class="all_restaurant">Price ($)</td>
    <td width="21%" class="all_restaurant">Image</td>
  ...
  <tr>
	...
	echo $sql_category['category_name']?></td>
    <td class="all_restaurant2"><?php $sql_sub_category = mysql_fetch_array(mysql_query("SELECT * FROM  restaurant_menu_subcategory WHERE id = '".$array_select['sub_category_id']."'"));echo $sql_sub_category['subcategory_name']?></td>
    <td class="all_restaurant2"><?php echo $array_select['price']?></td>
    <td class="all_restaurant2"><?php if($array_select['menu_pic']!=""){?><img src="thumb_images/<?php echo $array_select['menu_pic']?>" width="60" height="60"><?php } else{?><img src="uploads/no_image.jpg" width="60" height="60"> <?php }?></td>
    <td class="all_restaurant2"><a href="edit_restaurant_menu_item1.php?menu_id=<?php echo $array_select['id']?>" class="all_edit">Edit</a></td>
  </tr>
<?php } ?>
</table></div>
<?php
...
<?php
if($_SESSION['restid']!=""){
$res_basic_info_detail=mysql_fetch_array(mysql_query("SELECT * FROM restaurant_basic_info where user_id='".$_SESSION['restid']."'"));
//echo ("SELECT * FROM restaurant_menu_item WHERE restaurant_id='".$restaurant_id."'");
$sql_select = mysql_query("SELECT * FROM restaurant_menu_item WHERE restaurant_id='".$restaurant_id."'");
if($_REQUEST['sort_order']){
$sql_select.= " ORDER BY ".$_REQUEST['sort_order']."";
}
...
<table width="100%" border="1" bordercolor="c5c8d5" cellspacing="0" cellpadding="0" style="border-collapse:collapse; margin-top:20px;" align="center">
  <tr>
    <td width="22%" class="all_restaurant"><a href="javascript:void(0)" onClick="sort_function('menu_name')" class="heading_link">Menu Item Name</a></td>
    <td width="18%" class="all_restaurant"><a href="javascript:void(0)" onClick="sort_function('category_name')" class="heading_link">Category</a></td>
    <td width="20%" class="all_restaurant"><a href="javascript:void(0)" onClick="sort_function('sub_category_name')" class="heading_link">Sub Category</a></td>
    <td width="19%" class="all_restaurant"><a href="javascript:void(0)" onClick="sort_function('menu_name')" class="heading_link">Price ($)</a></td>
    <td width="21%" class="all_restaurant">Image</td>
    <td width="21%" class="all_restaurant">Action</td>
  </tr>
  <?php
  ...
  <tr>
    ...
    <?php /*?><?php echo $array_select['category_name']; ?><?php */?>
    </td>
    ...
    <?php /*?><?php echo $array_select['sub_category_name']; ?><?php */?>
    </td>
    <td class="all_restaurant2"><?php echo $array_select['price']?></td>
    ...
    <td class="all_restaurant2"><a href="edit_restaurant_menu_item1_spl_admin.php?menu_id=<?php echo $array_select['id']?>" class="all_edit">Edit</a></td>
  </tr>
<?php } ?>
</table></div>
<?php
