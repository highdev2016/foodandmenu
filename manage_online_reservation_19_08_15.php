      ...
      <?php include ("includes/restaurant_nav_menu.php");?>
        ...
        <div class="restaurant_cont_field" style="margin:0 15px;">
          ...
          <form name="frm" method="post" action="manage_online_reservation.php">
            <table class="sec-pnl-top my_report_table" width="100%">
              <tr>
                <td width="196">Restaurant Name : </td>
                <td width="200"><input type="text" name="" value="<?php echo $_REQUEST['restaurant_name'];?>" style="height:23px;  width: 168px;" class="restaurant"></td>
                <td width="253">Customer Name : </td>
                <td width="183"><input type="text" name="customer_name" value="<?php echo $_REQUEST['customer_name'];?>" style="height:23px;  width: 168px;" class="restaurant"></td>    
                <td width="223"><span> Contact Email : </span> </td>
                <td width="216"><input type="text" name="contact_email" value="<?php echo $_REQUEST['contact_email'];?>" style="height:23px;  width: 168px;" class="restaurant"></td>            
               </tr>
               ...
               <tr>
				...
				<td  width="253"><div id="start_dt1" style="visibility:<?php echo $display; ?>;"> Start Date : </div></td>	
				<td  width="183" id="start_dt2" style="visibility:<?php echo $display; ?>">
					<input type="text" name="start_date" id="start_date" value="<?php echo $_REQUEST['start_date']; ?>" readonly>
				</td>
				<td  width="223"><div id="end_dt1" style="visibility:<?php echo $display; ?>;">End Date : </div></td>	
				<td  width="216" id="end_dt2" style="visibility:<?php echo $display; ?>">
              ...
              <tr>
              	...
              	<td>&nbsp;</td>
              	<td>&nbsp;</td>              	
              	<td class="srcpnl-1"  align="right" colspan="3">
...
<option value="100"<?php if($_REQUEST['item_per_page'] == 100) { ?> selected <?php } ?>>100</option>
          ...
          <table width="99%" border="1" bordercolor="c5c8d5" cellspacing="0" cellpadding="0" style="border-collapse:collapse; margin-top:20px;" align="center">
            <tr>
              ...
              <th width="14%" class="all_restaurant"><a href="javascript:void(0)" onClick="sort_function('date','<?php echo $_REQUEST['restaurant_name']; ?>','<?php echo $_REQUEST['customer_name']; ?>','<?php echo $_REQUEST['contact_email']; ?>')" class="heading_link">Date</a></th>
              <th width="12%" class="all_restaurant"><a href="javascript:void(0)" onClick="sort_function('restaurant_name','<?php echo $_REQUEST['restaurant_name']; ?>','<?php echo $_REQUEST['customer_name']; ?>','<?php echo $_REQUEST['contact_email']; ?>')" class="heading_link">Restaurant Name</a></th>
              <th width="14%" class="all_restaurant"><a href="javascript:void(0)" onClick="sort_function('customer_name','<?php echo $_REQUEST['restaurant_name']; ?>','<?php echo $_REQUEST['customer_name']; ?>','<?php echo $_REQUEST['contact_email']; ?>')" class="heading_link">Customer Name</a></th>
              <th width="14%" class="all_restaurant"><a href="javascript:void(0)" onClick="sort_function('contact_email','<?php echo $_REQUEST['restaurant_name']; ?>','<?php echo $_REQUEST['customer_name']; ?>','<?php echo $_REQUEST['contact_email']; ?>')" class="heading_link">Contact Email</a></th>
              <th width="14%" class="all_restaurant"><a href="javascript:void(0)" onClick="sort_function('people','<?php echo $_REQUEST['restaurant_name']; ?>','<?php echo $_REQUEST['customer_name']; ?>','<?php echo $_REQUEST['contact_email']; ?>')" class="heading_link">No of people</a></th>
              <th width="14%" class="all_restaurant"><a href="javascript:void(0)" onClick="sort_function('comments','<?php echo $_REQUEST['restaurant_name']; ?>','<?php echo $_REQUEST['customer_name']; ?>','<?php echo $_REQUEST['contact_email']; ?>')" class="heading_link">Comments</a></th>
              <th width="14%" class="all_restaurant">Action</td>
