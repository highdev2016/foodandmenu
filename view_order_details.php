...
?>
            ...
            <div class="ordr-tbl">
            	...
            	<div class="clear"></div>
            	<p><a href="check_out.php?type=<?php echo $sql_menu_order['type']; ?>&order_id=<?php echo $sql_menu_order['order_id']; ?>&reorder=1" class="check_order_button" style="text-decoration: none; margin-left: 0px; float: left; margin-top:15px;"> Resubmit Order </a></p>
          		<div class="clear"></div>
            </div>
