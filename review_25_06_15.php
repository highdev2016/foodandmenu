...
<?php //echo change_dateformat_reverse($row_updated_review['post_date']); ?>  <!-- By <span><?php //echo $row_updated_review['customer_name']?></span> -->  </h5>
                                        ...
                                        <div class="rating_content_two review-likes rviw">
		                                 ...
		                                 <div class="viewers_comment">
		                                    ...
		                                    <li><?php if(isset($_SESSION['customer_id'])){?><a href="javascript:void(0);" onClick="FBShareOp('<?php echo addslashes($row_updated_review['customer_name'])?>','<?php echo $row_updated_review['restaurant_id']; ?>','<?php echo addslashes($cust_img)?>','<?php echo $cust_rev; ?>','thumb_images')">Share with facebook</a><?php }else{ ?><a href="login.php">Share with facebook</a><?php } ?></li>
										...
										<?php //echo change_dateformat_reverse($res_review['post_date']); ?>  <!-- By <span><?php //echo $res_review['customer_name']?></span> --></h5>
                                         ...
                                         <div class="rating_content_two review-likes rviw">
		                               	...
		                               	<div class="viewers_comment">
											...
											$cust_rev = str_replace("'","",$res_review['customer_review']);
											?>
											<li><?php if(isset($_SESSION['customer_id'])){?><a href="javascript:void(0);" onClick="FBShareOp('<?php echo addslashes($res_review['customer_name'])?>','<?php echo $res_review['restaurant_id']; ?>','<?php echo addslashes($cust_img)?>','<?php echo $cust_rev; ?>','thumb_images')">Share with facebook</a><?php }else{ ?><a href="login.php">Share with facebook</a><?php } ?></li>
