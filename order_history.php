 ...
 // echo $sql_order1;
  ...
  if(mysql_num_rows($sql_order)>0){
    ...
    <?php echo $sql_restaurant_name['restaurant_name']; ?>
              ...
              <td class="all_restaurant2"><?php echo  "$ ".($array_order['total_price']); ?></td>
              ...
              <td class="all_restaurant2"><a href="javascript:void(0);" onClick="open_details_div('<?php echo $array_order['order_id']; ?>');"  class="used_cls">View Details</a>
             <?php if($array_order['status']!="Refund" && $customer_id==1369)
			      {
				  ?>
                  ||
             <a href="https://foodandmenu.com/Authorize.Net-XML-master/examples/aim/createTransactionRequest_refund.php?order_id=<?php echo $array_order['order_id']; ?>&amount=<?=$array_order['total_price']?>"   class="used_cls">Refund parment</a>
              <?php } ?>
              </td>
            </tr>
