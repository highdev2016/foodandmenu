...
{
	header("location:export_live_orders_excel.php?order_id=".$_REQUEST['order_id']."&customer_name=".$_REQUEST['customer_name']."&customer_phone=".$_REQUEST['customer_phone']."&customer_address=".$_REQUEST['customer_address']."&status=".$_REQUEST['status']."&mod_date=".$_REQUEST['mod_date']."&start_date=".$_REQUEST['start_date']."&end_date=".$_REQUEST['end_date']);
}
...
<table class="sec-pnl-top">
	<tr>
		...
		<td width="184"><input type="text" name="order_id" value="<?php echo $_REQUEST['order_id'];?>" style="height:23px;" class="restaurant"></td>
