...
if($_REQUEST['delete_holiday_hrs']!=''){
	...
	header("location:spl_admin_additional.php?restaurant_edit_id=".$_REQUEST['restaurant_edit_id']."&hol_del_success=1");
}
/*------------------------------- Delete Monday Business Hours ---------------------------------------------*/
...
if($_REQUEST['delete_mon_buss_hrs']!=''){
	...
	header("location:spl_admin_additional.php?restaurant_edit_id=".$_REQUEST['restaurant_edit_id']."&bus_del_success=1");
}
/*------------------------------- Delete Monday Business Hours ---------------------------------------------*/
...
if($_REQUEST['delete_mon_del_hrs']!=''){
	...
	header("location:spl_admin_additional.php?restaurant_edit_id=".$_REQUEST['restaurant_edit_id']."&del_del_success=1");
}
/*------------------------------- Delete Monday Delivery Hours ---------------------------------------------*/
...
if($_REQUEST['delete_mon_pickup_hrs']!=''){
	...
	header("location:spl_admin_additional.php?restaurant_edit_id=".$_REQUEST['restaurant_edit_id']."&pickup_del_success=1");
}
/*------------------------------- Delete Monday Pickup Hours ---------------------------------------------*/
...
if($_REQUEST['delete']!=''){
	...
	header("location:spl_admin_additional.php?success=1");
}
...
if($_REQUEST['delete_pickup_hrs']!=''){
	...
	header("location:spl_admin_additional.php?restaurant_edit_id=".$_REQUEST['restaurant_edit_id']."&del_pickup_success=1");
}

if($_REQUEST['delete_del_charge']!=''){
	mysql_query("DELETE FROM restaurant_delivery_charge WHERE id = '".$_REQUEST['delete_del_charge']."'");
	header("location:spl_admin_additional.php?del_success=1");
}
...
while($array_del_charges = mysql_fetch_array($sql_select_del_charges)){
	...
	header("location:spl_admin_restaurant_menu.php");
	}
	else{
		header("lcation:spl_admin_additional.php?status=error");
	}
}
?>
...
<div class="restaurant_nav">
                    ...
                    <li><a href="spl_admin_additional.php" class="active7">Additional Info</a></li>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="spl_admin_additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_mon_buss_hrs=<?php echo $array_monday_buss_hrs['id'];?>">
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="spl_admin_additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_tue_buss_hrs=<?php echo $array_tuesday_buss_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="spl_admin_additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_wed_buss_hrs=<?php echo $array_wednesday_buss_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="spl_admin_additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_thu_buss_hrs=<?php echo $array_thursday_buss_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="spl_admin_additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_fri_buss_hrs=<?php echo $array_friday_buss_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="spl_admin_additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_sat_buss_hrs=<?php echo $array_saturday_buss_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="spl_admin_additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_sun_buss_hrs=<?php echo $array_sunday_buss_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<?php 
$sql_holidays_hrs = mysql_query("SELECT * FROM restaurant_holidays_master WHERE restaurant_id = '".$_REQUEST['restaurant_edit_id']."'");
if(mysql_num_rows($sql_holidays_hrs) > 0){
$id_holiday = 1;
while($array_holidays_hrs = mysql_fetch_array($sql_holidays_hrs)){ ?>
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="edit_additional.php?restaurant_edit_id=<?php echo $_REQUEST['restaurant_edit_id'];?>&delete_holiday_hrs=<?php echo $array_holidays_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<?php /*?><div style="margin-left:173px;"><a href="javascript:void(0);" onClick="add_cell(document.getElementById('item_id').value)" id="item_focus"><img src="images/add_bus_hrs.png"  style="margin-left:0;" width="213"/></a></div>
...
<a href="spl_admin_additional.php?delete=<?php echo $array_business_extra_hours['id'];?>" >
<img  src="images/Close_Box_Red.png">
</a>
</div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="spl_admin_additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_mon_del_hrs=<?php echo $array_monday_del_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="spl_admin_additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_tue_del_hrs=<?php echo $array_tuesday_del_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="spl_admin_additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_wed_del_hrs=<?php echo $array_wednesday_del_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="spl_admin_additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_thu_del_hrs=<?php echo $array_thursday_del_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_fri_del_hrs=<?php echo $array_friday_del_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="spl_admin_additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_sat_del_hrs=<?php echo $array_saturday_del_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="spl_admin_additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_sun_del_hrs=<?php echo $array_sunday_del_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;">
<a href="spl_admin_additional.php?delete_del_charge=<?php echo $array_del_charges['id'];?>" >
<img  src="images/Close_Box_Red.png">
</a>
</div>
<p>Delivery Range (miles) :</p>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="spl_admin_additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_mon_pickup_hrs=<?php echo $array_monday_pickup_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="spl_admin_additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_tue_pickup_hrs=<?php echo $array_tuesday_pickup_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="spl_admin_additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_wed_pickup_hrs=<?php echo $array_wednesday_pickup_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="spl_admin_additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_thu_pickup_hrs=<?php echo $array_thursday_pickup_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="spl_admin_additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_fri_pickup_hrs=<?php echo $array_friday_pickup_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="spl_admin_additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_sat_pickup_hrs=<?php echo $array_saturday_pickup_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="spl_admin_additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_sun_pickup_hrs=<?php echo $array_sunday_pickup_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
