    ...
    <?php } ?>
        ...
        <div class="check_form_section">
            ...
            <div class="check_form_box check_new_form">
                ...
                <input name="apt_no" type="text" id="apt_no" class="regifield"  value="<?php echo $sql_customer_details['apt_no']?>" style="width:139px !important;"  /> 
                </div>
                
                <div class="first_name last_nme">
                <p>Gate Code</p>
                <input name="gate_code" type="text" id="gate_code" class="regifield"  value="<?php echo $sql_customer_details['gate_code']?>" style="width:139px !important;"  />
                </div>
                </div>
            ...
            <div class="check_form_box check_new_form">
                ...
                <p>Apartment Name </p>
                <input name="apt_name_billing" type="text" id="apt_name_billing" class="regifield"  value="<?php echo $sql_customer_details['apt_name']?>" />
                <div class="clear"></div>
                
                <div class="first_name">
                <p>Apartment Number</p>                                     
                <input name="apt_no_billing" type="text" id="apt_no_billing" class="regifield"  value="<?php echo $sql_customer_details['apt_no']?>" style="width:139px !important;"  /> 
                </div>
                
                <div class="first_name last_nme">
                <p>Gate Code</p>
                <input name="gate_code_billing" type="text" id="gate_code_billing" class="regifield"  value="<?php echo $sql_customer_details['gate_code']?>" style="width:139px !important;"  />
                </div>
                </div>
                <div class="check_form" id="info_div_billing" style="display:<?php echo $display_other; ?>">
                <p>Information </p>
                <input name="information_billing" type="text" id="information_billing" class="regifield"  value="<?php echo $sql_customer_details['information']?>"  />
                </div>
                <div class="check_form">
                    <p>City*</p>
