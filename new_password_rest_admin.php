...
$password=md5($_REQUEST['password']);
	$sql_new_password=mysql_query("UPDATE  restaurant_admin_panel SET password='".$password."' WHERE id = '".$_REQUEST['id']."'");
	if($sql_new_password){
		$success = 1;
	}	
	header("location:restaurant_admin_login.php?success=1");
 }
?>
