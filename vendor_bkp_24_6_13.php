	...
	{  
		header("location:vendor.php?error=1");
			...
			$cms_rep = '<div style="width:100%;clear:both; border-bottom:3px solid #04303d;">
        				...
        				<img src="http://readysolution.info/restaurant/images/logo.png" alt="" style="margin:10px 0; float:left;" />
...
<?php
$i=1;
$res_vendors=mysql_query("SELECT * FROM restaurant_vendors WHERE 1");
...
<?php if(isset($_SESSION['customer_id'])){?>
  <ul>
		<li><a class="various1" href="#inline<?php echo $i;?>" title="Lorem ipsum dolor sit amet"><img src="images/view_profile.png" width="130" height="39" /></a></li>
	</ul>
    <?php } ?>
...
<p>Email : <?php echo $row_vendors['email'];?></p>

<p>Social Media : <?php echo $row_vendors['social_media'];?></p>

<p>Website : <?php echo $row_vendors['website'];?></p>
