...
<div class="body_section">
    <div class="body_container">
        ...
        <div class="main_body">
            <div class="food_body_cont">
                <div class="food_content">
                  ...
                  <?php /*?><?php if($_REQUEST['abuse_status'] == 1){?>
                    <p style="color:#0C0;float: left;font-size: 15px;font-weight: normal; padding:5px 0 0 0; margin-left:385px;">Your request is sent to Admin</p><?php } ?><?php */?>
       <?php
	   ...
	   ?>             
                        ...
                        <a href="write_review.php?id=<?php echo $_REQUEST['id'];?>&deal_id=<?php echo $_REQUEST['deal_id'];?>">Write a Review</a>
