...
<?php } ?>
    ...
    <?php } ?>
                                        ...
                                        ?>
                                        <span id="follow_unfollowGroup"><a href="javascript:void(0);" onClick="addClassfuncGroup();">Follow Me</a></span>
                                    </div>
                                    <script src="https://maps.googleapis.com/maps/api/js?v=3.exp&libraries=places"></script> 
                                    <script>
...
<?php } ?>
        ...
        <script type="text/javascript">
			...
			function removeClassfunc()
			{
				...
				$j("#follow_unfollow").html('<a href="javascript:void(0);" onClick="addClassfunc();">Follow Me</a>');
			...
			function addClassfuncGroup()
			{
				...
				$j("#follow_unfollowGroup").html('<a href="javascript:void(0);" onClick="removeClassfuncGroup();">Unfollow Me</a>');
				scroll_cartGroup();
			}
			function removeClassfuncGroup()
			{
				...
				$j("#follow_unfollowGroup").html('<a href="javascript:void(0);" onClick="addClassfuncGroup();">Follow Me</a>');
