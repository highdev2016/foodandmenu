...
if($_REQUEST['submit'] == "Search")
{
	if($_REQUEST['start_date'] != '')
	{
		if($_REQUEST['end_date'] != '')
		{
			$form_end_date = $_REQUEST['end_date'];
		}
	}
...
<div class="tab-look-restu" style="padding:2%;">
            ...
            <table class="sec-pnl-top" width="100%">
              <tr>
               <td width="150">
                ...
                <input type="text" name="end_date" id="end_date" class="restaurant" style="width: 133px ! important; text-align: left;" value="<?php echo $form_end_date; ?>" autocomplete="off">
                </td>
    ...
    <span class="blnce-head">Summary for <?php echo $start_date_summary; ?> - <?php echo $end_date_summary; ?></span>
	...
	<div id="postswrapper" style="margin-bottom:50px;">
