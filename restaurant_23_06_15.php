...
<body onLoad="init();">
    ...
    <style type="text/css">
        ...
        .pop_item{position: absolute;margin:-550px -223px 0px 0px;background:#f5f5f5;box-shadow:0px 1px 5px 0px #aeaeae;width: 500px;-moz-border-radius:5px;-webkit-border-radius:5px;border-radius:5px; z-index:999999999999;
                  width:900px;}
