...
if($_REQUEST['delete_holiday_hrs']!=''){
	...
	header("location:admin_additional.php?restaurant_edit_id=".$_REQUEST['restaurant_edit_id']."&hol_del_success=1");
}
/*------------------------------- Delete Monday Business Hours ---------------------------------------------*/
...
if($_REQUEST['delete_mon_buss_hrs']!=''){
	...
	header("location:admin_additional.php?restaurant_edit_id=".$_REQUEST['restaurant_edit_id']."&bus_del_success=1");
}
/*------------------------------- Delete Monday Business Hours ---------------------------------------------*/
...
if($_REQUEST['delete_mon_del_hrs']!=''){
	...
	header("location:admin_additional.php?restaurant_edit_id=".$_REQUEST['restaurant_edit_id']."&del_del_success=1");
}
/*------------------------------- Delete Monday Delivery Hours ---------------------------------------------*/
...
if($_REQUEST['delete_mon_pickup_hrs']!=''){
	...
	header("location:admin_additional.php?restaurant_edit_id=".$_REQUEST['restaurant_edit_id']."&pickup_del_success=1");
}
/*------------------------------- Delete Monday Pickup Hours ---------------------------------------------*/
...
if($_REQUEST['delete']!=''){
	...
	header("location:admin_additional.php?success=1");
}
...
if($_REQUEST['delete_pickup_hrs']!=''){
	...
	header("location:admin_additional.php?restaurant_edit_id=".$_REQUEST['restaurant_edit_id']."&del_pickup_success=1");
}

if($_REQUEST['delete_del_charge']!=''){
	mysql_query("DELETE FROM restaurant_delivery_charge WHERE id = '".$_REQUEST['delete_del_charge']."'");
	header("location:admin_additional.php?del_success=1");
}
...
if(count($_POST)>0 && $_REQUEST['submit']=="Save & Continue")
{
	...
	$sql_select_business_extrahours = mysql_query("SELECT * FROM restaurant_extra_business_hours WHERE restaurant_id = '".$restaurant_id."'");
	$k = 1;
	...
	$sql_select_business_hrs = mysql_query("SELECT * FROM restaurant_delivery_details_master WHERE restaurant_id = '".$restaurant_id."'");
	$i = 1;
	...
	$sql_select_pickup_hrs = mysql_query("SELECT * FROM restaurant_take_out_master WHERE restaurant_id = '".$restaurant_id."'");
	$m = 1;
...
while($array_del_charges = mysql_fetch_array($sql_select_del_charges)){
	...
	header("location:admin_restaurant_menu.php");
	}
	else{
		header("lcation:admin_additional.php?status=error");
	}
}
?>
...
<ul>
    ...
    <li><a href="admin_additional.php"  class="active7">Additional Info</a></li>
...
<?		 
	...
	if($row_basic_info_detail>0)
	{
		...
		$res_business_delivery_detail=mysql_query("SELECT * FROM restaurant_business_delivery_takeout_info where restaurant_id='".$_SESSION['restid']."'");
		...
		$res_service_detail=mysql_query("SELECT * FROM restaurant_services_dress_payment where restaurant_id='".$_SESSION['restid']."'");
		...
		$business_extra_hours = mysql_query("SELECT * FROM restaurant_extra_business_hours WHERE restaurant_id='".$_SESSION['restid']."'");
		
		$business_delivery_hours = mysql_query("SELECT * FROM restaurant_delivery_details_master WHERE restaurant_id = '".$_SESSION['restid']."' ");
		
		$business_pickup_hours = mysql_query("SELECT * FROM restaurant_take_out_master WHERE restaurant_id = '".$_SESSION['restid']."' ");
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="admin_additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_mon_buss_hrs=<?php echo $array_monday_buss_hrs['id'];?>">
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="admin_additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_tue_buss_hrs=<?php echo $array_tuesday_buss_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="admin_additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_wed_buss_hrs=<?php echo $array_wednesday_buss_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="admin_additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_thu_buss_hrs=<?php echo $array_thursday_buss_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="admin_additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_fri_buss_hrs=<?php echo $array_friday_buss_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="admin_additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_sat_buss_hrs=<?php echo $array_saturday_buss_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="admin_additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_sun_buss_hrs=<?php echo $array_sunday_buss_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="admin_additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_holiday_hrs=<?php echo $array_holidays_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<a href="admin_additional.php?delete=<?php echo $array_business_extra_hours['id'];?>" >
<img  src="images/Close_Box_Red.png">
</a>
</div>
...
<span style="color:#888888;">to</span>
<input name="del_hours_to" id="del_hours_to" type="text" class="restaurant" value="<?php echo $result_business_delivery_details['del_hours_to']; ?>" style="width:93px;" />
<?php */?>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="admin_additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_mon_del_hrs=<?php echo $array_monday_del_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="admin_additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_tue_del_hrs=<?php echo $array_tuesday_del_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="admin_additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_wed_del_hrs=<?php echo $array_wednesday_del_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="admin_additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_thu_del_hrs=<?php echo $array_thursday_del_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="admin_additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_sat_del_hrs=<?php echo $array_saturday_del_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="admin_additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_sun_del_hrs=<?php echo $array_sunday_del_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;">
<a href="admin_admin_additional.php?delete_del_charge=<?php echo $array_del_charges['id'];?>" >
<img  src="images/Close_Box_Red.png">
</a>
</div>
<p>Delivery Range (miles) :</p>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="admin_additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_mon_pickup_hrs=<?php echo $array_monday_pickup_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="admin_additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_tue_pickup_hrs=<?php echo $array_tuesday_pickup_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="admin_additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_wed_pickup_hrs=<?php echo $array_wednesday_pickup_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="admin_additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_thu_pickup_hrs=<?php echo $array_thursday_pickup_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="admin_additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_fri_pickup_hrs=<?php echo $array_friday_pickup_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="admin_additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_sat_pickup_hrs=<?php echo $array_saturday_pickup_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="admin_additional.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_sun_pickup_hrs=<?php echo $array_sunday_pickup_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<input name="reservation_open_Thursday" id="reservation_open_Thursday" type="text" class="restaurant" value="<?php echo $result_business_delivery_details['reservation_open_Thursday']; ?>" style="width:93px;" onBlur="check_res_fri_from(this.value);" />
<span style="color:#888888;">to</span>
<input name="reservation_close_Thursday" id="reservation_close_Thursday" type="text" class="restaurant" value="<?php echo $result_business_delivery_details['reservation_close_Thursday']; ?>" style="width:93px;" onBlur="check_res_fri_to(this.value);" />
