	   ...
	   ?>             
                      ...
                      <div class="review_detail">
                        ...
                        <div class="arrow_review"><img src="images/arrow_review.jpg" alt="" /></div>
                                    ...
                                    <ul>
                                        <li><a  class="various1" href="#inline<?php echo $customerInfo['id']; ?>" title="Lorem ipsum dolor sit amet">
									...
									<?php $sql_user_reviews = mysql_query("SELECT * FROM restaurant_reviews WHERE customer_id = '".$customerInfo['id']."'"); ?>
                                    <h1><span>Total Reviews : <?php echo mysql_num_rows($sql_user_reviews); ?></span></h1>
                                    <?php
