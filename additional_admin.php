...
if($_REQUEST['delete_holiday_hrs']!=''){
	mysql_query("DELETE FROM restaurant_holidays_master WHERE id = '".$_REQUEST['delete_holiday_hrs']."'");
	header("location:additional_admin.php?restaurant_edit_id=".$_REQUEST['restaurant_edit_id']."&hol_del_success=1");
}
/*------------------------------- Delete Monday Business Hours ---------------------------------------------*/
...
if($_REQUEST['delete_mon_buss_hrs']!=''){
	...
	header("location:additional_admin.php?restaurant_edit_id=".$_REQUEST['restaurant_edit_id']."&bus_del_success=1");
}
/*------------------------------- Delete Monday Business Hours ---------------------------------------------*/
...
if($_REQUEST['delete_mon_del_hrs']!=''){
	...
	header("location:additional_admin.php?restaurant_edit_id=".$_REQUEST['restaurant_edit_id']."&del_del_success=1");
}
/*------------------------------- Delete Monday Delivery Hours ---------------------------------------------*/
...
if($_REQUEST['delete_mon_pickup_hrs']!=''){
	...
	header("location:additional_admin.php?restaurant_edit_id=".$_REQUEST['restaurant_edit_id']."&pickup_del_success=1");
}
/*------------------------------- Delete Monday Pickup Hours ---------------------------------------------*/
...
if($_REQUEST['delete']!=''){
	...
	header("location:additional_admin.php?success=1");
}
...
if($_REQUEST['delete_pickup_hrs']!=''){
	...
	header("location:additional_admin.php?restaurant_edit_id=".$_REQUEST['restaurant_edit_id']."&del_pickup_success=1");
}

if($_REQUEST['delete_del_charge']!=''){
	mysql_query("DELETE FROM restaurant_delivery_charge WHERE id = '".$_REQUEST['delete_del_charge']."'");
	header("location:additional_admin.php?restaurant_edit_id=".$_REQUEST['restaurant_edit_id']."&del_success=1");
}

$sql_sel_pickup_hrs = mysql_fetch_array(mysql_query("SELECT * FROM restaurant_take_out_master WHERE restaurant_id = '".$_SESSION['restid']."'"));

$sql_sel_del_hrs = mysql_fetch_array(mysql_query("SELECT * FROM restaurant_delivery_details_master WHERE restaurant_id = '".$_SESSION['restid']."'"));

if(count($_POST)>0 && $_REQUEST['submit']=="Save & Continue")
{
	//print_r($_REQUEST['payment_method']); exit;
	$payment="";
	$payment_sep="";
	...
	$sql_select_business_extrahours = mysql_query("SELECT * FROM restaurant_extra_business_hours WHERE restaurant_id = '".$result_additional['restaurant_id']."'");
	$k = 1;
	...
	$sql_select_business_hrs = mysql_query("SELECT * FROM restaurant_delivery_details_master WHERE restaurant_id = '".$result_additional['restaurant_id']."'");
	$i = 1;
	...
	$sql_select_pickup_hrs = mysql_query("SELECT * FROM restaurant_take_out_master WHERE restaurant_id = '".$result_additional['restaurant_id']."'");
	$m = 1;
...
while($array_del_charges = mysql_fetch_array($sql_select_del_charges)){
	...
	foreach($_POST['countdiv'] as $countDiv){
		...
		$hours = $_POST['hours'.$countDiv];
		$hours_from = $_POST['hours_from_'.$countDiv];
		
		$sql_extra_business_hours = "insert into restaurant_extra_business_hours set restaurant_id='".$restaurant_id."', title='".$business_hours_title."', hours='".$hours."' , hours_from = '".$hours_from."' ";
	...
	foreach($_POST['countdiv_del_hrs'] as $countdiv_Del_Hrs){
		...
		$sql_restaurant_delivery_hrs = "insert into restaurant_delivery_details_master set restaurant_id='".$restaurant_id."', delivery_to='".$delivery_to."', delivery_from = '".$delivery_from."' ";
	...
	foreach($_POST['countdiv_pickup_hrs'] as $countdiv_Pickup_Hrs){
		...
		$sql_restaurant_pickup_hrs = "insert into restaurant_take_out_master set restaurant_id='".$restaurant_id."', from_time='".$pickup_from."', to_time = '".$pickup_to."' ";
	...
	$sql_del_charge = "insert into restaurant_delivery_charge SET restaurant_id='".$restaurant_id."', delivery_range='".$delivery_range."', delivery_charge='".$delivery_charge."'";
	mysql_query($sql_del_charge);
		}
	
	
	$sql_select_delivery_crge = mysql_query("SELECT * FROM restaurant_delivery_charge WHERE restaurant_id = '".$restaurant_id."'");
	$num_del_rows = mysql_num_rows($sql_select_delivery_crge);
	
	if($num_del_rows == 0){
		$sql_update_delivery = mysql_query("UPDATE restaurant_business_delivery_takeout_info SET free_delivery = '1' WHERE restaurant_id = '".$restaurant_id."'");
	}else{
		$sql_update_delivery = mysql_query("UPDATE restaurant_business_delivery_takeout_info SET free_delivery = '' WHERE restaurant_id = '".$restaurant_id."'");
	}
	...
	$sql_holiday_hrs = mysql_query("SELECT * FROM restaurant_holidays_master WHERE restaurant_id = '".$restaurant_id."'");
	$k_hol = 1;
	while($array_holiday_hrs = mysql_fetch_array($sql_holiday_hrs)){
		$sql_update_mon_buss_hrs = mysql_query("UPDATE restaurant_holidays_master SET holiday_date = '".change_dateformat($_REQUEST['holidaydate'.$k_hol])."' , time_from = '".$_REQUEST['holidaysfrom'.$k_hol]."' , time_to = '".$_REQUEST['holidaysto'.$k_hol]."' WHERE id = '".$array_holiday_hrs['id']."'");
		$k_hol++;
	}
	/*--------------------------------------- Update Holiday Hours ---------------------------------------------*/
	...
	$sql_mon_bussiness_hrs = mysql_query("SELECT * FROM restaurant_buss_hrs WHERE restaurant_id = '".$restaurant_id."' AND days_id = '1'");
	$k_mon = 1;
	...
	$sql_tue_bussiness_hrs = mysql_query("SELECT * FROM restaurant_buss_hrs WHERE restaurant_id = '".$restaurant_id."' AND days_id = '2'");
	$k_tue = 1;
	...
	$sql_wed_bussiness_hrs = mysql_query("SELECT * FROM restaurant_buss_hrs WHERE restaurant_id = '".$restaurant_id."' AND days_id = '3'");
	$k_wed = 1;
	...
	$sql_thu_bussiness_hrs = mysql_query("SELECT * FROM restaurant_buss_hrs WHERE restaurant_id = '".$restaurant_id."' AND days_id = '4'");
	$k_thu = 1;
	...
	$sql_fri_bussiness_hrs = mysql_query("SELECT * FROM restaurant_buss_hrs WHERE restaurant_id = '".$restaurant_id."' AND days_id = '5'");
	$k_fri = 1;
	...
	$sql_sat_bussiness_hrs = mysql_query("SELECT * FROM restaurant_buss_hrs WHERE restaurant_id = '".$restaurant_id."' AND days_id = '6'");
	$k_sat = 1;
	...
	$sql_sun_bussiness_hrs = mysql_query("SELECT * FROM restaurant_buss_hrs WHERE restaurant_id = '".$restaurant_id."' AND days_id = '7'");
	$k_sun = 1;
	...
	/*------------------------------------------- Holiday Hours -------------------------------------------------*/
	foreach($_POST['countdiv_holiday'] as $countdiv_holiday){
		$restaurant_id = $res_basic_info['id'];
		$holiday_date = $_POST['holiday_date'.$countdiv_holiday];
		$holidays_from = $_POST['holidays_from'.$countdiv_holiday];
		$holidays_to = $_POST['holidays_to'.$countdiv_holiday];
		
		if($holidays_from!='' && $holidays_to!=''){
			$sql_holiday_hrs = "INSERT INTO restaurant_holidays_master SET restaurant_id='".$restaurant_id."', holiday_date = '".change_dateformat($holiday_date)."' , time_from='".$holidays_from."' , time_to = '".$holidays_to."' ";
			mysql_query($sql_holiday_hrs);
		}
	}
	/*------------------------------------------- Holiday Hours -------------------------------------------------*/
	...
	foreach($_POST['countdiv_monday'] as $countdiv_monday){
		...
		if($bus_hrs_mon_from!='' && $bus_hrs_mon_to!=''){
			$sql_bus_hrs_monday = "INSERT INTO restaurant_buss_hrs SET restaurant_id='".$restaurant_id."', days_id='1', time_from='".$bus_hrs_mon_from."' , time_to = '".$bus_hrs_mon_to."' ";
	...
	foreach($_POST['countdiv_tuesday'] as $countdiv_tuesday){
		...
		if($bus_hrs_tue_from!='' && $bus_hrs_tue_to!=''){
			$sql_bus_hrs_tuesday = "INSERT INTO restaurant_buss_hrs SET restaurant_id='".$restaurant_id."', days_id='2', time_from='".$bus_hrs_tue_from."' , time_to = '".$bus_hrs_tue_to."' ";
	...
	foreach($_POST['countdiv_wednesday'] as $countdiv_wednesday){
		...
		if($bus_hrs_wed_from!='' && $bus_hrs_wed_to!=''){
			$sql_bus_hrs_wednesday = "INSERT INTO restaurant_buss_hrs SET restaurant_id='".$restaurant_id."', days_id='3', time_from='".$bus_hrs_wed_from."' , time_to = '".$bus_hrs_wed_to."' ";
	...
	foreach($_POST['countdiv_thursday'] as $countdiv_thursday){
		...
		if($bus_hrs_thu_from!='' && $bus_hrs_thu_to!=''){
			$sql_bus_hrs_thursday = "INSERT INTO restaurant_buss_hrs SET restaurant_id='".$restaurant_id."', days_id='4', time_from='".$bus_hrs_thu_from."' , time_to = '".$bus_hrs_thu_to."' ";
	...
	foreach($_POST['countdiv_friday'] as $countdiv_friday){
		...
		if($bus_hrs_fri_from!='' && $bus_hrs_fri_to!=''){
			$sql_bus_hrs_friday = "INSERT INTO restaurant_buss_hrs SET restaurant_id='".$restaurant_id."', days_id='5', time_from='".$bus_hrs_fri_from."' , time_to = '".$bus_hrs_fri_to."' ";
	...
	foreach($_POST['countdiv_saturday'] as $countdiv_saturday){
		...
		if($bus_hrs_sat_from!='' && $bus_hrs_sat_to!=''){
			$sql_bus_hrs_saturday = "INSERT INTO restaurant_buss_hrs SET restaurant_id='".$restaurant_id."', days_id='6', time_from='".$bus_hrs_sat_from."' , time_to = '".$bus_hrs_sat_to."' ";
	...
	foreach($_POST['countdiv_sunday'] as $countdiv_sunday){
		...
		if($bus_hrs_sun_from!='' && $bus_hrs_sun_to!=''){
			$sql_bus_hrs_sunday = "INSERT INTO restaurant_buss_hrs SET restaurant_id='".$restaurant_id."', days_id='7', time_from='".$bus_hrs_sun_from."' , time_to = '".$bus_hrs_sun_to."' ";
	...
	$sql_mon_del_hrs = mysql_query("SELECT * FROM restaurant_del_hrs WHERE restaurant_id = '".$restaurant_id."' AND days_id = '1'");
	$k_mon = 1;
	...
	$sql_tue_del_hrs = mysql_query("SELECT * FROM restaurant_del_hrs WHERE restaurant_id = '".$restaurant_id."' AND days_id = '2'");
	$k_tue = 1;
	...
	$sql_wed_del_hrs = mysql_query("SELECT * FROM restaurant_del_hrs WHERE restaurant_id = '".$restaurant_id."' AND days_id = '3'");
	$k_wed = 1;
	...
	$sql_thu_del_hrs = mysql_query("SELECT * FROM restaurant_del_hrs WHERE restaurant_id = '".$restaurant_id."' AND days_id = '4'");
	$k_thu = 1;
	...
	$sql_fri_del_hrs = mysql_query("SELECT * FROM restaurant_del_hrs WHERE restaurant_id = '".$restaurant_id."' AND days_id = '5'");
	$k_fri = 1;
	...
	$sql_sat_del_hrs = mysql_query("SELECT * FROM restaurant_del_hrs WHERE restaurant_id = '".$restaurant_id."' AND days_id = '6'");
	$k_sat = 1;
	...
	$sql_sun_del_hrs = mysql_query("SELECT * FROM restaurant_del_hrs WHERE restaurant_id = '".$restaurant_id."' AND days_id = '7'");
	$k_sun = 1;
	...
	foreach($_POST['countdiv_del_monday'] as $countdiv_del_monday){
		...
		if($del_hrs_mon_from!='' && $del_hrs_mon_to!=''){
			$sql_del_hrs_monday = "INSERT INTO restaurant_del_hrs SET restaurant_id='".$restaurant_id."', days_id='1', time_from='".$del_hrs_mon_from."' , time_to = '".$del_hrs_mon_to."' ";
	...
	foreach($_POST['countdiv_del_tuesday'] as $countdiv_del_tuesday){
		...
		if($del_hrs_tue_from!='' && $del_hrs_tue_to!=''){
			$sql_del_hrs_tuesday = "INSERT INTO restaurant_del_hrs SET restaurant_id='".$restaurant_id."', days_id='2', time_from='".$del_hrs_tue_from."' , time_to = '".$del_hrs_tue_to."' ";
	...
	foreach($_POST['countdiv_del_wednesday'] as $countdiv_del_wednesday){
		...
		if($del_hrs_wed_from!='' && $del_hrs_wed_to!=''){
			$sql_del_hrs_wednesday = "INSERT INTO restaurant_del_hrs SET restaurant_id='".$restaurant_id."', days_id='3', time_from='".$del_hrs_wed_from."' , time_to = '".$del_hrs_wed_to."' ";
	...
	foreach($_POST['countdiv_del_thursday'] as $countdiv_del_thursday){
		...
		if($del_hrs_thu_from!='' && $del_hrs_thu_to!=''){
			$sql_del_hrs_thursday = "INSERT INTO restaurant_del_hrs SET restaurant_id='".$restaurant_id."', days_id='4', time_from='".$del_hrs_thu_from."' , time_to = '".$del_hrs_thu_to."' ";
	...
	foreach($_POST['countdiv_del_friday'] as $countdiv_del_friday){
		...
		if($del_hrs_fri_from!='' && $del_hrs_fri_to!=''){
			$sql_del_hrs_friday = "INSERT INTO restaurant_del_hrs SET restaurant_id='".$restaurant_id."', days_id='5', time_from='".$del_hrs_fri_from."' , time_to = '".$del_hrs_fri_to."' ";
	...
	foreach($_POST['countdiv_del_saturday'] as $countdiv_del_saturday){
		...
		if($del_hrs_sat_from!='' && $del_hrs_sat_to!=''){
			$sql_del_hrs_saturday = "INSERT INTO restaurant_del_hrs SET restaurant_id='".$restaurant_id."', days_id='6', time_from='".$del_hrs_sat_from."' , time_to = '".$del_hrs_sat_to."' ";
	...
	foreach($_POST['countdiv_del_sunday'] as $countdiv_del_sunday){
		...
		if($del_hrs_sun_from!='' && $del_hrs_sun_to!=''){
			$sql_del_hrs_sunday = "INSERT INTO restaurant_del_hrs SET restaurant_id='".$restaurant_id."', days_id='7', time_from='".$del_hrs_sun_from."' , time_to = '".$del_hrs_sun_to."' ";
	...
	$sql_mon_pickup_hrs = mysql_query("SELECT * FROM restaurant_pickup_hrs WHERE restaurant_id = '".$restaurant_id."' AND days_id = '1'");
	$k_mon = 1;
	...
	$sql_tue_pickup_hrs = mysql_query("SELECT * FROM restaurant_pickup_hrs WHERE restaurant_id = '".$restaurant_id."' AND days_id = '2'");
	$k_tue = 1;
	...
	$sql_wed_pickup_hrs = mysql_query("SELECT * FROM restaurant_pickup_hrs WHERE restaurant_id = '".$restaurant_id."' AND days_id = '3'");
	$k_wed = 1;
	...
	$sql_thu_pickup_hrs = mysql_query("SELECT * FROM restaurant_pickup_hrs WHERE restaurant_id = '".$restaurant_id."' AND days_id = '4'");
	$k_thu = 1;
	...
	$sql_fri_pickup_hrs = mysql_query("SELECT * FROM restaurant_pickup_hrs WHERE restaurant_id = '".$restaurant_id."' AND days_id = '5'");
	$k_fri = 1;
	...
	$sql_sat_pickup_hrs = mysql_query("SELECT * FROM restaurant_pickup_hrs WHERE restaurant_id = '".$restaurant_id."' AND days_id = '6'");
	$k_sat = 1;
	...
	$sql_sun_pickup_hrs = mysql_query("SELECT * FROM restaurant_pickup_hrs WHERE restaurant_id = '".$restaurant_id."' AND days_id = '7'");
	$k_sun = 1;
	...
	foreach($_POST['countdiv_pickup_monday'] as $countdiv_pickup_monday){
		...
		if($pickup_hrs_mon_from!='' && $pickup_hrs_mon_to!=''){
			$sql_pickup_hrs_monday = "INSERT INTO restaurant_pickup_hrs SET restaurant_id='".$restaurant_id."', days_id='1', time_from='".$pickup_hrs_mon_from."' , time_to = '".$pickup_hrs_mon_to."' ";
	...
	foreach($_POST['countdiv_pickup_tuesday'] as $countdiv_pickup_tuesday){
		...
		if($pickup_hrs_tue_from!='' && $pickup_hrs_tue_to!=''){
			$sql_pickup_hrs_tuesday = "INSERT INTO restaurant_pickup_hrs SET restaurant_id='".$restaurant_id."', days_id='2', time_from='".$pickup_hrs_tue_from."' , time_to = '".$pickup_hrs_tue_to."' ";
	...
	foreach($_POST['countdiv_pickup_wednesday'] as $countdiv_pickup_wednesday){
		...
		if($pickup_hrs_wed_from!='' && $pickup_hrs_wed_to!=''){
			$sql_pickup_hrs_wednesday = "INSERT INTO restaurant_pickup_hrs SET restaurant_id='".$restaurant_id."', days_id='3', time_from='".$pickup_hrs_wed_from."' , time_to = '".$pickup_hrs_wed_to."' ";
	...
	foreach($_POST['countdiv_pickup_thursday'] as $countdiv_pickup_thursday){
		...
		if($pickup_hrs_thu_from!='' && $pickup_hrs_thu_to!=''){
			$sql_pickup_hrs_thursday = "INSERT INTO restaurant_pickup_hrs SET restaurant_id='".$restaurant_id."', days_id='4', time_from='".$pickup_hrs_thu_from."' , time_to = '".$pickup_hrs_thu_to."' ";
	...
	foreach($_POST['countdiv_pickup_friday'] as $countdiv_pickup_friday){
		...
		if($pickup_hrs_fri_from!='' && $pickup_hrs_fri_to!=''){
			$sql_pickup_hrs_friday = "INSERT INTO restaurant_pickup_hrs SET restaurant_id='".$restaurant_id."', days_id='5', time_from='".$pickup_hrs_fri_from."' , time_to = '".$pickup_hrs_fri_to."' ";
	...
	foreach($_POST['countdiv_pickup_saturday'] as $countdiv_pickup_saturday){
		...
		if($pickup_hrs_sat_from!='' && $pickup_hrs_sat_to!=''){
			$sql_pickup_hrs_saturday = "INSERT INTO restaurant_pickup_hrs SET restaurant_id='".$restaurant_id."', days_id='6', time_from='".$pickup_hrs_sat_from."' , time_to = '".$pickup_hrs_sat_to."' ";
	...
	foreach($_POST['countdiv_pickup_sunday'] as $countdiv_pickup_sunday){
		...
		if($pickup_hrs_sun_from!='' && $pickup_hrs_sun_to!=''){
			$sql_pickup_hrs_sunday = "INSERT INTO restaurant_pickup_hrs SET restaurant_id='".$restaurant_id."', days_id='7', time_from='".$pickup_hrs_sun_from."' , time_to = '".$pickup_hrs_sun_to."' ";
	...
	/*------------------------------------------- Sunday Pickup Hours -------------------------------------------------*/
		...
		{
	mysql_query("insert into restaurant_business_delivery_takeout_info set business_hours_mon='".mysql_real_escape_string(trim($_REQUEST['business_hours_mon']))."',business_hours_mon_from = '".mysql_real_escape_string(trim($_REQUEST['business_hours_mon_from']))."',business_hours_tue='".mysql_real_escape_string(trim($_REQUEST['business_hours_tue']))."',business_hours_tue_from='".mysql_real_escape_string(trim($_REQUEST['business_hours_tue_from']))."',business_hours_wed='".mysql_real_escape_string(trim($_REQUEST['business_hours_wed']))."',business_hours_wed_from = '".mysql_real_escape_string(trim($_REQUEST['business_hours_wed_from']))."',business_hours_thu='".mysql_real_escape_string(trim($_REQUEST['business_hours_thu']))."',business_hours_thu_from = '".mysql_real_escape_string(trim($_REQUEST['business_hours_thu_from']))."',business_hours_fri='".mysql_real_escape_string(trim($_REQUEST['business_hours_fri']))."',business_hours_fri_from = '".mysql_real_escape_string(trim($_REQUEST['business_hours_fri_from']))."',business_hours_sat='".mysql_real_escape_string(trim($_REQUEST['business_hours_sat']))."',business_hours_sat_from = '".mysql_real_escape_string(trim($_REQUEST['business_hours_sat_from']))."',business_hours_sun='".mysql_real_escape_string(trim($_REQUEST['business_hours_sun']))."',business_hours_sun_from = '".mysql_real_escape_string(trim($_REQUEST['business_hours_sun_from']))."',holidays='".mysql_real_escape_string($_REQUEST['holidays'])."',holidays_from = '".mysql_real_escape_string($_REQUEST['holidays_from'])."',delivery='".mysql_real_escape_string($_REQUEST['delivery'])."',minimum_ammount='".mysql_real_escape_string($_REQUEST['minimum_ammount'])."',delivery_charge='".mysql_real_escape_string($_REQUEST['delivery_charge'])."',delivery_range='".mysql_real_escape_string($_REQUEST['delivery_range'])."',delivery_hours='".mysql_real_escape_string($_REQUEST['delivery_hours'])."',delivery_estimated_time='".mysql_real_escape_string($_REQUEST['estimated_delivery_time'])."',pickup='".mysql_real_escape_string($_REQUEST['pickup'])."',drive_thru='".mysql_real_escape_string($_REQUEST['drive_thru'])."',restaurant_id='".mysql_real_escape_string($_SESSION['restid'])."' , reservation_open_Monday = '".date('H:i', strtotime($_REQUEST['reservation_open_Monday']))."' , reservation_close_Monday = '".date('H:i', strtotime($_REQUEST['reservation_close_Monday']))."' , reservation_open_Tuesday = '".date('H:i', strtotime($_REQUEST['reservation_open_Tuesday']))."' , reservation_close_Tuesday = '".date('H:i', strtotime($_REQUEST['reservation_close_Tuesday']))."' , reservation_open_Wednesday = '".date('H:i', strtotime($_REQUEST['reservation_open_Wednesday']))."' , reservation_close_Wednesday = '".date('H:i', strtotime($_REQUEST['reservation_close_Wednesday']))."' , reservation_open_Thursday = '".date('H:i', strtotime($_REQUEST['reservation_open_Thursday']))."' , reservation_close_Thursday = '".date('H:i', strtotime($_REQUEST['reservation_close_Thursday']))."' , reservation_open_Friday = '".date('H:i', strtotime($_REQUEST['reservation_open_Friday']))."' , reservation_close_Friday = '".date('H:i', strtotime($_REQUEST['reservation_close_Friday']))."' , reservation_open_Saturday = '".date('H:i', strtotime($_REQUEST['reservation_open_Saturday']))."' , reservation_close_Saturday = '".date('H:i', strtotime($_REQUEST['reservation_close_Saturday']))."' , reservation_open_Sunday = '".date('H:i', strtotime($_REQUEST['reservation_open_Sunday']))."' , reservation_close_Sunday = '".date('H:i', strtotime($_REQUEST['reservation_close_Sunday']))."' , credit_card_fee = '".$_REQUEST['credit_card_fee']."',tax = '".mysql_real_escape_string($_REQUEST['tax'])."' , commission = '".mysql_real_escape_string($_REQUEST['commission'])."' , service_fee = '".$_REQUEST['service_fee']."' , del_time_slot1 = '".$_REQUEST['del_time_slot1']."' , del_time_slot2 = '".$_REQUEST['del_time_slot2']."' , del_time_slot3 = '".$_REQUEST['del_time_slot3']."' , del_time_slot4 = '".$_REQUEST['del_time_slot4']."' , del_time_slot5 = '".$_REQUEST['del_time_slot5']."' , del_time_slot6 = '".$_REQUEST['del_time_slot6']."' , pickup_time_slot1 = '".$_REQUEST['pick_time_slot1']."' , pickup_time_slot2 = '".$_REQUEST['pick_time_slot2']."' , pickup_time_slot3 = '".$_REQUEST['pick_time_slot3']."' , pickup_time_slot4 = '".$_REQUEST['pick_time_slot4']."' , pickup_time_slot5 = '".$_REQUEST['pick_time_slot5']."' , pickup_time_slot6 = '".$_REQUEST['pick_time_slot6']."'");
	
	$sql_ser_dress = mysql_num_rows(mysql_query("SELECT * FROM restaurant_services_dress_payment WHERE restaurant_id='".mysql_real_escape_string($_SESSION['restid'])."'"));
	if($sql_ser_dress == 0){
		mysql_query("insert into restaurant_services_dress_payment set catering_service='".mysql_real_escape_string($_REQUEST['catering_service'])."',self_service='".mysql_real_escape_string($_REQUEST['self_service'])."',waiter_service='".mysql_real_escape_string($_REQUEST['waiter_service'])."',kid_friendly='".mysql_real_escape_string($_REQUEST['kid_friendly'])."',handicape='".mysql_real_escape_string($_REQUEST['handicape'])."',outdoor_seating='".mysql_real_escape_string($_REQUEST['outdoor_seating'])."',alchohol='".mysql_real_escape_string($_REQUEST['alchohol'])."',bar_seating='".mysql_real_escape_string($_REQUEST['bar_seating'])."',wi_fi='".mysql_real_escape_string($_REQUEST['wi_fi'])."',live_music='".mysql_real_escape_string($_REQUEST['live_music'])."',reservation='".mysql_real_escape_string($_REQUEST['reservation'])."',dress_code='".mysql_real_escape_string($_REQUEST['dress_code'])."',payment_method='".mysql_real_escape_string($payment)."',restaurant_id='".mysql_real_escape_string($_SESSION['restid'])."'");
	}else{
		mysql_query("UPDATE restaurant_services_dress_payment set catering_service='".mysql_real_escape_string($_REQUEST['catering_service'])."',self_service='".mysql_real_escape_string($_REQUEST['self_service'])."',waiter_service='".mysql_real_escape_string($_REQUEST['waiter_service'])."',kid_friendly='".mysql_real_escape_string($_REQUEST['kid_friendly'])."',handicape='".mysql_real_escape_string($_REQUEST['handicape'])."',outdoor_seating='".mysql_real_escape_string($_REQUEST['outdoor_seating'])."',alchohol='".mysql_real_escape_string($_REQUEST['alchohol'])."',bar_seating='".mysql_real_escape_string($_REQUEST['bar_seating'])."',wi_fi='".mysql_real_escape_string($_REQUEST['wi_fi'])."',live_music='".mysql_real_escape_string($_REQUEST['live_music'])."',reservation='".mysql_real_escape_string($_REQUEST['reservation'])."',dress_code='".mysql_real_escape_string($_REQUEST['dress_code'])."',payment_method='".mysql_real_escape_string($payment)."' WHERE restaurant_id='".mysql_real_escape_string($_SESSION['restid'])."'");
	}
	...
	/*--------------------------------------- Update Holiday Hours ---------------------------------------------*/
	$sql_holiday_hrs = mysql_query("SELECT * FROM restaurant_holidays_master WHERE restaurant_id = '".$_REQUEST['hid']."'");
	$k_hol = 1;
	while($array_holiday_hrs = mysql_fetch_array($sql_holiday_hrs)){
		$sql_update_mon_buss_hrs = mysql_query("UPDATE restaurant_holidays_master SET holiday_date = '".change_dateformat($_REQUEST['holidaydate'.$k_hol])."' , time_from = '".$_REQUEST['holidaysfrom'.$k_hol]."' , time_to = '".$_REQUEST['holidaysto'.$k_hol]."' WHERE id = '".$array_holiday_hrs['id']."'");
		$k_hol++;
	...
	foreach($_POST['countdiv_holiday'] as $countdiv_holiday){
		...
		if($holidays_from!='' && $holidays_to!=''){
			$sql_holiday_hrs = "INSERT INTO restaurant_holidays_master SET restaurant_id='".$_REQUEST['restaurant_edit_id']."', holiday_date = '".change_dateformat($holiday_date)."' , time_from='".$holidays_from."' , time_to = '".$holidays_to."' ";
			mysql_query($sql_holiday_hrs);
		}
	}
	/*------------------------------------------- Holiday Hours -------------------------------------------------*/
	...
	header("location:restaurant_menu_admin.php");
	}
?>
...
<div class="restaurant_body_cont edit_body_cont">
...
<div class="restaurant_nav">
                    ...
                    <li><a href="additional_admin.php" class="active7">Additional Info</a></li>
	...
	if($row_basic_info_detail>0)
	{
		...
		$additional_restaurant_id=$basic_info_detail['id'];
		$res_business_delivery_detail=mysql_query("SELECT * FROM restaurant_business_delivery_takeout_info where restaurant_id='".$additional_restaurant_id."'");
		...
		$res_service_detail=mysql_query("SELECT * FROM restaurant_services_dress_payment where restaurant_id='".$additional_restaurant_id."'");
		...
		$business_extra_hours = mysql_query("SELECT * FROM restaurant_extra_business_hours WHERE restaurant_id='".$additional_restaurant_id."'");
		
		$business_delivery_hours = mysql_query("SELECT * FROM restaurant_delivery_details_master WHERE restaurant_id = '".$additional_restaurant_id."' ");
		
		$business_pickup_hours = mysql_query("SELECT * FROM restaurant_take_out_master WHERE restaurant_id = '".$additional_restaurant_id."' ");
		
		$sql_del_charges = mysql_query("SELECT * FROM restaurant_delivery_charge WHERE restaurant_id = '".$additional_restaurant_id."'");	 
	}
...
<div class="restaurant_cont_field edit_additional_cont_field">
...
<p style="text-align:center;"><?php if($_REQUEST['hol_del_success'] == 1){
	echo "Holidays deleted successfully.";
}?>
</p>
...
<?php 
$sql_monaday_buss_hrs = mysql_query("SELECT * FROM restaurant_buss_hrs WHERE restaurant_id = '".$additional_restaurant_id."' AND days_id = '1'");
if(mysql_num_rows($sql_monaday_buss_hrs) > 0){
$id_mon = 1;
while($array_monday_buss_hrs = mysql_fetch_array($sql_monaday_buss_hrs)){ ?>
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="additional_admin.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_mon_buss_hrs=<?php echo $array_monday_buss_hrs['id'];?>">
...
<?php 
$sql_tuesday_buss_hrs = mysql_query("SELECT * FROM restaurant_buss_hrs WHERE restaurant_id = '".$additional_restaurant_id."' AND days_id = '2'");
if(mysql_num_rows($sql_tuesday_buss_hrs) > 0){
$id_tue = 1;
while($array_tuesday_buss_hrs = mysql_fetch_array($sql_tuesday_buss_hrs)){ ?>
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="additional_admin.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_tue_buss_hrs=<?php echo $array_tuesday_buss_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<?php 
$sql_wednesday_buss_hrs = mysql_query("SELECT * FROM restaurant_buss_hrs WHERE restaurant_id = '".$additional_restaurant_id."'  AND days_id = '3'");
if(mysql_num_rows($sql_wednesday_buss_hrs) > 0){
$id_wed = 1;
while($array_wednesday_buss_hrs = mysql_fetch_array($sql_wednesday_buss_hrs)){ ?>
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="additional_admin.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_wed_buss_hrs=<?php echo $array_wednesday_buss_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<?php 
$sql_thursday_buss_hrs = mysql_query("SELECT * FROM restaurant_buss_hrs WHERE restaurant_id = '".$additional_restaurant_id."'  AND days_id = '4'");
if(mysql_num_rows($sql_thursday_buss_hrs) > 0){
$id_thu = 1;
while($array_thursday_buss_hrs = mysql_fetch_array($sql_thursday_buss_hrs)){ ?>
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="additional_admin.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_thu_buss_hrs=<?php echo $array_thursday_buss_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<?php 
$sql_friday_buss_hrs = mysql_query("SELECT * FROM restaurant_buss_hrs WHERE restaurant_id = '".$additional_restaurant_id."'  AND days_id = '5'");
if(mysql_num_rows($sql_friday_buss_hrs) > 0){
$id_fri = 1;
while($array_friday_buss_hrs = mysql_fetch_array($sql_friday_buss_hrs)){ ?>
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="additional_admin.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_fri_buss_hrs=<?php echo $array_friday_buss_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<?php 
$sql_saturday_buss_hrs = mysql_query("SELECT * FROM restaurant_buss_hrs WHERE restaurant_id = '".$additional_restaurant_id."'  AND days_id = '6'");
if(mysql_num_rows($sql_saturday_buss_hrs) > 0){
$id_sat = 1;
while($array_saturday_buss_hrs = mysql_fetch_array($sql_saturday_buss_hrs)){ ?>
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="additional_admin.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_sat_buss_hrs=<?php echo $array_saturday_buss_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<?php 
$sql_sunday_buss_hrs = mysql_query("SELECT * FROM restaurant_buss_hrs WHERE restaurant_id = '".$additional_restaurant_id."'  AND days_id = '7'");
if(mysql_num_rows($sql_sunday_buss_hrs) > 0){
$id_sun = 1;
while($array_sunday_buss_hrs = mysql_fetch_array($sql_sunday_buss_hrs)){ ?>
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="additional_admin.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_sun_buss_hrs=<?php echo $array_sunday_buss_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
var $j = $.noConflict();
$j(function() {
	$j( ".date_class" ).datepicker({
		dateFormat:"mm-dd-yy"
	});
});

$j("body").on("click", ".date_class", function(){
            $j(this).datepicker({ dateFormat:"mm-dd-yy" });
            $j(this).datepicker("show");
    });
</script>
<script type="text/javascript">
function add_cell_holiday(id){
	$.ajax({
		url : 'add_hours_holidays.php',
		type : 'POST',
		data : 'id=' + id,
		//dataType : 'json',
		beforeSend : function(jqXHR, settings ){
		...
		success : function( data, textStatus, jqXHR){
			...
			var menuContent = data;
			var menuDiv = document.createElement('div');
			var menuDivid = menuDiv.id = 'business_div_holiday_' + id;
			//menuDiv.setAttribute("class","mainmanu");
			menuDiv.innerHTML = menuContent;
			document.getElementById('allmenu_holiday').appendChild(menuDiv);
			document.getElementById('item_id_holiday').value=parseInt(id)+1;
	...
	document.getElementById('item_focus_holiday').focus();
}

function remove_div_holiday(delId)
{
	var div = document.getElementById("business_div_holiday_" + delId);
	div.parentNode.removeChild(div);
}

function check_holiday_from(val,id)
{
	var bussto = Converttimeformat($("#holidays_to"+id).val());
	var value = Converttimeformat(val);
	...
	if(bussto != "")
	{
		...
		{
			alert("From time cannot be greater than To time.");
			$("#holidays_from"+id).val('');
		}
	}
}

function check_holiday_to(val,id)
{
	var bussfrom = Converttimeformat($("#holidays_from"+id).val());
	var value = Converttimeformat(val);
...
<p>Holidays :</p>
<div class="cross_bt" style="margin-left:414px;margin-top:11px;"><a href="javascript:void(0);" onClick="add_cell_holiday(document.getElementById('item_id_holiday').value)" id="item_focus_holiday"><img  src="images/grn-plus.png"></a>
</div>
<?php 
$sql_holidays_hrs = mysql_query("SELECT * FROM restaurant_holidays_master WHERE restaurant_id = '".$additional_restaurant_id."'");
if(mysql_num_rows($sql_holidays_hrs) > 0){
$id_holiday = 1;
while($array_holidays_hrs = mysql_fetch_array($sql_holidays_hrs)){ ?>
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="additional_admin.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_holiday_hrs=<?php echo $array_holidays_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
<input name="holidaydate<?php echo $id_holiday; ?>" id="holidaydate<?php echo $id_holiday; ?>" type="text" class="restaurant date_class" value="<?php echo date("m-d-Y", strtotime($array_holidays_hrs['holiday_date'])); ?>" /><p></p>
<input name="holidaysfrom<?php echo $id_holiday; ?>" id="holidaysfrom<?php echo $id_holiday; ?>" type="text" class="restaurant time_pick" value="<?php echo $array_holidays_hrs['time_from']; ?>" style="width:93px;" onBlur="check_holiday_from(this.value,'<?php echo $id_sun; ?>');" />
<span style="color:#888888;">to</span>
<input name="holidaysto<?php echo $id_holiday; ?>" id="holidaysto<?php echo $id_holiday; ?>" type="text" class="restaurant time_pick" value="<?php echo $array_holidays_hrs['time_to']; ?>" style="width:93px;" onBlur="check_holiday_to(this.value,'<?php echo $id_sun; ?>');" />
...
<div id="allmenu_holiday">
<?php if(mysql_num_rows($sql_holidays_hrs) == 0){?>
<input name="holiday_date1" id="holiday_date1" type="text" class="restaurant date_class" value="" />
<input name="holidays_from1" id="holidays_from1" type="text" class="restaurant time_pick" value="" style="width:93px;" onBlur="check_holiday_from(this.value,'1');" />
<span style="color:#888888;">to</span>
<input name="holidays_to1" id="holidays_to1" type="text" class="restaurant time_pick" value="" style="width:93px;" onBlur="check_holiday_to(this.value,'1');" />
<?php } ?>

<input type="hidden" id="item_id_holiday" name="item_id_holiday" value="2">

<input type="hidden" name="countdiv_holiday[]" value="1" class="webcampics">
...
<a href="additional_admin.php?delete=<?php echo $array_business_extra_hours['id'];?>" >
<img  src="images/Close_Box_Red.png">
</a>
</div>
...
<input name="del_hours_from" id="del_hours_from" type="text" class="restaurant" value="<?php echo $result_business_delivery_details['del_hours_from']; ?>" style="width:93px;" />
<span style="color:#888888;">to</span>
<input name="del_hours_to" id="del_hours_to" type="text" class="restaurant" value="<?php echo $result_business_delivery_details['del_hours_to']; ?>" style="width:93px;" /><?php */?>
...
<div class="cross_bt" style="margin-left:394px;">
<a href="additional_admin.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_del_hrs=<?php echo $array_delivery_hours['id'];?>" >
<img  src="images/Close_Box_Red.png">
</a>
</div>
...
<?php 
$sql_monaday_del_hrs = mysql_query("SELECT * FROM restaurant_del_hrs WHERE restaurant_id = '".$additional_restaurant_id."' AND days_id = '1'");
if(mysql_num_rows($sql_monaday_del_hrs) > 0){
$id_mon = 1;
while($array_monday_del_hrs = mysql_fetch_array($sql_monaday_del_hrs)){ ?>
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="additional_admin.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_mon_del_hrs=<?php echo $array_monday_del_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<?php 
$sql_tuesday_del_hrs = mysql_query("SELECT * FROM restaurant_del_hrs WHERE restaurant_id = '".$additional_restaurant_id."' AND days_id = '2'");
if(mysql_num_rows($sql_tuesday_del_hrs) > 0){
$id_tue = 1;
while($array_tuesday_del_hrs = mysql_fetch_array($sql_tuesday_del_hrs)){ ?>
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="additional_admin.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_tue_del_hrs=<?php echo $array_tuesday_del_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<?php 
$sql_wednesday_del_hrs = mysql_query("SELECT * FROM restaurant_del_hrs WHERE restaurant_id = '".$additional_restaurant_id."' AND days_id = '3'");
if(mysql_num_rows($sql_wednesday_del_hrs) > 0){
$id_wed = 1;
while($array_wednesday_del_hrs = mysql_fetch_array($sql_wednesday_del_hrs)){ ?>
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="additional_admin.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_wed_del_hrs=<?php echo $array_wednesday_del_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<?php 
$sql_thursday_del_hrs = mysql_query("SELECT * FROM restaurant_del_hrs WHERE restaurant_id = '".$additional_restaurant_id."' AND days_id = '4'");
if(mysql_num_rows($sql_thursday_del_hrs) > 0){
$id_thu = 1;
while($array_thursday_del_hrs = mysql_fetch_array($sql_thursday_del_hrs)){ ?>
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="additional_admin.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_thu_del_hrs=<?php echo $array_thursday_del_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<?php 
$sql_friday_del_hrs = mysql_query("SELECT * FROM restaurant_del_hrs WHERE restaurant_id = '".$additional_restaurant_id."' AND days_id = '5'");
if(mysql_num_rows($sql_friday_del_hrs) > 0){
$id_fri = 1;
while($array_friday_del_hrs = mysql_fetch_array($sql_friday_del_hrs)){ ?>
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="additional_admin.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_fri_del_hrs=<?php echo $array_friday_del_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<?php 
$sql_saturday_del_hrs = mysql_query("SELECT * FROM restaurant_del_hrs WHERE restaurant_id = '".$additional_restaurant_id."' AND days_id = '6'");
if(mysql_num_rows($sql_saturday_del_hrs) > 0){
$id_sat = 1;
while($array_saturday_del_hrs = mysql_fetch_array($sql_saturday_del_hrs)){ ?>
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="additional_admin.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_sat_del_hrs=<?php echo $array_saturday_del_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<?php 
$sql_sunday_del_hrs = mysql_query("SELECT * FROM restaurant_del_hrs WHERE restaurant_id = '".$additional_restaurant_id."' AND days_id = '7'");
if(mysql_num_rows($sql_sunday_del_hrs) > 0){
$id_sun = 1;
while($array_sunday_del_hrs = mysql_fetch_array($sql_sunday_del_hrs)){ ?>
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="additional_admin.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_sun_del_hrs=<?php echo $array_sunday_del_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;">
<a href="admin_additional.php?delete_del_charge=<?php echo $array_del_charges['id'];?>" >
<img  src="images/Close_Box_Red.png">
</a>
</div>
<p>Delivery Range (miles) :</p>
...
<div class="cross_bt" style="margin-left:394px;">
<a href="additional_admin.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_pickup_hrs=<?php echo $array_pickup_hours['id'];?>" >
<img  src="images/Close_Box_Red.png">
</a>
</div>
...
<?php 
$sql_monaday_pickup_hrs = mysql_query("SELECT * FROM restaurant_pickup_hrs WHERE restaurant_id = '".$additional_restaurant_id."' AND days_id = '1'");
if(mysql_num_rows($sql_monaday_pickup_hrs) > 0){
$id_mon = 1;
while($array_monday_pickup_hrs = mysql_fetch_array($sql_monaday_pickup_hrs)){ ?>
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="additional_admin.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_mon_pickup_hrs=<?php echo $array_monday_pickup_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<?php 
$sql_tuesday_pickup_hrs = mysql_query("SELECT * FROM restaurant_pickup_hrs WHERE restaurant_id = '".$additional_restaurant_id."' AND days_id = '2'");
if(mysql_num_rows($sql_tuesday_pickup_hrs) > 0){
$id_tue = 1;
while($array_tuesday_pickup_hrs = mysql_fetch_array($sql_tuesday_pickup_hrs)){ ?>
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="additional_admin.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_tue_pickup_hrs=<?php echo $array_tuesday_pickup_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<?php 
$sql_wednesday_pickup_hrs = mysql_query("SELECT * FROM restaurant_pickup_hrs WHERE restaurant_id = '".$additional_restaurant_id."' AND days_id = '3'");
if(mysql_num_rows($sql_wednesday_pickup_hrs) > 0){
$id_wed = 1;
while($array_wednesday_pickup_hrs = mysql_fetch_array($sql_wednesday_pickup_hrs)){ ?>
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="additional_admin.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_wed_pickup_hrs=<?php echo $array_wednesday_pickup_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<?php 
$sql_thursday_pickup_hrs = mysql_query("SELECT * FROM restaurant_pickup_hrs WHERE restaurant_id = '".$additional_restaurant_id."' AND days_id = '4'");
if(mysql_num_rows($sql_thursday_pickup_hrs) > 0){
$id_thu = 1;
while($array_thursday_pickup_hrs = mysql_fetch_array($sql_thursday_pickup_hrs)){ ?>
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="additional_admin.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_thu_pickup_hrs=<?php echo $array_thursday_pickup_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<?php 
$sql_friday_pickup_hrs = mysql_query("SELECT * FROM restaurant_pickup_hrs WHERE restaurant_id = '".$additional_restaurant_id."' AND days_id = '5'");
if(mysql_num_rows($sql_friday_pickup_hrs) > 0){
$id_fri = 1;
while($array_friday_pickup_hrs = mysql_fetch_array($sql_friday_pickup_hrs)){ ?>
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="additional_admin.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_fri_pickup_hrs=<?php echo $array_friday_pickup_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<?php 
$sql_saturday_pickup_hrs = mysql_query("SELECT * FROM restaurant_pickup_hrs WHERE restaurant_id = '".$additional_restaurant_id."' AND days_id = '6'");
if(mysql_num_rows($sql_saturday_pickup_hrs) > 0){
$id_sat = 1;
while($array_saturday_pickup_hrs = mysql_fetch_array($sql_saturday_pickup_hrs)){ ?>
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="additional_admin.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_sat_pickup_hrs=<?php echo $array_saturday_pickup_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<?php 
$sql_sunday_pickup_hrs = mysql_query("SELECT * FROM restaurant_pickup_hrs WHERE restaurant_id = '".$additional_restaurant_id."' AND days_id = '7'");
if(mysql_num_rows($sql_sunday_pickup_hrs) > 0){
$id_sun = 1;
while($array_sunday_pickup_hrs = mysql_fetch_array($sql_sunday_pickup_hrs)){ ?>
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="additional_admin.php?restaurant_edit_id=<?php echo $additional_restaurant_id;?>&delete_sun_pickup_hrs=<?php echo $array_sunday_pickup_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
