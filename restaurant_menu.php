...
if($_REQUEST['submit_category'] == 'Create'){
	...
	if(mysql_num_rows($sql_sel_category) == '0'){
		...
		header("location:restaurant_menu.php?catsuccess=1&popup=1");
	}else{
		...
		if(in_array($restaurant_id,$restaurant_arr)){
			header("location:restaurant_menu.php?caterror=1&popup=1");
...
if($_REQUEST['del_cat'] == 1)
{
	...
	if($del)
	{
		header("location:restaurant_menu.php?catdelsuccess=1&popup=1");
	}
}
...
if($_REQUEST['submit_subcategory'] == 'Add'){
	...
	if($sub_cat_num_rows == '0'){
		...
		header("location:restaurant_menu.php?subcatsuccess=1&popup=1");
	}else{
		header("location:restaurant_menu.php?subcaterror=1&popup=1");
	}
...
if($_REQUEST['del_subcat'] == '1')
{
	...
	header("location:restaurant_menu.php?subcatdel=1&popup=1&dlt=".$_REQUEST['dlt']."");
}
...
if($_REQUEST['edit_submit_category'] == 'Edit')
{
	...
	if($check_dup == 0)
	{
		...
		header("location:restaurant_menu.php?catedit_success=1&popup=1&edt=".$_REQUEST['pop_tab_id']."");
	}
	else
	{
		header("location:restaurant_menu.php?catedit_error=1&popup=1&edt=".$_REQUEST['pop_tab_id']."");
	}
}
...
if($_REQUEST['submit_subcategory_edit'] == 'Edit')
{
	...
	if($check_dup == 0)
	{
		...
		header("location:restaurant_menu.php?subedit_success=1&popup=1&edt=".$_REQUEST['edt']."");
	}
	else
	{
		header("location:restaurant_menu.php?subedit_error=1&popup=1&edt=".$_REQUEST['edt']."");
	}
...
if($_REQUEST['del_item'] == '1')
{
	...
	header("location:restaurant_menu.php?itemdel=1&cat_id=".$sql_sel['category_id']."&sub_cat=".$sql_sel['sub_category_id']."&open_div=1");
}
...
if($_REQUEST['sub_button'] == "Copy Menu")
{
	...
	header("location:restaurant_menu.php?success=3");
...
if($_REQUEST['submit'] == 'Save & Continue'){	
	...
	header("location:restaurant_menu.php?item_add=1&anc=".$_REQUEST['hid_anc_id']."");
...
if($_REQUEST['submit_item'] == 'Save & Continue')
{
	...
	/*if($update)
	{*/
		header("location:restaurant_menu.php?item_edit=1&open_div=1&cat_id=".$sql_menu_item['category_id']."&sub_cat=".$subcat."");
		exit;
	/*}*/
}
...
if($_REQUEST['del_ins']!='')
{
	...
	header("location:restaurant_menu.php?insdelitm=1&inspop=1&menu_id=".$_REQUEST['menu_id']."&cat_id=".$sql_menu_item['category_id']."&sub_cat=".$sql_menu_item['sub_category_id']."");
}
...
if($_REQUEST['sub_ins_button'] = "Copy Special Instructions")
{
	...
	if($update)
	{
		header("location:restaurant_menu.php?copyins=1");
	}
...
if($_REQUEST['edit_spl_ins'] == 'Save & Continue'){
	...
	header("location:restaurant_menu.php?insdelitm=1&inspop=1&menu_id=".$_REQUEST['menu_id']."&cat_id=".$sql_menu_item['category_id']."&sub_cat=".$sql_menu_item['sub_category_id']."&edit_succ_ins=1");
}
...
if($_REQUEST['submit_cat_time'] == "Submit")
{
	...
	if($update)
	{
		header("location:restaurant_menu.php?cattimesuccess=1&popup=1");
	}
...
if($_REQUEST['submit_sub_cat_time'] == "Submit")
{
	...
	if($update)
	{
		header("location:restaurant_menu.php?subcattimesuccess=1&popup=1");
	}
...
<div id="nw_pop" class="white_content xslg">
   ...
   <?php } ?>
        ...
        <table cellpadding="0" cellspacing="0" class="blue-table"> 
		   ...
		   $sql_subcat2 = mysql_query("SELECT * FROM restaurant_menu_subcategory WHERE category_id = '".$row_cat_single['id']."' AND restaurant_id = '".$restaurant_id."' ORDER BY show_order ");
            ...
            <tr>
                ...
                <a href="order_change_up_res_cat.php?res_id=<?php echo $restaurant_id; ?>&show_order=<?php echo $row_cat_single['show_order']; ?>&id=<?php echo $row_cat_single['id']; ?>&pg_name=res_menu"> <img src="images/icon-arrow-up-b-16.png" alt="Order Up" title="Order Up" align="absmiddle" /></a>
            <?php } ?>
            <?php if($max_order_id['max_id']!= $row_cat_single['show_order']){ ?>
                <a href="order_change_down_res_cat.php?res_id=<?php echo $restaurant_id; ?>&show_order=<?php echo $row_cat_single['show_order']; ?>&id=<?php echo $row_cat_single['id']; ?>&pg_name=res_menu"> <img src="images/icon-arrow-down-b-16.png" alt="Order Down" title="Order Down" align="absmiddle" /></a>
            <?php } ?>
                            </td>
                <td align="center">
                <a href="restaurant_menu.php?restaurant_edit_id=<?php echo $restaurant_id; ?>&cat_edit_id=<?php echo $row_cat_single['id'];?>&edit_cat=1&popup=1&cat_edt=<?php echo $inc_cat; ?>"> <img src="images/pen_edit_write_-16.png" alt="Edit" title="Edit" align="absmiddle"></a>
				...
				{
				?>
                	<a href="restaurant_menu.php?restaurant_edit_id=<?php echo $restaurant_id; ?>&del_cat_id=<?php echo $row_cat_single['id']; ?>&del_cat=1" onClick="return confirm('Are you sure to Delete this Category?');"> <img src="images/DeleteRed.png" alt="Delete" title="Delete" align="absmiddle"></a>
                <?php
				}
				else
				{
	...
	<div class="restaurant_nav ">
		...
		?>
		    <li class="li_cls"><?php /*?><a href="restaurant_menu.php?del_cat_id=<?php echo $row_cat['id']; ?>&del_cat=1" onClick="return confirm('Are you sure to Delete this Category?');"><img class="del_img" src="<?php echo $image_path; ?>" width="10" style="display:none" alt="Delete" title="<?php echo $title; ?>" align="absmiddle"></a><?php */?><a href="javascript:void(0);" id="cat_anc<?php echo $j; ?>" onClick="open_cat_div('<?php echo $j; ?>');"><?php echo $row_cat['category_name']; ?></a></li>
        <?php
		$j++;
		}
		?>
			...
			?>
				<tr>
                    ...
                    <?php if($min_order_id['min_id']!= $row_subcat['show_order']){ ?>
						<a href="order_change_up_res_sub_cat.php?cat_id=<?php echo $row_subcat['category_id']; ?>&res_id=<?php echo $restaurant_id; ?>&show_order=<?php echo $row_subcat['show_order']; ?>&id=<?php echo $row_subcat['id']; ?>&sh_odr=<?php echo $jj; ?>&pg_name=res_menu"> <img src="images/icon-arrow-up-b-16.png" alt="Order Up" title="Order Up" align="absmiddle" /></a>
                    <?php } ?>
                    <?php if($max_order_id['max_id']!= $row_subcat['show_order']){ ?>
						<a href="order_change_down_res_sub_cat.php?cat_id=<?php echo $row_subcat['category_id']; ?>&res_id=<?php echo $restaurant_id; ?>&show_order=<?php echo $row_subcat['show_order']; ?>&id=<?php echo $row_subcat['id']; ?>&sh_odr=<?php echo $jj; ?>&pg_name=res_menu"> <img src="images/icon-arrow-down-b-16.png" alt="Order Down" title="Order Down" align="absmiddle" /></a>
                    <?php } ?>
					</td>
					<td align="center">
						<a href="restaurant_menu.php?edit_id=<?php echo $row_subcat['id'];?>&edit_subcat=1&popup=1&edt=<?php echo $jj; ?>"> <img src="images/pen_edit_write_-16.png" alt="Edit" title="Edit" align="absmiddle" /></a>
						...
						<a href="restaurant_menu.php?del_id=<?php echo $row_subcat['id'];?>&del_subcat=1&dlt=<?php echo $jj; ?>" onClick="return confirm('Are you sure to Delete this Sub Category?')"> <img src="images/DeleteRed.png" alt="Delete" title="Delete" align="absmiddle" /></a>
					</td>
				</tr>
			<?php
			$sl++;
        ...
        if($subcat_num_rows_new > 0)
		{
			...
			?>
                ...
                <td>
                    ...
                    <div class="blue_table_bottom_color"><input type="checkbox" name="spicy[]" id="spicy" value="1" <?php if($row_item['spicy'] == '1'){?> checked="checked" <?php } ?>> Spicy</div>
                </td>
                <td>
                    ...
                    <div class="blue_table_bottom_color"><input type="checkbox" name="veggie[]" id="veggie" value="1" <?php if($row_item['veggie'] == '1'){?> checked="checked" <?php } ?>> Veggie</div>
                </td>
                <td>
                    ...
                    <div class="blue_table_bottom_color"><input type="checkbox" name="healthy[]" id="healthy" value="1" <?php if($row_item['healthy'] == '1'){?> checked="checked" <?php } ?>> Healthy</div>
                </td>
                <td>
				...
				?>
                    ...
                    <a href="restaurant_menu.php?del_ins=<?php echo $row_ins['id']; ?>&menu_id=<?php echo $row_ins['menu_id']; ?>" style="margin-left:10px;" onClick="return confirm('Are you sure to delete this Entire Instruction?');"><img src="images/Close_Box_Red.png"></a>
                    ...
                    <tr>
                     ...
                     <td>
                     <a href="restaurant_menu.php?del_ins_opt=<?php echo $row_ins_item['id']; ?>&del_ins_item=1&menu_id=<?php echo $row_ins_item['menu_id']; ?>" onClick="return confirm('Are you sure to delete this Instruction option?');"><img src="images/Close_Box_Red.png"></a>
                     </td>
                    </tr>
