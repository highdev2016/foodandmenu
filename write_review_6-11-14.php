...
if($_REQUEST['btn_submit']!="")
{
	...
	$sql_add_point = mysql_query("UPDATE restaurant_customer SET reward_point = reward_point+'".$sql_get_reward_point['online_review_rating']."' WHERE id = '".$_SESSION['customer_id']."'");
...
<div class="add_item" style="float:right;"><a href="javascript:void(0);" onClick="add_cell(document.getElementById('item_id').value)">Add New</a></div>
<?php
