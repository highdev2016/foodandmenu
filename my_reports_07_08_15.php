...
<div id="printdiv">
  ...
  <tr>
    ...
    <td width="20%" class="all_restaurant"><a href="javascript:void(0)" onClick="sort_function('menu_name','<?php echo $_REQUEST['order_date']; ?>','<?php echo $_REQUEST['customer_name']; ?>','<?php echo $_REQUEST['customer_email']; ?>','<?php echo $_REQUEST['start_date']; ?>','<?php echo $_REQUEST['end_date']; ?>')" class="heading_link">Menu Name</a></td>
    <td width="11%" class="all_restaurant"><!--<a href="javascript:void(0)" onClick="sort_function('quantity','<?php echo $_REQUEST['order_date']; ?>','<?php echo $_REQUEST['customer_name']; ?>','<?php echo $_REQUEST['customer_email']; ?>','<?php echo $_REQUEST['start_date']; ?>','<?php echo $_REQUEST['end_date']; ?>')" class="heading_link">-->Quantity<!--</a>--></td>
    <td width="9%" class="all_restaurant"><a href="javascript:void(0)" onClick="sort_function('unit_price','<?php echo $_REQUEST['order_date']; ?>','<?php echo $_REQUEST['customer_name']; ?>','<?php echo $_REQUEST['customer_email']; ?>','<?php echo $_REQUEST['start_date']; ?>','<?php echo $_REQUEST['end_date']; ?>')" class="heading_link">Price</a></td>
    ...
    <td width="12%" class="all_restaurant"><!--<a href="javascript:void(0)" onClick="sort_function('sum','<?php echo $_REQUEST['order_date']; ?>','<?php echo $_REQUEST['customer_name']; ?>','<?php echo $_REQUEST['customer_email']; ?>','<?php echo $_REQUEST['start_date']; ?>','<?php echo $_REQUEST['end_date']; ?>')" class="heading_link">-->Sum<!--</a>--></td>
    </tr>
  <?php
