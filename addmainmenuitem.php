...
<div class="new-res-fild">
	...
	<div class="catsec sub_cate">
        ...
        <div id="menu_sub_category_div<?php echo $id; ?>" class="sub_category_select">
    ...
    <div id="menu_item_div<?php echo $id; ?>_1" class="res_fld_menu">
    <input type="hidden" name="countmenudiv_<?php echo $id; ?>[]" value="1" class="webcampics">
    ...
    <input type="hidden" name="countsplinsdiv[]" value="1" class="webcampics">
        <div class="new-res-fild res_fld_menu">
            ...
            <div class="clear"></div>
            <div class="addmenu-fild">
                <input type="checkbox" name="menu_item_whats_good_<?php echo $id; ?>_1" id="menu_item_whats_good_<?php echo $id; ?>_1" value="1" style="height:12px; width: 15px;"> What's Good
            </div>
            <div class="addmenu-fild">
                <input type="checkbox" name="menu_item_spicy_<?php echo $id; ?>_1" id="menu_item_spicy_<?php echo $id; ?>_1" value="1" style="height:12px; width: 15px;"> Spicy
            </div>
            <div class="addmenu-fild">
                <input type="checkbox" name="menu_item_veggie_<?php echo $id; ?>_1" id="menu_item_veggie_<?php echo $id; ?>_1" value="1" style="height:12px; width: 15px;"> Veggie
            </div>
            <div class="addmenu-fild">
                <input type="checkbox" name="menu_item_healthy_<?php echo $id; ?>_1" id="menu_item_healthy_<?php echo $id; ?>_1" value="1" style="height:12px; width: 15px;"> Healthy
            </div>
