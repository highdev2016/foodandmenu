...
<style type="text/css">
	...
	.restaurant_form_field .cross_bt{
		margin-left: 380px !important;
	}
	
	.restaurant_form_field.review_form_field .cross_bt{
...
<div class="clear"></div>
<div class="restaurant_form_field review_form_field">

    <div class="review_date_field">
...
<div id="allmenu" style="position: relative;" class="form_fieldrating">
...
<div class="clear"></div>  
<span class="pic_size" style="color:#ff0000;">[Best size : 425 X 300]</span>

<div class="add_item add_plus_new"><a style="text-decoration:none;" class="pic_add_button" href="javascript:void(0);" onClick="add_cell(document.getElementById('item_id').value)"><i class="fa fa-plus"></i>
</a></div>
<?php
...
<input class="button4 rev_sub_butt" type="submit" value="Submit" name="btn_submit" <?php if($res_reviews['abuse_status']==1 && $res_reviews['status']==0){?> disabled=disabled <?php }?> >
</div>
