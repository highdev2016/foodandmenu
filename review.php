            ...
            <div class="food_body_cont">
                ...
                <div class="food_content">
                    ...
                    <div class="accr_menu" <?php /*?>id="tab"<?php */?>>
                        ...
                        <div class="accr_details review_details">
...
<?php //echo change_dateformat_reverse($row_updated_review['post_date']); ?>  <!-- By <span><?php //echo $row_updated_review['customer_name']?></span> -->  </h5>
                                        ...
                                        <div class="rating_content_two review-likes rviw">
		                                 ...
		                                 <div class="viewers_comment">
		                                     ...
		                                     <?php
												...
												<p class="edt"><a href="write_review.php?id=<?php echo $_REQUEST['id'];?>"><img src="images/pencil.png" style="margin: 0 5px 0; width:16px;" /> </a> </p>
		                                    ...
		                                    <li>
                                            <a href="mailto:<?php echo getNameTable("restaurant_customer","email","id",$customerInfo['id']); ?>?body=<?php echo $row_updated_review['customer_review']?>&subject=<?php echo date("d-m-Y", strtotime($row_updated_review['post_date'])); ?>  By <?php echo $row_updated_review['customer_name']?>" target="_blank">Email</a></li>
											
                                            <?php
											$cust_rev = str_replace("'","",$res_review['customer_review']);
											?>
                                            
		                                    <?php /*?><li><?php if(isset($_SESSION['customer_id'])){?><a href="javascript:void(0);" onClick="FBShareOp('<?php echo addslashes($row_updated_review['customer_name'])?>','<?php echo $row_updated_review['restaurant_id']; ?>','<?php echo addslashes($cust_img)?>','<?php echo $cust_rev; ?>','thumb_images')">Share with facebook</a><?php }else{ ?><a href="login.php">Share with facebook</a><?php } ?></li><?php */?>
                                            
                                            <li><?php if(isset($_SESSION['customer_id'])){?><a href="javascript:void(0);" onClick="FBShareOp('<?php echo addslashes($row_updated_review['customer_name'])?>','<?php echo $row_updated_review['restaurant_id']; ?>','<?php echo addslashes($cust_img)?>','<?php echo replace($cust_rev); ?>','thumb_images')">Share with facebook</a><?php }else{ ?><a href="login.php">Share with facebook</a><?php } ?></li>

		                                    <?php if($row_updated_review['abuse_status']==0){?>

		                                    <li><?php if(isset($_SESSION['customer_id'])){?><a href="report_abuse.php?id=<?php echo $_REQUEST['id'] ?>&r_id=<?php echo $row_updated_review['id']; ?>" onClick="return confirm('Are you sure to Report Abuse this Review?');">Report Abuse</a><?php } else{?><a href="login.php">Report Abuse</a><?php } ?></li>
                                 ...
                                 <li><div style="width:165px;">&nbsp;</div></li>
                                    ...
                                    <?php $uploaded_image = 'uploaded_images/'.$res_review['review_picture'] ?>	
                                        ...
                                        <ul>
		                                    ...
		                                    <li><a href="mailto:<?php echo getNameTable("restaurant_customer","email","id",$customerInfo['id']); ?>?body=<?php echo $res_review['customer_review']?>&subject=<?php echo date("d-m-Y", strtotime($res_review['post_date'])); ?>  By <?php echo $res_review['customer_name']?>" target="_blank">Email</a></li>

		                                    <?php /*?><li><?php if(isset($_SESSION['customer_id'])){?><a href="javascript:void(0);" onClick="fbpublishreview('<?=addslashes($res_review['customer_name'])?>','<?=addslashes($res_review['customer_review'])?>','<?=addslashes($cust_img)?>')">Share with facebook</a><?php }else{ ?><a href="login.php">Share with facebook</a><?php } ?></li><?php */?>
                                            
                                            <?php
											$cust_rev = str_replace("'","",$res_review['customer_review']);
											?>
											<li><?php if(isset($_SESSION['customer_id'])){?><a href="javascript:void(0);" onClick="FBShareOp('<?php echo addslashes($res_review['customer_name'])?>','<?php echo $res_review['restaurant_id']; ?>','<?php echo addslashes($cust_img)?>','<?php echo replace($cust_rev); ?>','thumb_images')">Share with facebook</a><?php }else{ ?><a href="login.php">Share with facebook</a><?php } ?></li>


		                                    <?php if($res_review['abuse_status']==0){?>

		                                    <li><?php if(isset($_SESSION['customer_id'])){?><a href="report_abuse.php?id=<?php echo $_REQUEST['id'] ?>&r_id=<?php echo $res_review['id']; ?>" onClick="return confirm('Are you sure to Report Abuse this Review?');">Report Abuse</a><?php } else{?><a href="login.php">Report Abuse</a><?php } ?></li>
