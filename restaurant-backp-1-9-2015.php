...
<?php } ?>
        ...
        <?php } else { ?>
                                                            <tr class="total-tr mn-ttl">
                                                                <td height="20" colspan="3" align="center" style="border-right: 1px solid #f8f8f8;">&nbsp;</td>
                                                                <td height="20" align="right" style="padding-left:141px !important;">Total </td>
                                                ...
                                                <form name="order_del_frm" method="post" action="">
													...
													if ($sql_restaurant_delivery_details['minimum_ammount'] != '' && ($del_more > 0)) { ?>
                                                        ...
                                                        <p style="color:#360; font-size:16px !important; font-weight:bold;">Add $ <?php echo $del_more; ?> for delivery. </p>
        <?php } ?>
