...
if($_REQUEST['submit'] == "Search")
{
	...
	$get_totals = mysql_fetch_array(mysql_query("SELECT SUM(tax) as tot_tax, SUM(tip) as tot_tip, SUM(commission) as tot_commission, SUM(coupon_discount) as tot_coupons, SUM(price_with_del_charge) as tot_sales, SUM(credit_card_fee) as tot_cc_fee FROM restaurant_menu_order WHERE order_date >= '".$start_date."' AND order_date <= '".$end_date."' AND restaurant_id = '".$_SESSION['restaurant']."'"));
...
<div class="tab-look-restu" style="padding:2%;">
            ...
            <table class="sec-pnl-top" width="100%">
              <tr>
               <td width="138px">
                ...
                <td width="81px">
                <input type="text" name="start_date" id="start_date" class="restaurant" style="width: 100px ! important; text-align: left;" value="<?php echo $_REQUEST['start_date']; ?>" autocomplete="off">
                </td>
                <td width="74px" >End Date : </td>
                <td width="47px" id="cust_date_td">
                <input type="text" name="end_date" id="end_date" class="restaurant" style="width: 100px ! important; text-align: left;" value="<?php echo $sr_end_dt; ?>" autocomplete="off">
                </td>
    ...
    <td class="all_restaurant" style="width:61px; padding: 10px 0px; color: #686868;font-family: Calibri; font-size: 13px;font-weight: bold; text-align: center;">Credit Card Fee</td>
    ...
    <td class="all_restaurant" style="width:51px; padding: 10px 0px; color: #686868;font-family: Calibri; font-size: 13px;font-weight: bold; text-align: center;">Action</td>
    </tr>
	...
	while($fetch_array = mysql_fetch_array($sql_search))
	{
		...
		?>
    <tr style="text-align:center;">
    <td class="all_restaurant2" style="width:61px; padding: 10px 0px; color: #686868;font-family: Calibri; font-size: 13px;text-align: center;"><span style="width: 56px;display: block;margin: auto;"> <?php echo $sl_no; ?> </span></td>
    <td class="all_restaurant2" style="width:155px; padding: 10px 0px; color: #686868;font-family: Calibri; font-size: 13px; text-align: center;"><span style="width: 150px;display: block;margin: auto;"> <?php echo date('m-d-Y h:i:s a', strtotime($fetch_array['order_date'])); ?> </span></td>
    <td class="all_restaurant2" style="width:70px; padding: 10px 0px; color: #686868;font-family: Calibri; font-size: 13px; text-align: center;"><span style="width: 60px;display: block;margin: auto;"> <?php echo "OR-00".$fetch_array['order_id']; ?> </span></td>
    <td class="all_restaurant2" style="width:130px; padding: 10px 0px; color: #686868;font-family: Calibri; font-size: 13px; text-align: center;"><span style="width: 125px;display: block;margin: auto;"> <?php echo getNameTable("restaurant_basic_info","restaurant_name","id",$fetch_array['restaurant_id']); ?> </span></td>
    <td class="all_restaurant2" style="width:65px; padding: 10px 0px; color: #686868;font-family: Calibri; font-size: 13px; text-align: center;"><span style="width: 60px;display: block;margin: auto;"> <?php echo $payment_mode; ?> </span></td>
    <td class="all_restaurant2" style="width:61px; padding: 10px 0px; color: #686868;font-family: Calibri; font-size: 13px; text-align: center;"><span style="width: 56px;display: block;margin: auto;"> <?php echo "$".$fetch_array['price_with_del_charge']; ?> </span></td>
    <td class="all_restaurant2" style="width:75px; padding: 10px 0px; color: #686868;font-family: Calibri; font-size: 13px; text-align: center;"><span style="width: 70px;display: block;margin: auto;"> <?php echo "$".$fetch_array['credit_card_fee']; ?> </span></td>
    <td class="all_restaurant2" style="width:75px; padding: 10px 0px; color: #686868;font-family: Calibri; font-size: 13px; text-align: center;"><span style="width: 70px;display: block;margin: auto;"> <?php echo "$".$fetch_array['commission']; ?> </span></td>
    <td class="all_restaurant2" style="width:65px; padding: 10px 0px; color: #686868;font-family: Calibri; font-size: 13px; text-align: center;"><span style="width: 60px;display: block;margin: auto;"> <?php echo "$".$fetch_array['coupon_discount']; ?></span> </td>
    <td class="all_restaurant2" style="width:67px; padding: 10px 0px; color: #686868;font-family: Calibri; font-size: 13px; text-align: center;"><span style="width: 62px;display: block;margin: auto;"> <?php echo $status; ?></span> </td>
    <td class="all_restaurant2" style="width:51px; padding: 10px 0px; color: #686868;font-family: Calibri; font-size: 13px; text-align: center;"><span style="width: 46px;display: block;margin: auto;"> <a href="javascript:void(0);" title="View" onClick="open_view_div('<?php echo $fetch_array['order_id'] ?>');" style="color:#686868;">View</a> </span></td>
