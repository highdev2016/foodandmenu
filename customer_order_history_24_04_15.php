...
<table width="970" border="1" cellspacing="0" bordercolor="d6d6d6" cellpadding="0" style="border-collapse:collapse; margin-top:10px;" class="curnt_ordr_details">
  ...
  if($totalrows > 0){ ?>
  <tr>
    <td align="center" class="cstmr_order_hstry"><a href="javascript:void(0)" onClick="sort_function('order_id')">Order No.</a></td>
    <td align="center" class="cstmr_order_hstry"><a href="javascript:void(0)" onClick="sort_function('')">Restaurant</a></td>
    <td align="center" class="cstmr_order_hstry"><a href="javascript:void(0)" onClick="sort_function('price_with_del_charge')">Total Price</a></td>
    <td align="center" class="cstmr_order_hstry"><a href="javascript:void(0)" onClick="sort_function('order_date')">Order date  (MM-DD-YYYY)</a></td>
    <td align="center" class="cstmr_order_hstry" style="color:rgb(232, 104, 7);">View Details</td>
  </tr>
