...
box-shadow: 0 0 5px #888; text-align:center; margin-top:200px; border:#1e5574 2px solid;">
<?php 
...
#fade
	...
	.pop_item{position: absolute;margin:-100px -100px 0px 0px;background:#f5f5f5;box-shadow:0px 1px 5px 0px #aeaeae;width: 500px;-moz-border-radius:5px;-webkit-border-radius:5px;border-radius:5px; z-index:999999999999;
	width:900px;}
                ...
                <div class="food_content">
                    ...
                    <div id="vertical_container" class="rstrnt_panel">
                       ...
                       <?php $sql_restaurant = mysql_fetch_array(mysql_query("SELECT * FROM restaurant_basic_info WHERE id = '".$_REQUEST['id']."'")); ?>
                           <div class="reviews_pop" style="display:none; width:510px;" id="local_review">
                    ...
                    <div class="rstrnt2_mre_info">
                            ...
                            <div>
								...
								<p style="color:#9AA930; font-weight:bold; font-size:17px;">Open Now</p>
								<?php }?>
                                <p><?php if($sql_delivery['pickup'] == 1){ echo "Currently Taking Orders"; } else { echo "Unavailable"; }?></p>
                            </div>
                    ...
                    <h2 class="popular_item"><a href="#top_div" onClick="popularitem()">More Business Info... </a></h2>
                        ...
                        <table width="100%" border="0" cellspacing="1" class="restro2_table">
                          ...
                          <div id="del_crg_div" style="display:none;">
                          <table width="100%" border="0" cellspacing="1" class="restro2_table">
                          <tr>
                    ...
                    <a href="#top_div" onClick="del_block();" class="check_order_button" style="text-decoration:none; margin-left:50px; margin-top:10px; padding:5px 50px;">Check Out </a>
                    ...
                    <div class="pop_item2" style="display:none;" id="del_add">
                        ...
                        <h3>We want to make sure this restaurant is convenient for delivery or pickup.</h3>
                            ...
                            <input name="address" id="address" type="text" class="pop_quantity" style="width:350px;" />
