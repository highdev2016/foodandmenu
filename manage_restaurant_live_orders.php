...
<table width="99%" border="1" bordercolor="c5c8d5" cellspacing="0" cellpadding="0" style="border-collapse:collapse; margin-top:20px;" align="center">
  ...
  $query_res = ("SELECT * FROM restaurant_menu_order WHERE restaurant_id = '".$sql_restaurant['id']."' ORDER BY `order_id` DESC ");
 ...
 // echo $query_res;
  ...
  <tr>
	...
	<?php echo $array_order['total_price']; ?>
    ...
    <td class="all_restaurant2">
    <a class="various1" href="#inliine<?php echo $array_order['order_id'];?>" title="View" style="color:#686868;">View</a>
     <?php if($array_order['status']!="Refund" && $array_order['payment_mode']=="Authorizes.Net")
			      {
				  ?>
     <a  href="https://foodandmenu.com/Authorize.Net-XML-master/examples/aim/createTransactionRequest_refund.php?order_id=<?php echo $array_order['order_id']; ?>&amount=<?=$array_order['total_price']?>&restaurant_id=<?=$sql_restaurant['id']?>">Refund parment</a>
