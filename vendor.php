...
#fancybox-wrap .view_top_right h1{
	margin:0;
}

#fancybox-wrap .view_top_right p{
	margin:0;
}

#fancybox-wrap .view_bottom p{
	font-weight: bold;
    margin: 0;
    padding: 0;
	font-size:14px;
...
.viewbutton{
	margin:8px 0 5px 140px !important;
}
...
<table border="0" cellspacing="0" cellpadding="0" class="vendor_table">
                 ...
                 <td width="13%" class="all_restaurant" align="right">Company Name:</td>
                  <td width="20%" class="all_restaurant">
                  ...
                  <td width="20%" class="all_restaurant"><select name="service_type" id="company_name" class="restaurant_list">
                  <option value="">----Select----</option>
                  <?php
...
<?php } else if(isset($_REQUEST['error']) && $_REQUEST['error'] == 1) { ?>
...
<p><span class="company_details">Company Name</span> <strong>:</strong> <span class="company_details_description"><?php echo $row_vendors['company_name'];?></span></p>

<p><span class="company_details">Name</span> <strong>:</strong> <span class="company_details_description"><?php echo $row_vendors['name'];?></span></p>

<p><span class="company_details">Services Type</span> <strong>:</strong> <span class="company_details_description"><?php echo $row_vendors['service_type'];?></span></p>

<p><span class="company_details">Brief Description About The Company</span> <strong>:</strong> <span class="company_details_description"><?php echo $row_vendors['company_brief_description'];?></span></p>

<p><span class="company_details">Brief Products and Services Description</span> <strong>:</strong> <span class="company_details_description"><?php echo $row_vendors['product_brief_description'];?></span></p>
...
<div class="vendor_cont_right">
  ...
  <?php if(isset($_SESSION['customer_id'])){?>
    ...
    <div style="display: none;">
		<div id="inline<?php echo $i;?>" style="width:648px;height:480px;overflow:auto;">
...
<p><span class="company_details">Address</span> <strong>:</strong> <span class="company_details_description"><?php echo $row_vendors['address'];?></span></p>

<p><span class="company_details">Phone</span> <strong>:</strong> <span class="company_details_description"><?php echo $row_vendors['phone'];?></span></p>

<p><span class="company_details">Email</span> <strong>:</strong> <span class="company_details_description"><a href="mailto:<?php echo $row_vendors['email'];?>" style="color:#333333; text-decoration:none;"><?php echo $row_vendors['email'];?></a></span></p>

<p><span class="company_details">Facebook</span> <strong>:</strong> <span class="company_details_description"><?php echo $row_vendors['social_media'];?></span></p>

<p><span class="company_details">Website</span> <strong>:</strong> <span class="company_details_description"><a href="<?php echo $row_vendors['website'];?>" target="_blank" style="color:#333333; text-decoration:none;"><?php echo $row_vendors['website'];?></a></span></p>
