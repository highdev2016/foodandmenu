...
function sort_function(sort_by){
	location.href = 'admin_restaurant_menu.php?sort_order='+sort_by;
}
</script>
...
<?php
if($_SESSION['restid']!=""){
$res_basic_info_detail=mysql_fetch_array(mysql_query("SELECT * FROM restaurant_basic_info where id='".$_SESSION['restid']."'"));
$sql_select = mysql_query("SELECT * FROM restaurant_menu_item WHERE restaurant_id='".$_SESSION['restid']."'");
...
<table width="100%" border="1" bordercolor="c5c8d5" cellspacing="0" cellpadding="0" style="border-collapse:collapse; margin-top:20px;" align="center">
  <tr>
    ...
    <td width="19%" class="all_restaurant"><a href="javascript:void(0)" onClick="sort_function('price')" class="heading_link">Price ($)</a></td>
    <td width="21%" class="all_restaurant">Image</td>
     <td width="21%" class="all_restaurant">Action</td>
  </tr>
  <?php
  ...
  <tr>
    ...
    <td class="all_restaurant2"><a href="edit_restaurant_menu_item_admin.php?menu_id=<?php echo $array_select['id']?>" class="all_edit">Edit</a></td>
  </tr>
<?php } ?>
</table></div>
<?php
