...
<form name="frm1" id="frm1" method="post" action="test_live_order.php">
...
<?php if ($total_pages > '1' ) {
            ...
            if ($page_num != 1) {
                $page_pagination .= "<a href=\"test_live_order.php?page=$prev&mod_date=".$_REQUEST['mod_date']."&customer_name=".$_REQUEST['customer_name']."&customer_phone=".$_REQUEST['customer_phone']."&customer_address=".$_REQUEST['customer_address']."&cust_date=".$_REQUEST['cust_date']."&start_date=".$_REQUEST['start_date']."&end_date=".$_REQUEST['end_date']."&item_per_page=".$_REQUEST['item_per_page']."\" class=\"more_link_pagination_prev\">Previous</a>";
				$page_pagination.='&nbsp;&nbsp;&nbsp;';
            }
