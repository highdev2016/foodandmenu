...
{
	$(".row_box").hide();
	$("#active_day"+id).css({'left': '42px','transition': '1s'});
...
{
	$(".row_box").hide();
	$("#active_day"+id).css({'left': '83px','transition': '1s'});
...
{
	$(".row_box").hide();
	$("#active_day"+id).css({'left': '124px','transition': '1s'});
...
{
	$(".row_box").hide();
	$("#active_day"+id).css({'left': '165px','transition': '1s'});
...
{
	$(".row_box").hide();
	$("#active_day"+id).css({'left': '206px','transition': '1s'});
...
{
	$(".row_box").hide();
	$("#active_day"+id).css({'left': '247px','transition': '1s'});
                    ...
                    <div class="nav_section">
                    	...
                    	<nav>
                        	...
                        	<ul id="menu">
								...
								<li><a href="login.php" class="login_icon"><span><img src="images/login-icon.png"></span> <span>Login</span></a></li>
								
								<li><a href="signup.php" class="regi_icon"><span><img src="images/regi-icon.png"></span> <span>Register</span></a></li>
								
								<?php } ?>
                                
                                <?php /*?><li><a href="login.php" class="login_icon log-icon"><span><img src="images/login-icon.png"></span> <span>Login</span></a></li>
                                
                                <li><a href="signup.php" class="regi_icon log-icon"><span><img src="images/regi-icon.png"></span> <span>Register</span></a></li><?php */?>
											...
											?>
                                                ...
                                                <ul>
                                                    <li class="<?php if($_REQUEST['hid_default'] == "default"){?>active_sort<?php } ?>">                                                            
                                                        ...
                                                        <a href="javascript:void(0);" onClick="place_hid_val('default');sub_form();">Default</a></label>
                                                    ...
                                                    <li class="<?php if($_REQUEST['hid_top_rated'] == "top_rated"){?>active_sort<?php } ?>">                                                            
                                                        ...
                                                        <a href="javascript:void(0);" onClick="place_hid_val('top_rated');sub_form();">Top Rated</a></label>
                                                    ...
                                                    <li class="<?php if($_REQUEST['hid_distance'] == "distance"){?>active_sort<?php } ?>">                                                            
                                                        ...
                                                        <a href="javascript:void(0);" onClick="place_hid_val('distance');sub_form();">Distance</a></label>
                                                    ...
                                                    <li class="<?php if($_REQUEST['hid_min_order'] == "min_order"){?>active_sort<?php } ?>">                                                            
                                                        <label>
                                                        <i class="fa fa-usd"></i>
                                                        <a href="javascript:void(0);" onClick="place_hid_val('min_order');sub_form();">Min Order</a></label>
                                                    ...
                                                    <li class="<?php if($_REQUEST['hid_newest'] == "newest"){?>active_sort<?php } ?>">                                                            
                                                        ...
                                                        <a href="javascript:void(0);" onClick="place_hid_val('newest');sub_form();">Newest</a></label>
                    	...
                    	<div class="container">
                            ...
                            while($row_search = mysql_fetch_array($res_search))
							{
			                    ...
			                    <?php } ?></p>
                             		 ...
                             		 <div class="col-xs-3 padd-right poptbl">
