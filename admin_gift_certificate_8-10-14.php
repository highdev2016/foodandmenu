...
<table><tr>
<td width="114">Certificate No : </td><td width="219"><input type="text" name="certificate_no" value="<?php echo $_REQUEST['certificate_no'];?>" style="height:23px;" class="restaurant"></td>
<td width="152">Validation Code : </td><td width="247"><input type="text" name="validation_code" value="<?php echo $_REQUEST['validation_code'];?>" style="height:23px;" class="restaurant"></td>

<td width="146">Restaurant Name : </td>
                <td width="184"><input type="text" name="restaurant_name" value="<?php echo $_REQUEST['restaurant_name'];?>" style="height:23px;  width: 168px;" class="restaurant"></td>
...
<td width="67"><a href="admin_gift_certificate.php" style="text-decoration:none;"><input type="button" name="show_all" value="Show All" class="button4" style="margin:0px;"></a></td>
</tr>
</table>
</form>
