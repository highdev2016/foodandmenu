...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                 ...
                 <td height="39" class="all_restaurant">Restaurant Name:</td>
                  ...
                  <option value="">--Select--</option>
                  <?php /*?><?php $sql_restaurant_name = mysql_query("SELECT * FROM restaurant_basic_info WHERE id!='' ORDER BY restaurant_name");
...
<div class="restaurant_cont_field"><table width="100%" border="1" bordercolor="c5c8d5" cellspacing="0" cellpadding="0" style="border-collapse:collapse; margin-top:20px;">
  <tr>
    <td width="245" class="all_restaurant"><a href="javascript:void(0)" onClick="sort_function('restaurant_name','<?php echo $_REQUEST['restaurant_name'];?>','<?php echo $_REQUEST['category'];?>')" class="heading_link">Restaurant Name</a></td>
    ...
    <td width="213" class="all_restaurant"><a href="javascript:void(0)" onClick="sort_function('restaurant_category_name','<?php echo $_REQUEST['restaurant_name'];?>','<?php echo $_REQUEST['category'];?>')" class="heading_link">Restaurant Category</a></td>
    <td width="205" class="all_restaurant">Image</td>
    <td width="217" class="all_restaurant">Action</td>
  </tr>
  <?php
