...
<div class="statement_export_file">
<?php
if($_REQUEST['submit'] == "Search" && $sql_num_rows > 0)
{
	?>
    <input type="submit" name="export" value="Export to Excel" class="button4">
    <a href="billing_export_pdf.php?statement=<?php echo $_REQUEST['statement']; ?>" title="Export to Pdf" target="_blank" style="text-decoration:none;"><input type="button" name="export_pdf" value="Export to Pdf" class="button4"></a>
	<?php
}
?>
...
<div class="clear"></div>
   ...
   <!-- EAT24 Deposited Into Your Account: $ -->
    ...
    <th class="all_restaurant">Order Time</th>
    <th class="all_restaurant">Order #</th>
    <th class="all_restaurant">Restaurant</th>
    <th class="all_restaurant">Type</th>
    <th class="all_restaurant">Tax</th>
    <th class="all_restaurant">Delivery Fee</th>
    <th class="all_restaurant">Tip</th>
    ...
    <td class="all_restaurant2" style="color: #686868;font-family: Calibri;font-size: 13px;padding: 17px "> <?php echo "$".$fetch_array['tax']; ?></td>
    <td class="all_restaurant2" style="color: #686868;font-family: Calibri;font-size: 13px;padding: 17px "> <?php echo "$".number_format($fetch_array['delivery_charge'],2); ?></td>
    <td class="all_restaurant2" style="color: #686868;font-family: Calibri;font-size: 13px;padding: 17px "> <?php echo "$".$fetch_array['tip']; ?></td>
