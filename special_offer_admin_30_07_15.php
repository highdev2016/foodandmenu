...
//			mail($email,$subject,$message,$headers);
	...
	$disclaimer_row=mysql_num_rows(mysql_query("SELECT * FROM restaurant_disclaimer WHERE restaurant_id='".$_SESSION['restid']."'"));
	if($disclaimer_row>0)
	{
		mysql_query("update restaurant_disclaimer set disclaimer='".$_REQUEST['disclaimer']."',description='".$_REQUEST['dis_description']."' WHERE restaurant_id='".$_SESSION['restid']."'");
	}
	else{
	mysql_query("insert into restaurant_disclaimer set restaurant_id='".$_SESSION['restid']."', disclaimer='".$_REQUEST['disclaimer']."',description='".$_REQUEST['dis_description']."'");
	}
	//mysql_query("insert into restaurant_disclamer set restaurant_id='".$_SESSION['rest_id']."', disclaimer='".$_REQUEST['disclaimer']."'");
...
<div class="restaurant_nav">
                    ...
                    <li><a href="special_offer_admin.php" class="active7">Special Offer</a></li>
...
<?php $basic_info_for_disclaimer=mysql_fetch_array(mysql_query("select * from restaurant_disclaimer where restaurant_id='".$_SESSION['restid']."'"));?>
...
<input name="coupon_price1" id="coupon_price1" type="text" onKeyUp="disable_coupon_percent1()" class="restaurant" onKeyPress="return goodchars(event,'1234567890.');" onBlur="check_order_coupon_price1()" />
...
<input name="coupon_code1" id="coupon_code1" type="text" class="restaurant coupon_code" value="<?php echo $randomString; ?>" onKeyUp="check_coupon_code(this.value, '<?php echo $_SESSION['restid']; ?>',1);"  />
...
<input name="coupon_code2" id="coupon_code2" type="text" class="restaurant coupon_code" value="<?php echo $randomString1; ?>" onKeyUp="check_coupon_code(this.value, '<?php echo $_SESSION['restid']; ?>',2);" />
...
<input name="coupon_code3" id="coupon_code3" type="text" class="restaurant coupon_code" value="<?php echo $randomString2; ?>" onKeyUp="check_coupon_code(this.value, '<?php echo $_SESSION['restid']; ?>',3);" />
...
<input name="coupon_price3" type="text" class="restaurant" />
...
<input name="coupon_code4" id="coupon_code4" type="text" class="restaurant coupon_code" value="<?php echo $randomString3; ?>" onKeyUp="check_coupon_code(this.value, '<?php echo $_SESSION['restid']; ?>',4);" />
