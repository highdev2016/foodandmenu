                    ...
                    <div class="nav_section">
                        ...
                        <nav>
                            ...
                            <ul id="menu">
                                ...
                                <li><a href="vendor.php" <?php
                                    if ($page == "vendor.php") {
                                        $class = "active_menu";
                                    }
                                    ?> class="mid_menu">Vendors</a></li>
                                        ...
                                        <div class="pick_sort_sec">
                                            ...
                                            <div class="right_search">
                                                ...
                                                <div class="sort_sec cuisines_nw">
                                                	 <div class="cuisines" onclick='open_toggle()'>
                                                    	<h1><img src="images/pop-icon.png" alt=""/> Cuisines</h1>	
                                                    </div>
													<div class="cuisines_ul" style="display: none;">
                                                    <ul>
                                                        <?php
                                                ...
                                                <div class="sort_sec cuisines_nw">
                                                	<div class="distance" onclick='open_toggle()'>
                                                    	<h1><img src="images/pop-icon.png" alt=""/> Distance</h1>	
                                                    </div>

                                                    <ul class="distance_ul" style="display: none">
                                                        <?php /* ?> <li>  
...
<?php /* ?><a href="#">More Distances</a> <?php */ ?>
        ...
        <?php } ?></p>
                                                        ...
                                                        <ul class="delivery_order">
                                                            ...
                                                            <li>Delivery Min: $<?php if ($row_search['minimum_ammount'] != "")
                                                            echo number_format($row_search['minimum_ammount'], 2);
                                                        else
                                                            echo "0.00";
                                                        ?></li>

                                                            <li>Delivery Fee: <?php if ($del_fee != 0.00)
                                                            echo "$" . $del_fee;
                                                        else
                                                            echo "Free";
                                                        ?></li>
...
?>
                            <div class="search_main_map" id="navigation" style="margin-top:19px;">
                                <div class="search_main_map_inner">
                                    ...
                                    <div id="map-canvas" style="width: 261px; height: 400px;"></div>
                                    <script>
                                        var poly;
                                        var geodesicPoly;
                                        var marker1;
...
<script type="text/javascript">
    ...
    $j(document).scroll(function () {
		...
		var start_pt = $j("#start_div").offset().top;
		var end_pt = $j("#stopHere").offset().top-600;
