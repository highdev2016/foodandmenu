...
<div class="registration_section registration_admin_section">
        ...
        <div class="regi_sign_up">
            ...
            <?php if($error == 1){ ?>
            <p class="login_error">The email address or password entered is not valid.</p>
            <?php } ?>
            
            <div class="clear"></div>
            
            <?php if($_REQUEST['success'] == 1){ ?>
            <p class="login_success">Password Changed Successfully.</p>
            <?php } ?>
	...
	<!--<div class="registration_left"></div>
