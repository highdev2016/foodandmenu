...
<tr>
   ...
   <!-- EAT24 Deposited Into Your Account: $ -->
    ...
    <div class="div-tbl" style="margin-top: 15px;">
    	<div class="div-row" style="display:table; border-right: 1px solid #CCCCCC;border-bottom: 1px solid #CCCCCC;">
		    <div class="head_class-1" style="width:61px; border-left: 1px solid #CCCCCC; border-top: 1px solid #CCCCCC;float: left;padding: 17px 6px; color: #686868;font-family: Calibri; font-size: 13px;font-weight: normal; text-align: center;"><strong>Serial No. </strong></div>
		    <div class="head_class-2" style="width:148px; border-left: 1px solid #CCCCCC; border-top: 1px solid #CCCCCC;float: left;padding: 17px 6px; color: #686868;font-family: Calibri; font-size: 13px;font-weight: normal; text-align: center;"><strong>Order Time</strong></div>
		    <div class="head_class-3" style="width:82px; border-left: 1px solid #CCCCCC; border-top: 1px solid #CCCCCC;float: left;padding: 17px 6px;color: #686868;font-family: Calibri; font-size: 13px;font-weight: normal; text-align: center;"><strong>Order #</strong></div>
		    <div class="head_class-4" style="width:157px; border-left: 1px solid #CCCCCC; border-top: 1px solid #CCCCCC;float: left;padding: 17px 6px;color: #686868;font-family: Calibri; font-size: 13px;font-weight: normal; text-align: center;"><strong>Restaurant</strong></div>
		    <div class="head_class-5" style="width:42px; border-left: 1px solid #CCCCCC; border-top: 1px solid #CCCCCC;float: left;padding: 17px 6px;color: #686868;font-family: Calibri; font-size: 13px;font-weight: normal;text-align: center;"><strong>Type</strong></div>
		    <div class="head_class-6" style="width:48px; border-left: 1px solid #CCCCCC; border-top: 1px solid #CCCCCC;float: left;padding: 17px 6px;color: #686868;font-family: Calibri; font-size: 13px;font-weight: normal;text-align: center;"><strong>Tax</strong></div>
		    <div class="head_class-7" style="width:80px; border-left: 1px solid #CCCCCC; border-top: 1px solid #CCCCCC;float: left;padding: 17px 6px;color: #686868;font-family: Calibri; font-size: 13px;font-weight: normal;text-align: center;"><strong>Delivery Fee</strong></div>
		    <div class="head_class-8" style="width:80px; border-left: 1px solid #CCCCCC; border-top: 1px solid #CCCCCC;float: left;padding: 17px 6px;color: #686868;font-family: Calibri; font-size: 13px;font-weight: normal;text-align: center;"><strong>Tip</strong></div>
		    <div class="head_class-9" style="width:93px; border-left: 1px solid #CCCCCC; border-top: 1px solid #CCCCCC;float: left;padding: 17px 6px;color: #686868;font-family: Calibri; font-size: 13px;font-weight: normal;text-align: center;"><strong>Total</strong></div>
		</div>    
    <!-- </tr> -->
    <?php 
	$sl_no=1;
	...
	?>
	<div class="div-row">
	    <div class="head_class-1"><?php echo $sl_no; ?></div>
	    <div class="head_class-2"><?php echo date('m-d-Y h:i:s a', strtotime($fetch_array['order_date'])); ?></div>
	    <div class="head_class-3"><?php echo "OR-00".$fetch_array['order_id']; ?></div>
	    <div class="head_class-4"><?php echo getNameTable("restaurant_basic_info","restaurant_name","id",$fetch_array['restaurant_id']); ?></div>
	    <div class="head_class-5"><?php echo $payment_mode; ?></div>
	    <div class="head_class-6"><?php echo "$".$fetch_array['tax']; ?></div>
	    <div class="head_class-7"><?php echo "$".number_format($fetch_array['delivery_charge'],2); ?></div>
	    <div class="head_class-8"><?php echo "$".$fetch_array['tip']; ?></div>
	    <div class="head_class-9"><?php echo "$".$fetch_array['price_with_del_charge']; ?></div>
    </div>
    <?php
	$sl_no++;
	}
