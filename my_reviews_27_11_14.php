...
<table width="99%" border="1" bordercolor="c5c8d5" cellspacing="0" cellpadding="0" style="border-collapse:collapse; margin-top:20px;" align="center">
  <tr>
    ...
    <td width="11%" class="all_restaurant"><a href="javascript:void(0)" onClick="sort_function('post_date','<?php echo $_REQUEST['post_date']; ?>','<?php echo $_REQUEST['customer_name']; ?>')" class="heading_link">Post Date</a></td>
    <td width="15%" class="all_restaurant"><a href="javascript:void(0)" onClick="sort_function('customer_name','<?php echo $_REQUEST['post_date']; ?>','<?php echo $_REQUEST['customer_name']; ?>')" class="heading_link">Customer Name</a></td>
    <td width="10%" class="all_restaurant"><a href="javascript:void(0)" onClick="sort_function('city','<?php echo $_REQUEST['post_date']; ?>','<?php echo $_REQUEST['customer_name']; ?>')" class="heading_link">City</a></td>
    <td width="11%" class="all_restaurant"><a href="javascript:void(0)" onClick="sort_function('state','<?php echo $_REQUEST['post_date']; ?>','<?php echo $_REQUEST['customer_name']; ?>')" class="heading_link">State</a></td>
    <td width="10%" class="all_restaurant">Review Image</td>
    <td width="34%" class="all_restaurant"><a href="javascript:void(0)" onClick="sort_function('customer_review','<?php echo $_REQUEST['post_date']; ?>','<?php echo $_REQUEST['customer_name']; ?>')" class="heading_link">Reviews</a></td>
...
date("m-d-Y", strtotime($array_order['post_date'])); ?></td>
  ...
  <div id="review_div<?php echo $array_order['id']; ?>" class="factor_details white_content nw_white_cont" style="display:none;">
        ...
        <div class="l-contnt nw-l-cont"> 
               <h2 class="pop-title up_nw_load_nw" style="margin-bottom: 6px;">Reply on Review</h2>
                        
                        <div class="form-body reason_reject">
                        
                        <div class="form-group">
										<label class="control-label pop-text">
...

								{
                                    ...
                                    <?php } ?> 
                                        ...
                                        <?php echo  
date("m-d-Y", strtotime($array_order['post_date']));?> by <?php echo $array_order['customer_name']; ?>
...
<div class="rating_content rviw">
 ...
 $rating_updated = getSingleReviewRating($array_order['restaurant_id'],$array_order['id']);
                                        ...
                                        <?php echo $array_order['customer_review']; ?>
                                            </div>
                               		...
                               		<div class="form-group">
										<label class="control-label pop-text">Reply Content                                 			<span class="required">*</span>        
										</label>
                                        
                                        <div class="text_pad pop-fild">
                    <textarea onKeyUp="check_val(<?php echo $array_order['id']; ?>);"  style="border: 1px solid rgb(181, 171, 198); border-radius: 2px; width: 379px; height: 85px;" id="rep_content<?php echo $array_order['id'] ?>" ><?php if($get_owner_review['comment'] != '') { echo $get_owner_review['comment']; } ?></textarea>
