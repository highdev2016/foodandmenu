        ...
        ?>
                                                <table width="100%" border="0" cellspacing="1" class="restro2_table" >
                                                    ...
                                                    echo $sql_item_name['menu_name'];
                                                        ?></td>
                                                            <td height="30" align="left" style="padding-left:2px;">$ <?php echo number_format(($array_items['quantity'] * $array_items['price']),2); ?> <a href="delete_menu_cart_item.php?id=<?php echo $_REQUEST['id']; ?>&del_id=<?php echo $array_items['id']; ?>" onClick="return confirm('Are you sure?');"><img src="images/1400777057_delete.png" height="12" width="12"></a></td>
                                                        </tr>
