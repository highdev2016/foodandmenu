...
//{
	...
	if($_REQUEST['cuisine_pop'] != "")
	{
		$cuisine_str = '';
		$sep2 = '';
		foreach($_REQUEST['cuisine_pop'] as $cuisine)
		{
			$cuisine_str = $cuisine_str.$sep2.$cuisine;
			$sep2 = ',';
		}
            ...
            <header>
                ...
                <div class="container">
                	...
                	<div class="logo_section slideDown">
                    	...
                    	<a href="index.php"><img src="images/inner-logo.png" width="148" height="92"></a>
                    ...
                    <div class="nav_section">
                    	...
                    	<nav>
                        	...
                        	<ul id="menu">
                                ...
                                <li><a href="vendor.php" <?php if($page=="vendor.php"){ $class = "active_menu"; } ?> class="mid_menu inner_menu">Vendors</a></li>
                                    ...
                                    <div class="col-xs-7">
                                    	...
                                    	<div class="right_search">
                                            ...
                                            <div class="sort_sec cuisines_nw">
												...
												?>
                                                    <li>  
                                                    	<input name="cuisine[]" type="checkbox" value="<?php echo $row_cuisine['id']; ?>" class="sort_check" onClick="sub_form();" <?php if(in_array($row_cuisine['id'],$_REQUEST['cuisine'])) { ?> checked <?php } ?> >                                      
                                            ...
                                            <div class="sort_sec cuisines_nw">
												...
												?>
                                                    <li>  
                                                    	<input name="cuisine_pop[]" type="checkbox" value="<?php echo $row_all_cuisine['id']; ?>" class="sort_check" onClick="sub_form();" <?php if(in_array($row_all_cuisine['id'],$_REQUEST['cuisine_pop']) || in_array($row_all_cuisine['id'],$_REQUEST['cuisine'])) { ?> checked <?php } ?> >                                      
                            ...
                            while($row_search = mysql_fetch_array($res_search))
							{
			                    ...
			                    <?php } ?></p>
                                        ...
                                        <div class="listing_buttons">
                                        	...
                                        	<a href="javascript:void(0);" onClick="open_gift_div('<?php echo $row_search['id']; ?>');">Gift Certificate</a>
                                            
                                            <a href="javascript:void(0);" onClick="open_coupon_div('<?php echo $row_search['id']; ?>');">Online Coupons</a>
                            ...
                            <div class="col-xs-3 padd-right">
                            	...
                            	<div class="search_map_sec">
                                    ...
                                    <div class="search_panel_pop_div" id="gift_pop_div<?php echo $row_search4['id']; ?>" style="display:none;">
                                        ...
                                        <h1>Gift Certificate <a href="javascript:void(0);" onClick="close_gift_div('<?php echo $row_search4['id']; ?>');"><i class="fa fa-times"></i></a></h1>
                                                                                                                        
                                        <p><?php echo stripslashes($row_search4['restaurant_name']); ?></p>
