...
<?php } ?>
<?php if($error == 2){ ?>
<p style="color:red; margin-bottom:5px;">Your Account has been disabled.</p>
<?php } ?>
...
<a href="javascript:void(0);" onClick="checkLoginState();"><img src="images/fb_connect.png" width="219" height="37" /></a>

<?php //} ?>
                         
<a href="javascript:void(0);" onClick="login_google_plus();"><img src="images/sign_up_with.png" width="219" height="37" /> </a>
<ul>
