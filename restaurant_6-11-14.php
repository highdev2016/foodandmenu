                ...
                <div class="food_content">
                    ...
                    <div id="vertical_container" class="rstrnt_panel">
					   ...
					   if($cart_row == 0){
                        ...
                        <div class="rstrnt_right_panel rstrnt_right_panel_new">
                    <div class="rstrnt_right_panel1 rstrnt_right_panel_new1" style="min-height:310px; display:<?php echo $display; ?>;">
                    ...
                    <h2 class="popular_item"><a href="#top_div" onClick="popularitem()">More Business Info... </a></h2>
                        ...
                        <div class="rstrnt_right_panel1 rstrnt_right_panel_new1" style="display:<?php echo $display1; ?>;">
