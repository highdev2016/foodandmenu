...
{
	mysql_query("DELETE FROM  restaurant_contact_category WHERE id=".$_REQUEST['delete_id']."");
	$msg1="Successfully deleted category.";
	header("location:manage_contact_category.php?msg1=$msg1&page=".$_REQUEST['page']."");
}
///////////////////////End for delete/////////////////////////////////////
...
<form name="frmproduct" action="manage_contact_category.php" method="post">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
           <tr>
             <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
               <tr>
                 <td><h2 style="background:#FA8730; color:#fff; padding:8px;">Manage Contact form category</h2> <span style="float:right" class="login_labelin"><a href="add_contact_category.php" style="color:#7D7E7E; text-decoration:none; font-weight:bold;">Add Contact Category</a></span></td>
               </tr>
               <tr>
                 <td></td>
               </tr>
             ...
             <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
               ...
               <tr>
                 ...
                 <table width="100%" height="99" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC" style="border-collapse:collapse;">
                  ...
                  <?php 
				    $query_res="select * from  restaurant_contact_category where 1";
		...
		if($page > 1) 
		{ 
		$pagination .= "<a href=\"manage_contact_category.php?page=$prev\" class=\"more_link_pagination_prev\">Previous</a>"; 
		$pagination.="&nbsp;&nbsp;&nbsp;";
		} 
		...
		{ 
		$pagination .= "<a href=\"manage_contact_category.php?page=$i\" class=\"more_link_pagination\">$i</a>"; 
		$pagination.='&nbsp;&nbsp;&nbsp;';
		} 
		} 
		...
		if($page < $total_pages) 
		{ 
		$pagination .= "<a href=\"manage_contact_category.php?page=$next\" class=\"more_link_pagination_prev\">Next</a>"; 
		$pagination.="&nbsp;&nbsp;&nbsp;";
		} 
		...
		////////////////////////////////End pagination////////////////////////////////////
					...
					?>
                      ...
                      <td align="center" valign="middle"><?php  echo $array_products['contact_category']; ?></td>  
           
                     <td align="center" valign="middle"><a href="edit_contact_category.php?action=edit&id=<?php echo $array_products['id'];?>&page=<?=$_REQUEST['page']?>" onClick="return confirm('Are you sure, you want to edit ?');"><img src="images/1304761512_pen.png" alt="Edit" title="Edit" border="0" /></a>&nbsp;&nbsp;<a href="manage_contact_category.php?delete=del&delete_id=<?php echo $array_products['id'];?>&page=<?=$_REQUEST['page']?>" onClick="return confirm('Are you sure?');"><img src="images/1304761651_DeleteRed.png" alt="Delete" title="Delete" border="0" /></a>
                      </td>
					</tr>
					<?php
						$inc++;}
