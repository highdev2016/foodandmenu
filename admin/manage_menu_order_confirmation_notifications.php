	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
           <tr>
             <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
               <tr>
                 <td height="92"><h2 style="background:#FA8730; color:#fff; padding:8px;">Manage Menu Order Confirmation Notification</h2><span style="float:right" class="login_labelin"><a href="javascript:void(0);" onclick="history.back();" ><input type="button" name="back" id="back" value="Back" class="normalbutton" /></a></span></td>
               </tr>
               <tr>
                 <td>
                 </td>
                 ...
                 <table width="100%" height="99" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC" style="border-collapse:collapse;">
                   <tr class="login_labelin" bgcolor="#404CA1" style="color:#ffffff;">
                    ...
                    <tr bgcolor="#ffffff" height="40">
                      ...
                      <td align="center" valign="middle"><a href="manage_auto_responder.php?page_id=29">EDIT</a></td>
					</tr>
                    
                    <tr bgcolor="#eeeeee" height="40">
                      <td align="center" valign="middle">2</td> 
                      <td align="center" valign="middle">MAIL TO ADMIN</td> 
                      <td align="center" valign="middle"><a href="manage_auto_responder.php?page_id=30">EDIT</a></td>
					</tr>
