...
$sql_update = mysql_query("UPDATE restaurant_customer SET account_disabled = 0 WHERE id = '".$_REQUEST['id']."'");
...
$sql_cms = mysql_fetch_array(mysql_query("SELECT * FROM restaurant_auto_responder WHERE page_id = 32"));	
...
header("location:manage_customer.php?enabled=1&page=".$_REQUEST['page']."");
