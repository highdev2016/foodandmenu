...
function main()
{
  ...
  $sql="select * from restaurant_home_page_content where id = 3";
...

  {
	...
	$sql_about = ("update  restaurant_home_page_content set heading='".$heading."',description='".$description."' WHERE id = 3");
...
$sql_select=mysql_query("select * from  restaurant_home_page_content where id = 3");
