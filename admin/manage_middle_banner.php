...
{
	mysql_query("DELETE FROM restaurant_middle_banner WHERE id=".$_REQUEST['delete_id']."");
	header("location:manage_middle_banner.php?success=2&page=".$_REQUEST['page']."");
}
///////////////////////End for delete/////////////////////////////////////
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
           <tr>
             <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
               <tr>
                 <td><h2 style="background:#FA8730; color:#fff; padding:8px;">Manage Middle Banner</h2> <span style="float:right" class="login_labelin"><a href="add_middle_banner.php" style="color:#7D7E7E; text-decoration:none; font-weight:bold;">Add Middle Banner</a></span></td>
               </tr>
               <tr>
                 <td></td>
               </tr>
               <tr>
                 <td style="padding-left:20px; padding-top:15px;"></td>
					  ...
					  {?>
					  <tr>
						<td height="30" colspan="4" align="center" class="login_labelin"><font color="#FF3333"><img src="images/approve.jpg" height="18" align="absmiddle">Middle Banner Added Successfully</font></td>
					  </tr>
					  <?php
					  }
					  ...
					  {?>
					  <tr>
						<td height="30" colspan="4" align="center" class="login_labelin"><font color="#FF3333"><img src="images/approve.jpg" height="18" align="absmiddle">Middle Banner Deleted Successfully.  </font></td>
					  </tr>
					  <?php
					  }
					  ...
					  {?>
					  <tr>
						<td height="30" colspan="4" align="center" class="login_labelin"><font color="#FF3333"><img src="images/approve.jpg" height="18" align="absmiddle">Middle Banner Updated Successfully.  </font></td>
					  </tr>
					  <?php
					  }
					  ?>
             ...
             <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
               ...
               <tr>
                 ...
                 <table width="100%" height="99" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC" style="border-collapse:collapse;">
                  ...
                  <?php 
				    $query_res="select * from restaurant_middle_banner where 1";
		...
		////////////////////////////////End pagination////////////////////////////////////
					...
					?>
                     ...
                     <td align="center" valign="middle"><a href="edit_middle_banner.php?action=edit&id=<?php echo $array_products['id'];?>&page=<?=$_REQUEST['page']?>" onClick="return confirm('Are you sure, you want to edit ?');"><img src="images/1304761512_pen.png" alt="Edit" title="Edit" border="0" /></a>&nbsp;&nbsp;<a href="manage_banner.php?delete=del&delete_id=<?php echo $array_products['id'];?>&page=<?=$_REQUEST['page']?>" onClick="return confirm('Are you sure?you want to delete this middle Banner?');"><img src="images/1304761651_DeleteRed.png" alt="Delete" title="Delete" border="0" /></a>
                      </td>
					</tr>
					<?php
						$inc++;}
