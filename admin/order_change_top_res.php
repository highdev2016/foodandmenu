<?php  ob_start();
	...
	mysql_query("UPDATE restaurant_basic_info set show_order=1 WHERE id=".$parent."");
	...
	$sql_featured_city=mysql_query("SELECT show_order,id FROM restaurant_basic_info WHERE status=1 AND id NOT IN(".$parent.") ORDER BY show_order");
