...
if($_REQUEST['delete']=="del" && $_REQUEST['delete_id']!='')
{
	...
	$msg1="Successfully deleted restaurant admin.";
	header("location:manage_restaurant_admin.php?msg1=$msg1&page=".$_REQUEST['page']."");
}
///////////////////////End for delete/////////////////////////////////////
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
           <tr>
             <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
               <tr>
                 <td><h2 style="background:#FA8730; color:#fff; padding:8px;">Manage Restaurant Admin</h2> <span style="float:right" class="login_labelin"><a href="add_restaurant_admin.php" style="color:#7D7E7E; text-decoration:none; font-weight:bold;">Add Restaurant Admin</a></span></td>
               </tr>
               <tr>
                 <td></td>
               </tr>
             ...
             <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
               ...
               <tr>
                 ...
                 <table width="100%" height="99" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC" style="border-collapse:collapse;">
                  ...
                  <?php 
				    $query_res="select * from restaurant_users where user_type='admin_restaurant'";
		...
		if($page > 1) 
		{ 
		$pagination .= "<a href=\"manage_restaurant_admin.php?page=$prev\" class=\"more_link_pagination_prev\">Previous</a>"; 
		$pagination.="&nbsp;&nbsp;&nbsp;";
		} 
		...
		{ 
		$pagination .= "<a href=\"manage_restaurant_admin.php?page=$i\" class=\"more_link_pagination\">$i</a>"; 
		$pagination.='&nbsp;&nbsp;&nbsp;';
		} 
		} 
		...
		if($page < $total_pages) 
		{ 
		$pagination .= "<a href=\"manage_restaurant_admin.php?page=$next\" class=\"more_link_pagination_prev\">Next</a>"; 
		$pagination.="&nbsp;&nbsp;&nbsp;";
		} 
		...
		////////////////////////////////End pagination////////////////////////////////////
					...
					?>
                     ...
                     <td align="center" valign="middle"><a href="edit_restaurant_admin.php?id=<?php echo $array_products['ID'];?>">EDIT</a> &nbsp;&nbsp;<a href="manage_restaurant_admin.php?delete=del&delete_id=<?php echo $array_products['ID'];?>&page=<?=$_REQUEST['page']?>" onClick="return confirm('Are you sure?');"><!--<img src="images/1304761651_DeleteRed.png" alt="Delete" title="Delete" border="0" />-->
                     DELETE</a>
                      </td>
					</tr>
					<?php
