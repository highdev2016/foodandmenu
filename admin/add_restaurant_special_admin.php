...
function main()
{
	...
	if(count($_POST)>0 && $_REQUEST['submit']=="Add")
	{
			...
			mysql_query("insert into  restaurant_users set  user_email='".mysql_real_escape_string($_REQUEST['email_id'])."',user_pass='".mysql_real_escape_string(md5($_REQUEST['pwd']))."',user_type='admin_restaurant_add',user_status=1");
...
<h2 style="background:#FA8730; color:#fff; padding:8px;">Add restaurant special admin</h2>
