...
<a href = "javascript:void(0)" onclick = "document.getElementById('light').style.display='none';document.getElementById('fade').style.display='none'"><img src="images/fancy_closebox.png" style=" margin-left: 259px;
    ...
    <div class="body_container">
       ...
       <?php
	   $total_review=mysql_num_rows(mysql_query("SELECT * FROM restaurant_reviews where restaurant_id='".$_REQUEST['id']."' AND status=1 AND parent_id = 0 AND review_status = 0"));
	   ...
	   ?>             
						...
						$sql = "SELECT * 
								...
								WHERE rr.id = rrat.review_id AND rr.restaurant_id='".$_REQUEST['id']."' AND rrat.restaurant_id='".$_REQUEST['id']."' AND rr.status=1 AND rr.review_status = 0";
                      ...
                      <div class="review_detail">
                        ...
                        <div class="arrow_review"><img src="images/arrow_review.jpg" alt="" /></div>
                                ...
                                <div class="rating_content_two">
                                    ...
                                    <?php $uploaded_image = 'uploaded_images/'.$row_updated_review['review_picture'];
									...
									else
									{
									 ...
									 ?>	
                                   	  <h5>
<?php echo change_dateformat_reverse($row_updated_review['post_date']); ?>  By <span><?php echo $row_updated_review['customer_name']?></span></h5> <?php echo $upd_status; ?>
                                        <p class="review-con"><?php if($row_updated_review['review_picture'] != '') { ?><a class="example_cat" href="<?php echo $uploaded_image; ?>"><img src="thumb_images/<?php echo $row_updated_review['review_picture']; ?>" height="30"></a><?php } echo $row_updated_review['customer_review']?></p>
...
<?php echo $prev_status; ?>
                                        <p class="review-con"><?php if($res_review['review_picture'] != '') { ?><a class="example_cat" href="<?php echo $uploaded_image; ?>"><img src="thumb_images/<?php echo $res_review['review_picture']; ?>" height="30"></a><?php } echo $res_review['customer_review']?></p>
                                        <div class="viewers_comment">
                                    <ul>
