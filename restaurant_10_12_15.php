...
<?php } ?>
        ...
        ?>
                                                <table width="100%" border="0" cellspacing="1" class="restro2_table" >
                                                    <tr>
                                                        <td width="10%" height="20" colspan="3" align="center" class="restro2_table_bg"><h2>Qty</h2></td>
                                                    ...
                                                    while ($array_items = mysql_fetch_array($sql_items)) {
                                                        ...
                                                        <tr>
                                                            <td height="30" colspan="3" align="center" class="text-center"><a class="qunTty" href="#"><?php echo $array_items['quantity']; ?></a>
                                                                <div class="item_hover"> <a href="restaurant.php?id=<?php echo $_REQUEST['id']; ?>&sub=sub&cart_id=<?php echo $array_items['id']; ?>">-</a> <a style="margin-left:2px;" href="restaurant.php?id=<?php echo $_REQUEST['id']; ?>&add=add&cart_id=<?php echo $array_items['id']; ?>">+</a> </div></td>
