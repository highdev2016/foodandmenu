...
<?php /*?><script src="//code.jquery.com/ui/1.11.1/jquery-ui.js"></script><?php */?>
...
function sort_function(sort_by,submit1,start_date,end_date){
	location.href = 'balance_15-10-14.php?sort_order='+sort_by+'&submit='+submit1+'&start_date='+start_date+'&end_date='+end_date;
}
</script>
...
<ul class="tab-look">
	...
	<li class="active"><a href="balance_15-10-14.php">Balance</a></li>
</ul>
...
<div class="tab-look-restu" style="padding:2%;">
          <form name="frm" method="post" action="balance_15-10-14.php" onSubmit="return check_validtion();">
