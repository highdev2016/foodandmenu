...
if($_REQUEST['delete_mon_buss_hrs']!=''){
	...
	header("location:edit_additional_new.php?restaurant_edit_id=".$_REQUEST['restaurant_edit_id']."&bus_del_success=1");
}
/*------------------------------- Delete Monday Business Hours ---------------------------------------------*/
...
while($array_del_charges = mysql_fetch_array($sql_select_del_charges)){
	...
	$sql_tue_bussiness_hrs = mysql_query("SELECT * FROM restaurant_buss_hrs WHERE restaurant_id = '".$_REQUEST['hid']."' AND days_id = '1'");
	$k_tue = 1;
	...
	$sql_wed_bussiness_hrs = mysql_query("SELECT * FROM restaurant_buss_hrs WHERE restaurant_id = '".$_REQUEST['hid']."' AND days_id = '1'");
	$k_wed = 1;
	...
	$sql_thu_bussiness_hrs = mysql_query("SELECT * FROM restaurant_buss_hrs WHERE restaurant_id = '".$_REQUEST['hid']."' AND days_id = '1'");
	$k_thu = 1;
	...
	$sql_fri_bussiness_hrs = mysql_query("SELECT * FROM restaurant_buss_hrs WHERE restaurant_id = '".$_REQUEST['hid']."' AND days_id = '1'");
	$k_fri = 1;
	...
	$sql_sat_bussiness_hrs = mysql_query("SELECT * FROM restaurant_buss_hrs WHERE restaurant_id = '".$_REQUEST['hid']."' AND days_id = '1'");
	$k_sat = 1;
	...
	$sql_sun_bussiness_hrs = mysql_query("SELECT * FROM restaurant_buss_hrs WHERE restaurant_id = '".$_REQUEST['hid']."' AND days_id = '1'");
	$k_sun = 1;
	...
	foreach($_POST['countdiv_tuesday'] as $countdiv_tuesday){
		...
		if($bus_hrs_tue_from!='' && $bus_hrs_tue_to!=''){
			$sql_bus_hrs_tuesday = "INSERT INTO restaurant_buss_hrs SET restaurant_id='".$_REQUEST['restaurant_edit_id']."', days_id='1', time_from='".$bus_hrs_tue_from."' , time_to = '".$bus_hrs_tue_to."' ";
	...
	foreach($_POST['countdiv_wednesday'] as $countdiv_wednesday){
		...
		if($bus_hrs_wed_from!='' && $bus_hrs_wed_to!=''){
			$sql_bus_hrs_wednesday = "INSERT INTO restaurant_buss_hrs SET restaurant_id='".$_REQUEST['restaurant_edit_id']."', days_id='1', time_from='".$bus_hrs_wed_from."' , time_to = '".$bus_hrs_wed_to."' ";
	...
	foreach($_POST['countdiv_thursday'] as $countdiv_thursday){
		...
		if($bus_hrs_thu_from!='' && $bus_hrs_thu_to!=''){
			$sql_bus_hrs_thursday = "INSERT INTO restaurant_buss_hrs SET restaurant_id='".$_REQUEST['restaurant_edit_id']."', days_id='1', time_from='".$bus_hrs_thu_from."' , time_to = '".$bus_hrs_thu_to."' ";
	...
	foreach($_POST['countdiv_friday'] as $countdiv_friday){
		...
		if($bus_hrs_fri_from!='' && $bus_hrs_fri_to!=''){
			$sql_bus_hrs_friday = "INSERT INTO restaurant_buss_hrs SET restaurant_id='".$_REQUEST['restaurant_edit_id']."', days_id='1', time_from='".$bus_hrs_fri_from."' , time_to = '".$bus_hrs_fri_to."' ";
	...
	foreach($_POST['countdiv_saturday'] as $countdiv_saturday){
		...
		if($bus_hrs_sat_from!='' && $bus_hrs_sat_to!=''){
			$sql_bus_hrs_saturday = "INSERT INTO restaurant_buss_hrs SET restaurant_id='".$_REQUEST['restaurant_edit_id']."', days_id='1', time_from='".$bus_hrs_sat_from."' , time_to = '".$bus_hrs_sat_to."' ";
	...
	foreach($_POST['countdiv_sunday'] as $countdiv_sunday){
		...
		if($bus_hrs_sun_from!='' && $bus_hrs_sun_to!=''){
			$sql_bus_hrs_sunday = "INSERT INTO restaurant_buss_hrs SET restaurant_id='".$_REQUEST['restaurant_edit_id']."', days_id='1', time_from='".$bus_hrs_sun_from."' , time_to = '".$bus_hrs_sun_to."' ";
	...
	header("location:edit_additional_new.php?restaurant_edit_id=".$_REQUEST['hid']."&success=2");		
}
?>
<script type="text/javascript">
function getkey(e)
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="edit_additional_new.php?restaurant_edit_id=<?php echo $_REQUEST['restaurant_edit_id'];?>&delete_mon_buss_hrs=<?php echo $array_monday_buss_hrs['id'];?>">
...
$id_tue = 1;
while($array_tuesday_buss_hrs = mysql_fetch_array($array_tuesday_buss_hrs)){ ?>
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="edit_additional_new.php?restaurant_edit_id=<?php echo $_REQUEST['restaurant_edit_id'];?>&delete_tue_buss_hrs=<?php echo $array_tuesday_buss_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="edit_additional_new.php?restaurant_edit_id=<?php echo $_REQUEST['restaurant_edit_id'];?>&delete_wed_buss_hrs=<?php echo $array_wednesday_buss_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="edit_additional_new.php?restaurant_edit_id=<?php echo $_REQUEST['restaurant_edit_id'];?>&delete_thu_buss_hrs=<?php echo $array_thursday_buss_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="edit_additional_new.php?restaurant_edit_id=<?php echo $_REQUEST['restaurant_edit_id'];?>&delete_fri_buss_hrs=<?php echo $array_friday_buss_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
$id_sat = 1;
while($array_saturday_buss_hrs = mysql_fetch_array($sql_monaday_buss_hrs)){ ?>
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="edit_additional_new.php?restaurant_edit_id=<?php echo $_REQUEST['restaurant_edit_id'];?>&delete_sat_buss_hrs=<?php echo $array_saturday_buss_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
$id_sun = 1;
while($array_sunday_buss_hrs = mysql_fetch_array($sql_monaday_buss_hrs)){ ?>
<div class="cross_bt" style="margin-left:394px;margin-top:11px;"><a href="edit_additional_new.php?restaurant_edit_id=<?php echo $_REQUEST['restaurant_edit_id'];?>&delete_sun_buss_hrs=<?php echo $array_sunday_buss_hrs['id'];?>">
<img  src="images/Close_Box_Red.png">
</a></div>
...
<script type="text/javascript">
function check_holiday_from(val)
{
	var holiday_to_value = Converttimeformat($("#holidays").val());
	var value = Converttimeformat(val);
	
	if(holiday_to_value != "")
	{
		if(value > holiday_to_value)
		{
			alert("From time cannot be greater than To time.");
			$("#holidays_from").val('');
		}
...
function check_holiday_to(val)
{
	var holiday_from_value = Converttimeformat($("#holidays_from").val());
	var value = Converttimeformat(val);
	
	if(holiday_from_value != "")
	{
		if(value < holiday_from_value)
		{
			alert("To time cannot be less than From time.");
			$("#holidays").val('');
		}
...
<input name="delivery_from_monday" id="delivery_from_monday" type="text" class="restaurant time_pick" value="<?php echo $sql_sel_del_hrs['delivery_from_monday']; ?>" style="width:93px;" onBlur="check_del_mon_from(this.value);"  />
<span style="color:#888888;">to</span>
<input name="delivery_to_monday" id="delivery_to_monday" type="text" class="restaurant time_pick" value="<?php echo $sql_sel_del_hrs['delivery_to_monday']; ?>" style="width:93px;" onBlur="check_del_mon_to(this.value);" />
<div class="clear"></div>

<script type="text/javascript">
function check_del_mon_from(val)
{
	var mon_to_value = Converttimeformat($("#delivery_to_monday").val());
	var value = Converttimeformat(val);
	
	if(mon_to_value != "")
	{
		if(value > mon_to_value)
		{
			alert("From time cannot be greater than To time.");
			$("#delivery_from_monday").val('');
		}
	}
}

function check_del_mon_to(val)
{
	var mon_from_value = Converttimeformat($("#delivery_from_monday").val());
	var value = Converttimeformat(val);
	
	if(mon_from_value != "")
	{
		if(value < mon_from_value)
		{
			alert("To time cannot be less than From time.");
			$("#delivery_to_monday").val('');
		}
	}
}
...
<input name="delivery_from_tuesday" id="delivery_from_tuesday" type="text" class="restaurant time_pick" value="<?php echo $sql_sel_del_hrs['delivery_from_tuesday']; ?>" style="width:93px;" onBlur="check_del_tue_from(this.value);" />
<span style="color:#888888;">to</span>
<input name="delivery_to_tuesday" id="delivery_to_tuesday" type="text" class="restaurant time_pick" value="<?php echo $sql_sel_del_hrs['delivery_to_tuesday']; ?>" style="width:93px;" onBlur="check_del_tue_to(this.value);" />
<div class="clear"></div>

<script type="text/javascript">
function check_del_tue_from(val)
{
	var tue_to_value = Converttimeformat($("#delivery_to_tuesday").val());
	var value = Converttimeformat(val);
	
	if(tue_to_value != "")
	{
		if(value > tue_to_value)
		{
			alert("From time cannot be greater than To time.");
			$("#delivery_from_tuesday").val('');
		}
	}
}

function check_del_tue_to(val)
{
	var tue_from_value = Converttimeformat($("#delivery_from_tuesday").val());
	var value = Converttimeformat(val);
	
	if(tue_from_value != "")
	{
		if(value < tue_from_value)
		{
			alert("To time cannot be less than From time.");
			$("#delivery_to_tuesday").val('');
		}
	}
}
...
<input name="delivery_from_wednesday" id="delivery_from_wednesday" type="text" class="restaurant time_pick" value="<?php echo $sql_sel_del_hrs['delivery_from_wednesday']; ?>" style="width:93px;" onBlur="check_del_wed_from(this.value);" />
<span style="color:#888888;">to</span>
<input name="delivery_to_wednesday" id="delivery_to_wednesday" type="text" class="restaurant time_pick" value="<?php echo $sql_sel_del_hrs['delivery_to_wednesday']; ?>" style="width:93px;" onBlur="check_del_wed_to(this.value);" />
<div class="clear"></div>

<script type="text/javascript">
function check_del_wed_from(val)
{
	var wed_to_value = Converttimeformat($("#delivery_to_wednesday").val());
	var value = Converttimeformat(val);
	
	if(wed_to_value != "")
	{
		if(value > wed_to_value)
		{
			alert("From time cannot be greater than To time.");
			$("#delivery_from_wednesday").val('');
		}
	}
}

function check_del_wed_to(val)
{
	var wed_from_value = Converttimeformat($("#delivery_from_wednesday").val());
	var value = Converttimeformat(val);
	
	if(wed_from_value != "")
	{
		if(value < wed_from_value)
		{
			alert("To time cannot be less than From time.");
			$("#delivery_to_wednesday").val('');
		}
	}
}
...
<input name="delivery_from_thursday" id="delivery_from_thursday" type="text" class="restaurant time_pick" value="<?php echo $sql_sel_del_hrs['delivery_from_thursday']; ?>" style="width:93px;" onBlur="check_del_thu_from(this.value);" />
<span style="color:#888888;">to</span>
<input name="delivery_to_thursday" id="delivery_to_thursday" type="text" class="restaurant time_pick" value="<?php echo $sql_sel_del_hrs['delivery_to_thursday']; ?>" style="width:93px;" onBlur="check_del_thu_to(this.value);" />
<div class="clear"></div>

<script type="text/javascript">
function check_del_thu_from(val)
{
	var thu_to_value = Converttimeformat($("#delivery_to_thursday").val());
	var value = Converttimeformat(val);
	
	if(thu_to_value != "")
	{
		if(value > thu_to_value)
		{
			alert("From time cannot be greater than To time.");
			$("#delivery_from_thursday").val('');
		}
	}
}

function check_del_thu_to(val)
{
	var thu_from_value = Converttimeformat($("#delivery_from_thursday").val());
	var value = Converttimeformat(val);
	
	if(thu_from_value != "")
	{
		if(value < thu_from_value)
		{
			alert("To time cannot be less than From time.");
			$("#delivery_to_thursday").val('');
		}
	}
}
...
<input name="delivery_from_friday" id="delivery_from_friday" type="text" class="restaurant time_pick" value="<?php echo $sql_sel_del_hrs['delivery_from_friday']; ?>" style="width:93px;" onBlur="check_del_fri_from(this.value);" />
<span style="color:#888888;">to</span>
<input name="delivery_to_friday" id="delivery_to_friday" type="text" class="restaurant time_pick" value="<?php echo $sql_sel_del_hrs['delivery_to_friday']; ?>" style="width:93px;" onBlur="check_del_fri_to(this.value);" />
<div class="clear"></div>

<script type="text/javascript">
function check_del_fri_from(val)
{
	var fri_to_value = Converttimeformat($("#delivery_to_friday").val());
	var value = Converttimeformat(val);
	
	if(fri_to_value != "")
	{
		if(value > fri_to_value)
		{
			alert("From time cannot be greater than To time.");
			$("#delivery_from_friday").val('');
		}
	}
}

function check_del_fri_to(val)
{
	var fri_from_value = Converttimeformat($("#delivery_from_friday").val());
	var value = Converttimeformat(val);
	
	if(fri_from_value != "")
	{
		if(value < fri_from_value)
		{
			alert("To time cannot be less than From time.");
			$("#delivery_to_friday").val('');
		}
	}
}
...
<input name="delivery_from_saturday" id="delivery_from_saturday" type="text" class="restaurant time_pick" value="<?php echo $sql_sel_del_hrs['delivery_from_saturday']; ?>" style="width:93px;" onBlur="check_del_sat_from(this.value);" />
<span style="color:#888888;">to</span>
<input name="delivery_to_saturday" id="delivery_to_saturday" type="text" class="restaurant time_pick" value="<?php echo $sql_sel_del_hrs['delivery_to_saturday']; ?>" style="width:93px;" onBlur="check_del_sat_to(this.value);" />
<div class="clear"></div>

<script type="text/javascript">
function check_del_sat_from(val)
{
	var sat_to_value = Converttimeformat($("#delivery_to_saturday").val());
	var value = Converttimeformat(val);
	
	if(sat_to_value != "")
	{
		if(value > sat_to_value)
		{
			alert("From time cannot be greater than To time.");
			$("#delivery_from_saturday").val('');
		}
	}
}

function check_del_sat_to(val)
{
	var sat_from_value = Converttimeformat($("#delivery_from_saturday").val());
	var value = Converttimeformat(val);
	
	if(sat_from_value != "")
	{
		if(value < sat_from_value)
		{
			alert("To time cannot be less than From time.");
			$("#delivery_to_saturday").val('');
		}
	}
}
...
<input name="delivery_from_sunday" id="delivery_from_sunday" type="text" class="restaurant time_pick" value="<?php echo $sql_sel_del_hrs['delivery_from_sunday']; ?>" style="width:93px;" onBlur="check_del_sun_from(this.value);" />
<span style="color:#888888;">to</span>
<input name="delivery_to_sunday" id="delivery_to_sunday" type="text" class="restaurant time_pick" value="<?php echo $sql_sel_del_hrs['delivery_to_sunday']; ?>" style="width:93px;" onBlur="check_del_sun_to(this.value);" />
<div class="clear"></div>

<script type="text/javascript">
function check_del_sun_from(val)
{
	var sun_to_value = Converttimeformat($("#delivery_to_sunday").val());
	var value = Converttimeformat(val);
	
	if(sun_to_value != "")
	{
		if(value > sun_to_value)
		{
			alert("From time cannot be greater than To time.");
			$("#delivery_from_sunday").val('');
		}
	}
}
...
function check_del_sat_to(val)
{
	var sun_from_value = Converttimeformat($("#delivery_from_sunday").val());
	var value = Converttimeformat(val);
	
	if(sun_from_value != "")
	{
		if(value < sun_from_value)
		{
			alert("To time cannot be less than From time.");
			$("#delivery_to_sunday").val('');
		}
	}
}
...
<p>Pick Up Hours (Monday):</p>
<input name="from_time_monday" id="from_time_monday" type="text" class="restaurant time_pick" value="<?php echo $sql_sel_pickup_hrs['from_time_monday']; ?>" style="width:93px;" onBlur="check_pick_mon_from(this.value);"  />
<span style="color:#888888;">to</span>
<input name="to_time_monday" id="to_time_monday" type="text" class="restaurant time_pick" value="<?php echo $sql_sel_pickup_hrs['to_time_monday']; ?>" style="width:93px;" onBlur="check_pick_mon_to(this.value);" />
<div class="clear"></div>

<script type="text/javascript">
function check_pick_mon_from(val)
{
	var mon_to_value = Converttimeformat($("#to_time_monday").val());
	var value = Converttimeformat(val);
	...
	if(mon_to_value != "")
	{
		...
		{
			alert("From time cannot be greater than To time.");
			$("#from_time_monday").val('');
		}
	}
}

function check_pick_mon_to(val)
{
	var mon_from_value = Converttimeformat($("#from_time_monday").val());
	var value = Converttimeformat(val);
...
<p>Pick Up Hours (Tuesday):</p>
<input name="from_time_tuesday" id="from_time_tuesday" type="text" class="restaurant time_pick" value="<?php echo $sql_sel_pickup_hrs['from_time_tuesday']; ?>" style="width:93px;" onBlur="check_pick_tue_from(this.value);" />
<span style="color:#888888;">to</span>
<input name="to_time_tuesday" id="to_time_tuesday" type="text" class="restaurant time_pick" value="<?php echo $sql_sel_pickup_hrs['to_time_tuesday']; ?>" style="width:93px;" onBlur="check_pick_tue_to(this.value);" />
<div class="clear"></div>

<script type="text/javascript">
function check_pick_tue_from(val)
{
	var tue_to_value = Converttimeformat($("#to_time_tuesday").val());
	var value = Converttimeformat(val);
...
function check_pick_tue_to(val)
{
	var tue_from_value = Converttimeformat($("#from_time_tuesday").val());
	var value = Converttimeformat(val);
...
<p>Pick Up Hours (Wednesday):</p>
<input name="from_time_wednesday" id="from_time_wednesday" type="text" class="restaurant time_pick" value="<?php echo $sql_sel_pickup_hrs['from_time_wednesday']; ?>" style="width:93px;" onBlur="check_pick_wed_from(this.value);" />
<span style="color:#888888;">to</span>
<input name="to_time_wednesday" id="to_time_wednesday" type="text" class="restaurant time_pick" value="<?php echo $sql_sel_pickup_hrs['to_time_wednesday']; ?>" style="width:93px;" onBlur="check_pick_wed_to(this.value);" />
<div class="clear"></div>

<script type="text/javascript">
function check_pick_wed_from(val)
{
	var wed_to_value = Converttimeformat($("#to_time_wednesday").val());
	var value = Converttimeformat(val);
...
function check_pick_wed_to(val)
{
	var wed_from_value = Converttimeformat($("#from_time_wednesday").val());
	var value = Converttimeformat(val);
...
<p>Pick Up Hours (Thursday):</p>
<input name="from_time_thursday" id="from_time_thursday" type="text" class="restaurant time_pick" value="<?php echo $sql_sel_pickup_hrs['from_time_thursday']; ?>" style="width:93px;" onBlur="check_pick_thu_from(this.value);" />
<span style="color:#888888;">to</span>
<input name="to_time_thursday" id="to_time_thursday" type="text" class="restaurant time_pick" value="<?php echo $sql_sel_pickup_hrs['to_time_thursday']; ?>" style="width:93px;" onBlur="check_pick_thu_to(this.value);" />
<div class="clear"></div>

<script type="text/javascript">
function check_pick_thu_from(val)
{
	var thu_to_value = Converttimeformat($("#to_time_thursday").val());
	var value = Converttimeformat(val);
...
function check_pick_thu_to(val)
{
	var thu_from_value = Converttimeformat($("#to_time_thursday").val());
	var value = Converttimeformat(val);
...
<p>Pick Up Hours (Friday):</p>
<input name="from_time_friday" id="from_time_friday" type="text" class="restaurant time_pick" value="<?php echo $sql_sel_pickup_hrs['from_time_friday']; ?>" style="width:93px;" onBlur="check_pick_fri_from(this.value);" />
<span style="color:#888888;">to</span>
<input name="to_time_friday" id="to_time_friday" type="text" class="restaurant time_pick" value="<?php echo $sql_sel_pickup_hrs['to_time_friday']; ?>" style="width:93px;" onBlur="check_pick_fri_to(this.value);" />
<div class="clear"></div>

<script type="text/javascript">
function check_pick_fri_from(val)
{
	var fri_to_value = Converttimeformat($("#to_time_friday").val());
	var value = Converttimeformat(val);
...
function check_pick_fri_to(val)
{
	var fri_from_value = Converttimeformat($("#from_time_friday").val());
	var value = Converttimeformat(val);
...
<p>Pick Up Hours (Saturday):</p>
<input name="from_time_saturday" id="from_time_saturday" type="text" class="restaurant time_pick" value="<?php echo $sql_sel_pickup_hrs['from_time_saturday']; ?>" style="width:93px;" onBlur="check_pick_sat_from(this.value);" />
<span style="color:#888888;">to</span>
<input name="to_time_saturday" id="to_time_saturday" type="text" class="restaurant time_pick" value="<?php echo $sql_sel_pickup_hrs['to_time_saturday']; ?>" style="width:93px;" onBlur="check_pick_sat_to(this.value);" />
<div class="clear"></div>

<script type="text/javascript">
function check_pick_sat_from(val)
{
	var sat_to_value = Converttimeformat($("#to_time_saturday").val());
	var value = Converttimeformat(val);
...
function check_pick_sat_to(val)
{
	var sat_from_value = Converttimeformat($("#from_time_saturday").val());
	var value = Converttimeformat(val);
...
<p>Pick Up Hours (Sunday):</p>
<input name="from_time_sunday" id="from_time_sunday" type="text" class="restaurant time_pick" value="<?php echo $sql_sel_pickup_hrs['from_time_sunday']; ?>" style="width:93px;" onBlur="check_pick_sun_from(this.value);" />
<span style="color:#888888;">to</span>
<input name="to_time_sunday" id="to_time_sunday" type="text" class="restaurant time_pick" value="<?php echo $sql_sel_pickup_hrs['to_time_sunday']; ?>" style="width:93px;" onBlur="check_pick_sun_to(this.value);" />
<div class="clear"></div>

<script type="text/javascript">
function check_pick_sun_from(val)
{
	var sun_to_value = Converttimeformat($("#to_time_sunday").val());
	var value = Converttimeformat(val);
...
function check_pick_sat_to(val)
{
	var sun_from_value = Converttimeformat($("#from_time_sunday").val());
	var value = Converttimeformat(val);
