...
<script type="text/javascript">
        ...
        {
            $j('html, body').animate({ scrollTop: $j('#accor_subcat' + id).offset().top - 150 }, '100');
            //$j('').slideDown();
        }
    </script>
<div id="fade"></div>
          ...
          <div class="accr_details">
            ...
            <div id="sidebox">
              ...
              <ul class="side_menus">
                ...
                <?php } ?>
                <li><a title="<?php echo $array_menu_catyegory1['category_name']; ?>" href="restaurant.php?id=<?php echo $_REQUEST['id']; ?>&c_id=<?php echo $array_menu_catyegory1['id']; ?>#tab"><?php echo $array_menu_catyegory1['category_name']; ?></a></li>
              </ul>
              <div class="clear"></div>
              <div>
                    ...
                    <?php
                                                ...
                                                while ($array_menu_sub_category1 = mysql_fetch_array($sql_menu_subcategory1)) {
                                                    if ($array_menu_sub_category1['subcategory_name'] != '') {
                                                        ?>
                    <li><a ua-action="Menu Sections"  title="<?php echo $array_menu_sub_category1['subcategory_name']; ?>" href="javascript:void(0);"  ><?php echo $array_menu_sub_category1['subcategory_name']; ?> </a></li>
                    <?php
                                                        }
                                                    }
                                                    ?>
...
?>
  ...
  <?php echo $sql_restaurant['restaurant_city'];?>&nbsp;&nbsp;<?php echo $sql_restaurant['restaurant_state'];?>&nbsp;&nbsp;<?php echo $sql_restaurant['restaurant_zipcode'];?></span>
    ...
    if (mysql_num_rows($sql_items) > 0) {
        ?>
            <div class="rstrnt_right_panel rstrnt_right_panel_new ur-order" style="display:<?php echo $display1; ?>; margin-top:10px;">
              ...
              <div class="cost_summary" id="totalblock">
                <div class="f_clear">
                  ...
                  <div class="pick_delvry_right">
                    ...
                    DELIVERY <img src="images/delivery.png"> </div>
                  <div class="clear"></div>
                </div>
