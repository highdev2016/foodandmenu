							...
							<div class="follow-section">
								<ul>
                                    ...
                                    <?php
										...
										{
										?>
                                        	<a href='javascript:void(0);' class='follow-btn' style='cursor:default; margin: 5px -5px 0; width: 91px;' ><img src='images/follower.png' align='absmiddle'  /> Request Sent</a>
                                        <?php
										}
									...
									<div class="restu-block">
                                        ...
                                        <?php while($row_updated_review = mysql_fetch_array($sql_updated_review))
                                          ...
                                          <ul>
		                                    ...
		                                    <span class="like_text" id="like_count_<?php echo $row_updated_review['id']; ?>"><?php echo get_like_unlike_count_on_review($row['id'], 'like'); ?></span><img src="images/like_select.png" width="16" height="16" />
		                                    <?php } else { ?>
		                                    <span class="like_text" id="like_count_<?php echo $row_updated_review['id']; ?>"><?php echo get_like_unlike_count_on_review($row_updated_review['id'], 'like'); ?></span><a href="like" id="do_like_<?php echo $row['id']; ?>" class="like" review="<?php echo $row_updated_review['id']; ?>" cid="<?php echo $_SESSION['customer_id']; ?>"><img src="images/like.png" width="16" height="16" /></a>
											<?php } ?>
		                                    </li>
		                                    ...
		                                    <?php } else { ?>
		                                    <!--<li><a href="#"></a></li>-->
		                                    <li id="li_like_<?php echo $row_updated_review['id']; ?>"><span class="like_text" id="like_count_<?php echo $row['id']; ?>"><?php echo get_like_unlike_count_on_review($row_updated_review['id'], 'like'); ?></span><a href="like" onClick="like_unlike_alert('Please Login First to Like this'); return false;"><img src="images/like_select.png" width="16" height="16" /></a></li>
		                                    ...
		                                    <?php } ?>
                                    			...
                                    			<?php if(isset($_SESSION['customer_id'])){?><a target="_blank" href="http://www.facebook.com/share.php?u=http://foodandmenu.com/restaurant.php?id=<?php echo $row_updated_review['restaurant_id']; ?>">Share with facebook</a><?php }else{ ?><a href="login.php">Share with facebook</a><?php } ?>
                                                </div>
                                       ...
                                       <?php } ?>
                                          ...
                                          <ul>
                                    		...
                                    		<?php if(isset($_SESSION['customer_id'])){?><a target="_blank" href="http://www.facebook.com/share.php?u=http://foodandmenu.com/restaurant.php?id=<?php echo $row['restaurant_id']; ?>">Share with facebook</a><?php }else{ ?><a href="login.php">Share with facebook</a><?php } ?>
                                            </div>
