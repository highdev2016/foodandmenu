...
if($_REQUEST['sub'] == 'sub'){
	...
	if($_SESSION['coupon_code']!=''){
		...
		$sql_sel_coupon = mysql_fetch_array(mysql_query("SELECT * FROM restaurant_coupon WHERE coupon_code = '".$_SESSION['coupon_code']."' AND restaurant_id = '".$_REQUEST['id']."'"));
		$_SESSION['coupon_discount'] = ($sql_sel_coupon['discount']*$cart_amt)/100;
	}
