...
<table width="970" border="1" cellspacing="0" bordercolor="d6d6d6" cellpadding="0" style="border-collapse:collapse;">
  <?php 
  ...
  <tr>
    <td class="cart_table_text">Deal Name</td>
    <td class="cart_table_text">Deal Price($)</td>
    <td class="cart_table_text">Deal Quantity</td>
    <td class="cart_table_text">Deal Photo</td>
    <td class="cart_table_text">Total Price</td>
    <td class="cart_table_text">Option</td>
  </tr>
  <?php
  	/*$max=count($_SESSION['cart']);
	for($i=0;$i<$max;$i++){
