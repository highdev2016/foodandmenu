...
<table width="100%" class="my_report_table"><tr>
...
<td width="10%"><p style="margin-top:12px;">Start date :</p></td>
<td width="17%"><input type="text" name="start_date" id="start_date" value="<?php echo $_REQUEST['start_date'];?>" class="restaurant" autocomplete="off" style="width:180px;"></td>
<td width="10%"><p style="margin-top:12px;">End date :</p></td>
<td width="17%"><input type="text" name="end_date" id="end_date" value="<?php echo $_REQUEST['end_date'];?>" class="restaurant" autocomplete="off" style="width:180px;"></td>
<td width="46%">
<input type="submit" name="submit1" value="Search" class="button4">
...
<a href="export_reports_pdf.php" title="Export to Pdf" target="_blank" style="text-decoration:none;"><input type="button" name="export_pdf" value="Export to Pdf" class="button4" style="margin:0px;"/></a></td>
</tr>
</table>

<div style="padding-bottom:20px;">
<div class="report_head" style="float:left;">
