<?php
  ob_start();
	...
	$sql_team_order=sprintf("SELECT show_order,id FROM restaurant_menu_category WHERE show_order>'%s' AND restaurant_id = '".$res_id."' order by show_order asc limit 0,1",$order);
