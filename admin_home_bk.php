          ...
          <form name="frm" method="post" action="admin_home.php">
            <table>
              ...
              <td width="146">Date : </td>
                ...
                <td width="128">Order Number : </td>
                <td width="184"><input type="text" name="order_id" value="<?php echo $_REQUEST['order_id'];?>" style="height:23px;  width: 168px;" class="restaurant"></td>                
               </tr>
               
               <tr>
               		<td width="146">Confirmation Code : </td>
                <td width="184"><input type="text" name="confirmation_code" value="<?php echo $_REQUEST['confirmation_code'];?>" style="height:23px;  width: 168px;" class="restaurant"></td>
               </tr>
               
              <tr>
                <td colspan="5">&nbsp;</td>
                <td class="srcpnl-"><input type="submit" name="submit" value="Search" class="button4" style="margin:0px;">
                  <a href="admin_home.php" class="button4" style="margin:0px; text-decoration:none; padding:6px 13px;" >Show All</a></td>
                  </tr>
            </table>
          </form>
