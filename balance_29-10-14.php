...
function sort_function(sort_by,submit1,start_date,end_date){
	location.href = 'balance_16_10.php?sort_order='+sort_by+'&submit='+submit1+'&start_date='+start_date+'&end_date='+end_date;
}
</script>
            ...
            <table class="sec-pnl-top" width="100%">
              <tr>
               <td>
               	...
               	<td>Start Date : </td>
                <td>
                <input type="text" name="start_date" id="start_date" class="restaurant" style="width: 133px ! important; text-align: left;" value="<?php echo $_REQUEST['start_date']; ?>" autocomplete="off">
                </td>
                <td>End Date : </td>
                <td id="cust_date_td">
                <input type="text" name="end_date" id="end_date" class="restaurant" style="width: 133px ! important; text-align: left;" value="<?php echo $sr_end_dt; ?>" autocomplete="off">
                </td>
                ...
                <td>
					...
					{
					?>
					<a href="javascript:void(0);" class="check_order_button" style="text-decoration: none; padding: 7px 7px; float: none; margin: 0px; font-size: 13.3px;" id="print_but" >Print</a>
					<?php
					}
					?>
                </td>
