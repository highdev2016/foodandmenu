					...
					<div style="width: 24%; float: right;">
                            ...
                            <div class="search_main_map" id="navigation" style="margin-top:52px;">
                                <div class="search_main_map_inner">
                                    ...
                                    <div id="mapcanvas_dds" style="width: 100%; height: 400px;"></div>
 <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA8RPY5KpkdAp85-FSYrukKzHEO_LtgIUk&libraries=places&callback=initAutocomplete"
         async defer></script>
									...
									<script>
									 var $j = jQuery.noConflict();
                                        ...
                                        function initialize() {
                                            ...
                                            var map = new google.maps.Map(document.getElementById('mapcanvas_dds),
                                                    mapOptions);
