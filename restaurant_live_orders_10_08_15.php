...
<table class="sec-pnl-top" width="100%">
	<tr>
		...
		<td width="17%" class="all_restaurant">Customer Name : </td>
		<td width="16%"><input type="text" name="customer_name" value="<?php echo $_REQUEST['customer_name'];?>" style="height:23px;" class="restaurant"></td>
		<td width="15%" class="all_restaurant">Customer Phone : </td>
		<td width="17%"><input type="text" name="customer_phone" value="<?php echo $_REQUEST['customer_phone'];?>" style="height:23px;" class="restaurant"></td>
