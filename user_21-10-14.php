...
function sort_date(user_id)
{
	...
	$.ajax({
			...
			success : function(data, textStatus, jqXHR){
				...
				setTimeout(function(){$("#loader_div").hide()}, 5000);
				//$("#loader_div").hide();
...
type: "POST",
url: "ajax_user.php",
data: "lastmsg="+ ID + "&cust_id=" + cust_id + "&new_count=" + hid_count + '&sort_type=' + sort_type,
cache: false,
...
$follower_count = mysql_num_rows(mysql_query("SELECT id FROM user_follow WHERE follower_id = '".$customer_id."' "));

$following_count = mysql_num_rows(mysql_query("SELECT id FROM user_follow WHERE following_id = '".$customer_id."' "));

$check_follow_status = mysql_num_rows(mysql_query("SELECT id FROM user_follow WHERE following_id = '".$customer_id."' AND follower_id = '".$_SESSION['customer_id']."' "));

$favourite_count = mysql_num_rows(mysql_query("SELECT id FROM restaurant_favourite WHERE user_id = '".$customer_id."' "));

$all_follower = mysql_query("SELECT * FROM user_follow WHERE follower_id = '".$customer_id."' ");

$all_following = mysql_query("SELECT * FROM user_follow WHERE following_id = '".$customer_id."' ");
					...
					<div class="user-profile-section">
							...
							<div class="follow-section">
								<ul>
                                    ...
                                    <?php while($row_all_following = mysql_fetch_array($all_following)) { 
										...
										echo "<a href='user.php?id=".$row_all_following['follower_id']."' style='color:#4E7AD5'>".getNameTable("restaurant_customer","firstname","id",$row_all_following['follower_id'])." ".getNameTable("restaurant_customer","lastname","id",$row_all_following['follower_id'])."</a><br>";
                                    ...
                                    <?php while($row_all_follower = mysql_fetch_array($all_follower)) { 
										...
										echo "<a href='user.php?id=".$row_all_follower['following_id']."' style='color:#4E7AD5'>".getNameTable("restaurant_customer","firstname","id",$row_all_follower['following_id'])." ".getNameTable("restaurant_customer","lastname","id",$row_all_following['following_id'])."</a><br>";
                                    ...
                                    <?php while($row_all_favourite = mysql_fetch_array($all_favourite)) { 
										...
										echo "<a href='restaurant.php?id=".$row_all_favourite['restaurant_id']."' style='color:#4E7AD5'>".getNameTable("restaurant_basic_info","restaurant_name","id",$row_all_favourite['restaurant_id'])."</a><br>";
						...
						<div class="user-cont">
							...
							<div class="user-cont-right">
                                ...
                                <div id="main_res_div">
                                <div id="loader_div" style="display:none;"><img src="images/loader_gif.gif"></div>
                                <!-- Start restu-block -->
