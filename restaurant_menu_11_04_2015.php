...
function sort_function(sort_by){
	location.href = 'restaurant_menu.php?sort_order='+sort_by;
}
</script>
...
<textarea name="menu_description1" id="menu_description1" style="margin-top:10px; border:1px solid #B5ABC6; " rows="3" cols="25" ></textarea>
...
$sql_select = "SELECT * FROM restaurant_menu_item WHERE restaurant_id='".$restaurant_id."'";
