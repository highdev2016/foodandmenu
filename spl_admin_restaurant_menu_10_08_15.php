        ...
        if($subcat_num_rows_new > 0)
		{
			...
			?>
                ...
                <td>
					...
					<input type="text" name="menu_item_name[]" id="menu_item_name" class="restaurant" value="<?php echo $row_item['menu_name']; ?>" ><br>
                    <input type="checkbox" name="whats_good_<?php echo $row_item['id']."_".$item_inc; ?>" id="whats_good_<?php echo $row_item['id']."_".$item_inc; ?>" value="1" <?php if($row_item['whats_good'] == '1'){?> checked="checked" <?php } ?>> What's Good
                </td>
                <td>
					<input type="text" name="menu_item_price[]" id="menu_item_price" class="restaurant menu_item_rest" value="<?php echo $row_item['price']; ?>" ><br>
                    <input type="checkbox" name="spicy_<?php echo $row_item['id']."_".$item_inc; ?>" id="spicy_<?php echo $row_item['id']."_".$item_inc; ?>" value="1" <?php if($row_item['spicy'] == '1'){?> checked="checked" <?php } ?>> Spicy
                </td>
                <td>
					<input type="text" name="menu_item_description[]" id="menu_item_description" class="restaurant menu_item_desc" value="<?php echo $row_item['description']; ?>" ><br>
                    <input type="checkbox" name="veggie_<?php echo $row_item['id']."_".$item_inc; ?>" id="veggie_<?php echo $row_item['id']."_".$item_inc; ?>" value="1" <?php if($row_item['veggie'] == '1'){?> checked="checked" <?php } ?>> Veggie
                </td>
                <td>
                	<?php if($row_item['menu_pic'] != '') { ?>
					<img src="uploaded_images/<?php echo $row_item['menu_pic']; ?>" width="50">
					<?php } ?>
					<input type="file" name="menu_itemwise_picture<?php echo $row_item['id']; ?>" id="menu_item_picture" class="restaurant_browse" ><br>
                    <input type="checkbox" name="healthy_<?php echo $row_item['id']."_".$item_inc; ?>" id="healthy_<?php echo $row_item['id']."_".$item_inc; ?>" value="1" <?php if($row_item['healthy'] == '1'){?> checked="checked" <?php } ?>> Healthy
                </td>
