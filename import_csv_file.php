...
{	
	...
	$sql_get_duplicate = mysql_num_rows(mysql_query("SELECT * FROM restaurant_basic_info WHERE restaurant_name = '".addslashes(trim($arr_elements[5]))."' AND restaurant_address = '".addslashes(trim($arr_elements[6]))."' AND restaurant_city = '".addslashes(trim($arr_elements[7]))."' AND restaurant_state = '".addslashes(trim($arr_elements[8]))."' AND restaurant_zipcode = '".$arr_elements[9]."' "));
	...
	$sql = ("INSERT INTO  restaurant_basic_info SET  user_id = '1',name='".addslashes(trim($arr_elements[0]))."',phone='".$arr_elements[1]."',fax='".$arr_elements[2]."',email='".$arr_elements[3]."',website='".$arr_elements[4]."',restaurant_name='".addslashes(trim($arr_elements[5]))."',restaurant_address='".addslashes(trim($arr_elements[6]))."',restaurant_city='".addslashes(trim($arr_elements[7]))."',restaurant_state='".addslashes(trim($arr_elements[8]))."',restaurant_zipcode='".$arr_elements[9]."',restaurant_country='".addslashes(trim($arr_elements[10]))."',status = 1, featured_status = 1,  show_order ='".($sql_show_order['show_order']+1)."' ,latitude = '".$latlng->lat."' , longitude = '".$latlng->lng."' ");
