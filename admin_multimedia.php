...
<div class="restaurant_nav">
                    ...
                    <li><a href="admin_multimedia.php"  class="active7">Multimedia</a></li>
...
<table width="100%" border="1" bordercolor="c5c8d5" cellspacing="0" cellpadding="0" style="border-collapse:collapse; margin-top:10px;" align="center">
  ...
  <td align="center"><input type="checkbox" name="check_box[]" value="<?php echo $array_deals['id']; ?>"  /></td>
    ...
    <td class="all_restaurant2"><a href="edit_image1_admin.php?image_id=<?php echo $array_deals['id']?>" class="all_edit" onClick="return confirm('Are you sure you want to delete this image?');">Edit</a>&nbsp;<a href="admin_multimedia.php?action=del&del_image_id=<?php echo $array_deals['id']?>" class="all_edit" onClick="return confirm('Are you sure you want to delete this image?');">Delete</a></td>
  </tr>
<?php } ?>
</table></div>
<?php
...
<table width="100%" border="1" bordercolor="c5c8d5" cellspacing="0" cellpadding="0" style="border-collapse:collapse; margin-top:10px;" align="center">
  ...
  <tr>
    ...
    <td class="all_restaurant2"><a href="edit_video1_admin.php?video_id=<?php echo $array_deals['id']?>" class="all_edit" onClick="return confirm('Are you sure you want to edit this video?');">Edit</a>&nbsp;<a href="admin_multimedia.php?action=del&del_video_id=<?php echo $array_deals['id']?>" class="all_edit" onClick="return confirm('Are you sure you want to delete this video?');">Delete</a></td>
  </tr>
<?php } ?>
</table></div>
<?php
