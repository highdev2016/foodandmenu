...
<style type="text/css">
	...
	function distance($start,$destination)
	{
	 ...
	 $data = file_get_contents("https://maps.googleapis.com/maps/api/distancematrix/json?origins=".$from."&destinations=".$to."&language=en-EN&key=AIzaSyBNWkwTRDI6S8qlJ9k04INTy-uzWnQT-Hs");
		//echo "<br>";
