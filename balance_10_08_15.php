...
<div class="tab-look-restu" style="padding:2%;">
    ...
    <td class="all_restaurant2" style="width:75px; padding: 10px 0px; color: #686868;font-family: Calibri; font-size: 13px; text-align: center;"><span style="width: 70px;display: block;margin: auto;"> <?php echo "$".$fetch_array['service_fee']; ?> </span></td>
